...
export default function getMockWkTblPersonList(): WkTblMasterPersonInterface[] {

        const list: WkTblMasterPersonInterface[] = [];
...
function createEntity(index: number): WkTblMasterPersonInterface {

        const entity: WkTblMasterPersonInterface = new WkTblMasterPersonEntity();
        entity.wkTblMasterPersonId = index;
        entity.isLatest = true;

        entity.partnerName = "迂回献金　ミカエル　太郎" + index;
        ...
        entity.corpNo = "1-234-5678" + index;
        entity.corpAddress = "三重県架空市湖畔町" + index;
        entity.corpName = "とこぶし収穫組合" + index;
