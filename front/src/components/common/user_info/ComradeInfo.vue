...
const THIS_PAGE_ROLE: string = UserRoleConstants.ROLE_COMRADE;
// ユーザ情報を持ってくる
...
<template>
    <div style="background-color: darkgreen;padding-left: 0.7%;">
        <div style=" background-color: white;z-index: 2;padding-left: 1.3%;opacity: 1;text-align: right;">
            ...
            <div style="padding-right: 2.5%;">
                <div style="float: right;" class="left-space">
                    <img src="../../../assets/comrade.png" style="width: 80px;" @click="onInfo">
                </div>
