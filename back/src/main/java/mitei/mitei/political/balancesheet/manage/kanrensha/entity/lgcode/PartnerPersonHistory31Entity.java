...
/**
 * partner_person_history_31接続用Entity
 */
@Entity
@Table(name = "partner_person_history_31")
public class PartnerPersonHistory31Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
