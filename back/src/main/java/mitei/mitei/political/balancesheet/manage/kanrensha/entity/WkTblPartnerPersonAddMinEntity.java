...
/**
 * wk_tbl_partner_person_add_min接続用Entity
 */
@Entity
@Table(name = "wk_tbl_partner_person_add_min")
public class WkTblPartnerPersonAddMinEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
     ...
     * テーブルIdを設定する
     *
     * @param wkTblPartnerPersonAddMinId テーブルId
     */
    ...
    /** 関連者個人コード */
    @Column(name = "wk_tbl_partner_person_add_min_code")
    private Integer wkTblPartnerPersonAddMinCode = INIT_Integer;
     ...
     * @return 関連者個人コード
     */
    public Integer getWkTblPartnerPersonAddMinCode() {
        return wkTblPartnerPersonAddMinCode;
    }

    /**
     * 関連者個人コードを設定する
     *
     * @param wkTblPartnerPersonAddMinCode 関連者個人コード
     */
    public void setWkTblPartnerPersonAddMinCode(final Integer wkTblPartnerPersonAddMinCode) {
        this.wkTblPartnerPersonAddMinCode = wkTblPartnerPersonAddMinCode;
    }
