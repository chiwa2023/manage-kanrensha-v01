 ...
 */
@Component
public class DumpPartnerCorpHistory30ItemWriter extends FlatFileItemWriter<PartnerCorpHistory30Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory30ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory30Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory30Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
