...
/**
 * partner_poli_org_history_42接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_42")
public class PartnerPoliOrgHistory42Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
