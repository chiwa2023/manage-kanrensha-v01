 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory47ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory47Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory47ItemReader(
            final @Autowired PartnerPoliOrgHistory47Repository partnerPoliOrgHistory47Repository) {
        super();
