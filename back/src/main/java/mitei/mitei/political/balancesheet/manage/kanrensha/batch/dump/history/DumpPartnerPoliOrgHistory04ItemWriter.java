 ...
 */
@Component
public class DumpPartnerPoliOrgHistory04ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory04Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory04ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory04Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory04Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
