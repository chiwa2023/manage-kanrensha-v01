 ...
 */
@Component
public class DumpPartnerPersonHistory31ItemWriter extends FlatFileItemWriter<PartnerPersonHistory31Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory31ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory31Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory31Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
