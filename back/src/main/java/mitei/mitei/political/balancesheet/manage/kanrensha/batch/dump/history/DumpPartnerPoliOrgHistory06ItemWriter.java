 ...
 */
@Component
public class DumpPartnerPoliOrgHistory06ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory06Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory06ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory06Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory06Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
