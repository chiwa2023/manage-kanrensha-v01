...
/**
 * wk_tbl_partner_combine_org接続用Entity
 */
@Entity
@Table(name = "wk_tbl_partner_combine_org")
public class WkTblPartnerCombineOrgEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
     ...
     * テーブルIdを設定する
     *
     * @param wkTblPartnerCombineOrgId テーブルId
     */
    ...
    /** 紐づけコード */
    @Column(name = "wk_tbl_partner_combine_org_code")
    private Integer wkTblPartnerCombineOrgCode = INIT_Integer;
     ...
     * @return 紐づけコード
     */
    public Integer getWkTblPartnerCombineOrgCode() {
        return wkTblPartnerCombineOrgCode;
    }

    /**
     * 紐づけコードを設定する
     *
     * @param wkTblPartnerCombineOrgCode 紐づけコード
     */
    public void setWkTblPartnerCombineOrgCode(final Integer wkTblPartnerCombineOrgCode) {
        this.wkTblPartnerCombineOrgCode = wkTblPartnerCombineOrgCode;
    }
