 ...
 */
@Component
public class PartnerPoliOrgAddStdLineMapper implements LineMapper<PartnerPoliOrgAddStdDto> {
     ...
     * コンストラクタ
     */
    public PartnerPoliOrgAddStdLineMapper() {
        listGaitou.add("はい");
        listGaitou.add("1");
        listGaitou.add("１");
        listGaitou.add("true");
     ...
     */
    @Override
    public PartnerPoliOrgAddStdDto mapLine(final String line, final int lineNumber) throws Exception {
        ...
        // 政治団体代表者名カラム位置
        dto.setPoliOrgDelegate(this.removeQuote(cell[POS_SHOKUGYOU]));
        // 団体区分カラム位置
