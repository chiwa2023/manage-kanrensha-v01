...
/**
 * partner_poli_org_history_06接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_06")
public class PartnerPoliOrgHistory06Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
