...
/**
 * partner_poli_org_history_39接続用Repository
 */
public interface PartnerPoliOrgHistory39Repository extends JpaRepository<PartnerPoliOrgHistory39Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_39 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory39Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory39Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
