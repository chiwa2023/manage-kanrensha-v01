 ...
 */
@Component
public class DumpPartnerPersonHistory46ItemWriter extends FlatFileItemWriter<PartnerPersonHistory46Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory46ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory46Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory46Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
