 ...
 */
@Component
public class EraseWkTblParnerCorpHistoryTasklet implements Tasklet ,StepExecutionListener{
    ...
    public RepeatStatus execute(final StepContribution contribution, final ChunkContext chunkContext) throws Exception {
        ...
        wkTblPartnerCorpHistoryRepository.deleteByInsertUserCode(userCode);

        wkTblPartnerCorpJudgeRepository.deleteByInsertUserCode(userCode);
