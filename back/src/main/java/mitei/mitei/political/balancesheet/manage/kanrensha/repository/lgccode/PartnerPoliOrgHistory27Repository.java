...
/**
 * partner_poli_org_history_27接続用Repository
 */
public interface PartnerPoliOrgHistory27Repository extends JpaRepository<PartnerPoliOrgHistory27Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_27 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory27Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory27Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
