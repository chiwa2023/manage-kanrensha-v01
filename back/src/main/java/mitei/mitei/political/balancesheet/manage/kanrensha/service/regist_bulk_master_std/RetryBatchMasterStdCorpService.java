...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.partner.corp.add_std.RetryStdKanrenshaCorporationMasterBatchConfiguration;
 ...
 */
@Service
public class RetryBatchMasterStdCorpService {
    ...
    public void practice(final UserPersonLeastDto userDto) {
        ...
        try {
            jobLauncher.run(retryStdKanrenshaCorporationMaster, jobParameters);
