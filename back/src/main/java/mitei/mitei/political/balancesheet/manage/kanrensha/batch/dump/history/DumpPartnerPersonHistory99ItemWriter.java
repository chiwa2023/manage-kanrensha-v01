 ...
 */
@Component
public class DumpPartnerPersonHistory99ItemWriter extends FlatFileItemWriter<PartnerPersonHistory99Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory99ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory99Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory99Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
