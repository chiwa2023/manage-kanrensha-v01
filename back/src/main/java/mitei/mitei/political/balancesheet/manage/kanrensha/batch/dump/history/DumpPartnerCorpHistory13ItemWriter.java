 ...
 */
@Component
public class DumpPartnerCorpHistory13ItemWriter extends FlatFileItemWriter<PartnerCorpHistory13Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory13ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory13Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory13Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
