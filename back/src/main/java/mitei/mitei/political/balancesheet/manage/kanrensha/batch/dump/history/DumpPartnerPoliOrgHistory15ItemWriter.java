 ...
 */
@Component
public class DumpPartnerPoliOrgHistory15ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory15Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory15ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory15Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory15Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
