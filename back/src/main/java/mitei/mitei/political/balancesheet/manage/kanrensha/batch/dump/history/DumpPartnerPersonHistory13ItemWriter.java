 ...
 */
@Component
public class DumpPartnerPersonHistory13ItemWriter extends FlatFileItemWriter<PartnerPersonHistory13Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory13ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory13Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory13Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
