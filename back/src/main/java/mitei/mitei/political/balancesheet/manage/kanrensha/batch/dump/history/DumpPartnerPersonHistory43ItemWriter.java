 ...
 */
@Component
public class DumpPartnerPersonHistory43ItemWriter extends FlatFileItemWriter<PartnerPersonHistory43Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory43ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory43Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory43Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
