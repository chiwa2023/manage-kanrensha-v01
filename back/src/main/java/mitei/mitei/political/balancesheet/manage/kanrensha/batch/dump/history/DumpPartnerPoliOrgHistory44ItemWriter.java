 ...
 */
@Component
public class DumpPartnerPoliOrgHistory44ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory44Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory44ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory44Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory44Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
