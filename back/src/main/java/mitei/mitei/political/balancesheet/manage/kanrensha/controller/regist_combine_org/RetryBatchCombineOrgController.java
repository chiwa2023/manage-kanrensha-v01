...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.regist_combine_org.RetryBatchCombineOrgService;
...
public class RetryBatchCombineOrgController {
    ...
    @Autowired
    private RetryBatchCombineOrgService retryBatchCombineCorpService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        retryBatchCombineCorpService.practice(capsuleDto.getUserDto());
