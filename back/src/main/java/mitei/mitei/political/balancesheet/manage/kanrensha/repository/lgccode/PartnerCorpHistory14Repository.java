...
/**
 * partner_corp_history_14接続用Repository
 */
public interface PartnerCorpHistory14Repository extends JpaRepository<PartnerCorpHistory14Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_14 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory14Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory14Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
