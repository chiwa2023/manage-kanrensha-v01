 ...
 */
@Component
public class DumpPartnerPoliOrgHistory07ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory07Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory07ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory07Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory07Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
