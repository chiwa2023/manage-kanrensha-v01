...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.regist_bulk_history.RetryBatchHistoryCorpService;
...
public class RetryBatchHistoryCorpController {

    /** 非同期処理登録専用Service */
    @Autowired
    private RetryBatchHistoryCorpService retryBatchHistoryCorpService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        retryBatchHistoryCorpService.practice(capsuleDto.getUserDto());
