...
/**
 * partner_corp_history_34接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_34")
public class PartnerCorpHistory34Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
