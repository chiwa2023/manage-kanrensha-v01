...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.partner.corp.add_std.AddStdKanrenshaCorporationMasterBatchConfiguration;
...
public class ExecuteBatchMasterStdCorpService {
    ...
    public void practice(final String readFilePath, final UserPersonLeastDto userDto) {
        ...
        try {
            jobLauncher.run(addStdKanrenshaCorporationMaster, jobParameters);
