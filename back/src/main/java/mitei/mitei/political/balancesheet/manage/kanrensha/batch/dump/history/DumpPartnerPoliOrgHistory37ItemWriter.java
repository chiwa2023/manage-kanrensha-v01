 ...
 */
@Component
public class DumpPartnerPoliOrgHistory37ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory37Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory37ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory37Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory37Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
