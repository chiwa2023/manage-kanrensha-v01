...
public class UpdateApprovalKanrenshaPersonAddressLogic {
    ...
    public Integer practice(final MasterKanrenshaAddressBaseEntity entity, final UserPersonLeastDto userDto) {
        ...
        MasterPersonAddressEntity entityLoad = masterPersonAddressRepository.findById(entity.getKanrenshaAddressId())
                .get();
        ...
        if (Objects.equals(entity.getPostal1(), entityLoad.getPostal1())
            ...
            masterPersonAddressRepository.save(entityLoad);

        }

        // TODO マスタ本体も修正

        if (0 == masterPersonAddressRepository.save(this.cloneNewEntity(entity, entityLoad, userDto))
                .getMasterPersonAddressId()) {
            return 0;
        } else {
    ...
    private MasterPersonAddressEntity cloneNewEntity(final MasterKanrenshaAddressBaseEntity entity,
            final MasterPersonAddressEntity entityLoad, final UserPersonLeastDto userDto) {

        MasterPersonAddressEntity entitySaved = new MasterPersonAddressEntity();
        ...
        entitySaved.setMasterPersonAddressId(0); // auto increment
        return entitySaved;
    }
