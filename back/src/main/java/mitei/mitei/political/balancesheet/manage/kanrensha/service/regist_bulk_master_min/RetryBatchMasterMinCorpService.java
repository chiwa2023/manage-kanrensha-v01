...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.partner.corp.add_min.RetryMinKanrenshaCorpMasterBatchConfiguration;
 ...
 */
@Service
public class RetryBatchMasterMinCorpService {
    ...
    public void practice(final UserPersonLeastDto userDto) {
        ...
        try {
            jobLauncher.run(retryMinKanrenshaCorpMaster, jobParameters);
