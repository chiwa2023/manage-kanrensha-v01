...
/**
 * partner_corp_history_30接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_30")
public class PartnerCorpHistory30Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
