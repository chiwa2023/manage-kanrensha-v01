...
/**
 * partner_person_history_28接続用Entity
 */
@Entity
@Table(name = "partner_person_history_28")
public class PartnerPersonHistory28Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
