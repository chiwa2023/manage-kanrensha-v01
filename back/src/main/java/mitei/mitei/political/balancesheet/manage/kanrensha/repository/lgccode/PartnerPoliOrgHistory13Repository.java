...
/**
 * partner_poli_org_history_13接続用Repository
 */
public interface PartnerPoliOrgHistory13Repository extends JpaRepository<PartnerPoliOrgHistory13Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_13 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory13Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
