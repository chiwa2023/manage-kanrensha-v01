 ...
 */
@Component
public class DumpPartnerPoliOrgHistory01ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory01Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory01ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory01Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory01Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
