...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.partner.poli_org.add_min.AddMinKanrenshaPoliOrgMasterBatchConfiguration;
...
public class ExecuteBatchMasterMinPoliOrgService {
    ...
    public void practice(final String readFilePath, final UserPersonLeastDto userDto) {
        ...
        try {
            jobLauncher.run(addMinKanrenshaPoliOrgMaster, jobParameters);
