 ...
 */
@Component
public class DumpPartnerPersonHistory04ItemWriter extends FlatFileItemWriter<PartnerPersonHistory04Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory04ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory04Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory04Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
