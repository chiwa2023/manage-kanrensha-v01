...
/**
 * partner_poli_org_history_31接続用Repository
 */
public interface PartnerPoliOrgHistory31Repository extends JpaRepository<PartnerPoliOrgHistory31Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_31 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory31Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory31Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
