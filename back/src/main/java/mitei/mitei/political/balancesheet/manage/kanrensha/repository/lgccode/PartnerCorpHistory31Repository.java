...
/**
 * partner_corp_history_31接続用Repository
 */
public interface PartnerCorpHistory31Repository extends JpaRepository<PartnerCorpHistory31Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_31 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory31Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory31Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
