...
public class GetRiyoushaComradeDtoController {
     ...
     */
    @PostMapping("/get-comrade")
    public ResponseEntity<GetRiyoushaComradeResultDto> practice(
            final @RequestBody GetRiyoushaComradeCapsuleDto capsuleDto) {

        GetRiyoushaComradeResultDto resultDto = new GetRiyoushaComradeResultDto();
        try {
            resultDto.setRiyoushaComradeDto(getRiyoushaComradeDtoService.practice(capsuleDto.getRiyoushaComradeEntity()));
