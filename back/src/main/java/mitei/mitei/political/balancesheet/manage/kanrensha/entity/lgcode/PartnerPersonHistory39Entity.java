...
/**
 * partner_person_history_39接続用Entity
 */
@Entity
@Table(name = "partner_person_history_39")
public class PartnerPersonHistory39Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
