 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory40ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory40Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory40ItemReader(
            final @Autowired PartnerPoliOrgHistory40Repository partnerPoliOrgHistory40Repository) {
        super();
