...
/**
 * partner_corp_history_03接続用Repository
 */
public interface PartnerCorpHistory03Repository extends JpaRepository<PartnerCorpHistory03Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_03 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory03Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory03Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
