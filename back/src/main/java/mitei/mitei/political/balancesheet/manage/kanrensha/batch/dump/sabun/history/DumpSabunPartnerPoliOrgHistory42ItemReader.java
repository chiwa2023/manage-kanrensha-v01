 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory42ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory42Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory42ItemReader(
            final @Autowired PartnerPoliOrgHistory42Repository partnerPoliOrgHistory42Repository) {
        super();
