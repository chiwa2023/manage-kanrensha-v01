...
/**
 * riyousha_admin_access接続用Entity
 */
@Entity
@Table(name = "riyousha_admin_access")
public class RiyoushaAdminAccessEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "riyousha_admin_access_id")
    private Integer riyoushaAdminAccessId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getRiyoushaAdminAccessId() {
        return riyoushaAdminAccessId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param riyoushaAdminAccessId テーブルId
     */
    public void setRiyoushaAdminAccessId(final Integer riyoushaAdminAccessId) {
        this.riyoushaAdminAccessId = riyoushaAdminAccessId;
    }
     ...
     * API接続利用者Idを設定する
     *
     * @param riyoushaAdminId API接続利用者Id
     */
