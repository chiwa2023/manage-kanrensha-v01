 ...
 */
@Component
public class PartnerCorpAddMiniRecordItemReader extends RepositoryItemReader<WkTblPartnerCorpAddMinEntity> {

    /**
     * コンストラクタ
     *
     * @param wkTblPartnerCorpAddMinRepository 関連者企業・団体最小登録ワークテーブルRepository
     */
    public PartnerCorpAddMiniRecordItemReader(
            final @Autowired WkTblPartnerCorpAddMinRepository wkTblPartnerCorpAddMinRepository) {
