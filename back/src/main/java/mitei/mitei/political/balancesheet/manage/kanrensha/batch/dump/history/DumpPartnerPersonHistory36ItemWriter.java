 ...
 */
@Component
public class DumpPartnerPersonHistory36ItemWriter extends FlatFileItemWriter<PartnerPersonHistory36Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory36ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory36Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory36Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
