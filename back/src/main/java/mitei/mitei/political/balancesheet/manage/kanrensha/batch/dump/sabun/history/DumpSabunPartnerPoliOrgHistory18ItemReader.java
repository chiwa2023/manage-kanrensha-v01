 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory18ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory18Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory18ItemReader(
            final @Autowired PartnerPoliOrgHistory18Repository partnerPoliOrgHistory18Repository) {
        super();
