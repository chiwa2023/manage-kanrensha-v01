...
/**
 * partner_person_history_02接続用Entity
 */
@Entity
@Table(name = "partner_person_history_02")
public class PartnerPersonHistory02Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
