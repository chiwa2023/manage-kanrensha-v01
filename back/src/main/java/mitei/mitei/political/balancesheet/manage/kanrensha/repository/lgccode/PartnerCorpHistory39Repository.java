...
/**
 * partner_corp_history_39接続用Repository
 */
public interface PartnerCorpHistory39Repository extends JpaRepository<PartnerCorpHistory39Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_39 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory39Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory39Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
