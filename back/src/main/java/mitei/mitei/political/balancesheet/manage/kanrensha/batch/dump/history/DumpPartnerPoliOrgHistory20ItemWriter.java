 ...
 */
@Component
public class DumpPartnerPoliOrgHistory20ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory20Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory20ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory20Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory20Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
