...
/**
 * partner_poli_org_history_07接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_07")
public class PartnerPoliOrgHistory07Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
