 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory04ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory04Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory04ItemReader(
            final @Autowired PartnerPoliOrgHistory04Repository partnerPoliOrgHistory04Repository) {
        super();
