...
/**
 * partner_poli_org_history_04接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_04")
public class PartnerPoliOrgHistory04Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
