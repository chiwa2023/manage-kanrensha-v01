...
public interface PartnerPoliOrgHistory21Repository extends JpaRepository<PartnerPoliOrgHistory21Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory21Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory21Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
