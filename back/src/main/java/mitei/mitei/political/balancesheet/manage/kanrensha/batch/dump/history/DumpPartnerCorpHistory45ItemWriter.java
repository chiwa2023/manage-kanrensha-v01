 ...
 */
@Component
public class DumpPartnerCorpHistory45ItemWriter extends FlatFileItemWriter<PartnerCorpHistory45Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory45ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory45Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory45Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
