 ...
 */
@Component
public class DumpPartnerPoliOrgHistory99ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory99Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory99ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory99Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory99Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
