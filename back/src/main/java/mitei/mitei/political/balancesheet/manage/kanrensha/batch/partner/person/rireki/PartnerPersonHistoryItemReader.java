 ...
 */
@Component
public class PartnerPersonHistoryItemReader extends FlatFileItemReader<PartnerPersonHistoryDto> {
     ...
     */
    public PartnerPersonHistoryItemReader(final @Autowired PartnerPersonHistoryLineMapper lineMapper) {
        super();
