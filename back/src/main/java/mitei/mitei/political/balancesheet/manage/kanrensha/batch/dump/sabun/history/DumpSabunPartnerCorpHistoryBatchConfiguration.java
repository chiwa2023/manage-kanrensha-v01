...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory01ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory02ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory03ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory04ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory05ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory06ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory07ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory08ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory09ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory10ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory11ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory12ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory13ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory14ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory15ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory16ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory17ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory18ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory19ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory20ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory21ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory22ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory23ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory24ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory25ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory26ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory27ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory28ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory29ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory30ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory31ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory32ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory33ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory34ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory35ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory36ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory37ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory38ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory39ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory40ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory41ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory42ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory43ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory44ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory45ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory46ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory47ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerCorpHistory99ItemWriter;
 ...
 */
@Configuration
public class DumpSabunPartnerCorpHistoryBatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "dumpSabunPartnerCorpHistory";
    ...
    @Autowired
    private DumpSabunPartnerCorpHistory01ItemReader dumpSabunPartnerCorpHistory01ItemReader;
    /** 関連者企業・団体履歴(02)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory02ItemReader dumpSabunPartnerCorpHistory02ItemReader;
    /** 関連者企業・団体履歴(03)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory03ItemReader dumpSabunPartnerCorpHistory03ItemReader;
    /** 関連者企業・団体履歴(04)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory04ItemReader dumpSabunPartnerCorpHistory04ItemReader;
    /** 関連者企業・団体履歴(05)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory05ItemReader dumpSabunPartnerCorpHistory05ItemReader;
    /** 関連者企業・団体履歴(06)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory06ItemReader dumpSabunPartnerCorpHistory06ItemReader;
    /** 関連者企業・団体履歴(07)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory07ItemReader dumpSabunPartnerCorpHistory07ItemReader;
    /** 関連者企業・団体履歴(08)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory08ItemReader dumpSabunPartnerCorpHistory08ItemReader;
    /** 関連者企業・団体履歴(09)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory09ItemReader dumpSabunPartnerCorpHistory09ItemReader;
    /** 関連者企業・団体履歴(10)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory10ItemReader dumpSabunPartnerCorpHistory10ItemReader;
    /** 関連者企業・団体履歴(11)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory11ItemReader dumpSabunPartnerCorpHistory11ItemReader;
    /** 関連者企業・団体履歴(12)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory12ItemReader dumpSabunPartnerCorpHistory12ItemReader;
    /** 関連者企業・団体履歴(13)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory13ItemReader dumpSabunPartnerCorpHistory13ItemReader;
    /** 関連者企業・団体履歴(14)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory14ItemReader dumpSabunPartnerCorpHistory14ItemReader;
    /** 関連者企業・団体履歴(15)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory15ItemReader dumpSabunPartnerCorpHistory15ItemReader;
    /** 関連者企業・団体履歴(16)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory16ItemReader dumpSabunPartnerCorpHistory16ItemReader;
    /** 関連者企業・団体履歴(17)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory17ItemReader dumpSabunPartnerCorpHistory17ItemReader;
    /** 関連者企業・団体履歴(18)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory18ItemReader dumpSabunPartnerCorpHistory18ItemReader;
    /** 関連者企業・団体履歴(19)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory19ItemReader dumpSabunPartnerCorpHistory19ItemReader;
    /** 関連者企業・団体履歴(20)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory20ItemReader dumpSabunPartnerCorpHistory20ItemReader;
    /** 関連者企業・団体履歴(21)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory21ItemReader dumpSabunPartnerCorpHistory21ItemReader;
    /** 関連者企業・団体履歴(22)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory22ItemReader dumpSabunPartnerCorpHistory22ItemReader;
    /** 関連者企業・団体履歴(23)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory23ItemReader dumpSabunPartnerCorpHistory23ItemReader;
    /** 関連者企業・団体履歴(24)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory24ItemReader dumpSabunPartnerCorpHistory24ItemReader;
    /** 関連者企業・団体履歴(25)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory25ItemReader dumpSabunPartnerCorpHistory25ItemReader;
    /** 関連者企業・団体履歴(26)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory26ItemReader dumpSabunPartnerCorpHistory26ItemReader;
    /** 関連者企業・団体履歴(27)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory27ItemReader dumpSabunPartnerCorpHistory27ItemReader;
    /** 関連者企業・団体履歴(28)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory28ItemReader dumpSabunPartnerCorpHistory28ItemReader;
    /** 関連者企業・団体履歴(29)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory29ItemReader dumpSabunPartnerCorpHistory29ItemReader;
    /** 関連者企業・団体履歴(30)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory30ItemReader dumpSabunPartnerCorpHistory30ItemReader;
    /** 関連者企業・団体履歴(31)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory31ItemReader dumpSabunPartnerCorpHistory31ItemReader;
    /** 関連者企業・団体履歴(32)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory32ItemReader dumpSabunPartnerCorpHistory32ItemReader;
    /** 関連者企業・団体履歴(33)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory33ItemReader dumpSabunPartnerCorpHistory33ItemReader;
    /** 関連者企業・団体履歴(34)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory34ItemReader dumpSabunPartnerCorpHistory34ItemReader;
    /** 関連者企業・団体履歴(35)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory35ItemReader dumpSabunPartnerCorpHistory35ItemReader;
    /** 関連者企業・団体履歴(36)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory36ItemReader dumpSabunPartnerCorpHistory36ItemReader;
    /** 関連者企業・団体履歴(37)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory37ItemReader dumpSabunPartnerCorpHistory37ItemReader;
    /** 関連者企業・団体履歴(38)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory38ItemReader dumpSabunPartnerCorpHistory38ItemReader;
    /** 関連者企業・団体履歴(39)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory39ItemReader dumpSabunPartnerCorpHistory39ItemReader;
    /** 関連者企業・団体履歴(40)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory40ItemReader dumpSabunPartnerCorpHistory40ItemReader;
    /** 関連者企業・団体履歴(41)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory41ItemReader dumpSabunPartnerCorpHistory41ItemReader;
    /** 関連者企業・団体履歴(42)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory42ItemReader dumpSabunPartnerCorpHistory42ItemReader;
    /** 関連者企業・団体履歴(43)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory43ItemReader dumpSabunPartnerCorpHistory43ItemReader;
    /** 関連者企業・団体履歴(44)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory44ItemReader dumpSabunPartnerCorpHistory44ItemReader;
    /** 関連者企業・団体履歴(45)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory45ItemReader dumpSabunPartnerCorpHistory45ItemReader;
    /** 関連者企業・団体履歴(46)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory46ItemReader dumpSabunPartnerCorpHistory46ItemReader;
    /** 関連者企業・団体履歴(47)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory47ItemReader dumpSabunPartnerCorpHistory47ItemReader;
    /** 関連者企業・団体履歴(99)CsvItemReader */
    @Autowired
    private DumpSabunPartnerCorpHistory99ItemReader dumpSabunPartnerCorpHistory99ItemReader;
    ...
    protected Step getStep01(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT01, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory01ItemReader).writer(dumpPartnerCorpHistory01ItemWriter).build();
    }
    ...
    protected Step getStep02(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT02, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory02ItemReader).writer(dumpPartnerCorpHistory02ItemWriter).build();
    }
    ...
    protected Step getStep03(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT03, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory03ItemReader).writer(dumpPartnerCorpHistory03ItemWriter).build();
    }
    ...
    protected Step getStep04(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT04, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory04ItemReader).writer(dumpPartnerCorpHistory04ItemWriter).build();
    }
    ...
    protected Step getStep05(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT05, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory05ItemReader).writer(dumpPartnerCorpHistory05ItemWriter).build();
    }
    ...
    protected Step getStep06(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT06, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory06ItemReader).writer(dumpPartnerCorpHistory06ItemWriter).build();
    }
    ...
    protected Step getStep07(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT07, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory07ItemReader).writer(dumpPartnerCorpHistory07ItemWriter).build();
    }
    ...
    protected Step getStep08(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT01, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory08ItemReader).writer(dumpPartnerCorpHistory08ItemWriter).build();
    }
    ...
    protected Step getStep09(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT09, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory09ItemReader).writer(dumpPartnerCorpHistory09ItemWriter).build();
    }
    ...
    protected Step getStep10(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT10, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory10ItemReader).writer(dumpPartnerCorpHistory10ItemWriter).build();
    }
    ...
    protected Step getStep11(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT11, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory11ItemReader).writer(dumpPartnerCorpHistory11ItemWriter).build();
    }
    ...
    protected Step getStep12(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT12, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory12ItemReader).writer(dumpPartnerCorpHistory12ItemWriter).build();
    }
    ...
    protected Step getStep13(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT13, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory13ItemReader).writer(dumpPartnerCorpHistory13ItemWriter).build();
    }
    ...
    protected Step getStep14(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT14, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory14ItemReader).writer(dumpPartnerCorpHistory14ItemWriter).build();
    }
    ...
    protected Step getStep15(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT15, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory15ItemReader).writer(dumpPartnerCorpHistory15ItemWriter).build();
    }
    ...
    protected Step getStep16(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT16, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory16ItemReader).writer(dumpPartnerCorpHistory16ItemWriter).build();
    }
    ...
    protected Step getStep17(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT17, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory17ItemReader).writer(dumpPartnerCorpHistory17ItemWriter).build();
    }
    ...
    protected Step getStep18(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT18, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory18ItemReader).writer(dumpPartnerCorpHistory18ItemWriter).build();
    }
    ...
    protected Step getStep19(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT19, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory19ItemReader).writer(dumpPartnerCorpHistory19ItemWriter).build();
    }
    ...
    protected Step getStep20(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT20, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory20ItemReader).writer(dumpPartnerCorpHistory20ItemWriter).build();
    }
    ...
    protected Step getStep21(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT21, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory21ItemReader).writer(dumpPartnerCorpHistory21ItemWriter).build();
    }
    ...
    protected Step getStep22(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT22, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory22ItemReader).writer(dumpPartnerCorpHistory22ItemWriter).build();
    }
    ...
    protected Step getStep23(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT23, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory23ItemReader).writer(dumpPartnerCorpHistory23ItemWriter).build();
    }
    ...
    protected Step getStep24(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT24, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory24ItemReader).writer(dumpPartnerCorpHistory24ItemWriter).build();
    }
    ...
    protected Step getStep25(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT25, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory25ItemReader).writer(dumpPartnerCorpHistory25ItemWriter).build();
    }
    ...
    protected Step getStep26(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT26, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory26ItemReader).writer(dumpPartnerCorpHistory26ItemWriter).build();
    }
    ...
    protected Step getStep27(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT27, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory27ItemReader).writer(dumpPartnerCorpHistory27ItemWriter).build();
    }
    ...
    protected Step getStep28(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT28, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory28ItemReader).writer(dumpPartnerCorpHistory28ItemWriter).build();
    }
    ...
    protected Step getStep29(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT29, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory29ItemReader).writer(dumpPartnerCorpHistory29ItemWriter).build();
    }
    ...
    protected Step getStep30(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT30, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory30ItemReader).writer(dumpPartnerCorpHistory30ItemWriter).build();
    }
    ...
    protected Step getStep31(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT31, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory31ItemReader).writer(dumpPartnerCorpHistory31ItemWriter).build();
    }
    ...
    protected Step getStep32(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT32, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory32ItemReader).writer(dumpPartnerCorpHistory32ItemWriter).build();
    }
    ...
    protected Step getStep33(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT33, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory33ItemReader).writer(dumpPartnerCorpHistory33ItemWriter).build();
    }
    ...
    protected Step getStep34(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT34, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory34ItemReader).writer(dumpPartnerCorpHistory34ItemWriter).build();
    }
    ...
    protected Step getStep35(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT35, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory35ItemReader).writer(dumpPartnerCorpHistory35ItemWriter).build();
    }
    ...
    protected Step getStep36(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT36, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory36ItemReader).writer(dumpPartnerCorpHistory36ItemWriter).build();
    }
    ...
    protected Step getStep37(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT37, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory37ItemReader).writer(dumpPartnerCorpHistory37ItemWriter).build();
    }
    ...
    protected Step getStep38(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT38, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory38ItemReader).writer(dumpPartnerCorpHistory38ItemWriter).build();
    }
    ...
    protected Step getStep39(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT39, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory39ItemReader).writer(dumpPartnerCorpHistory39ItemWriter).build();
    }
    ...
    protected Step getStep40(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT40, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory40ItemReader).writer(dumpPartnerCorpHistory40ItemWriter).build();
    }
    ...
    protected Step getStep41(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT41, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory41ItemReader).writer(dumpPartnerCorpHistory41ItemWriter).build();
    }
    ...
    protected Step getStep42(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT42, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory42ItemReader).writer(dumpPartnerCorpHistory42ItemWriter).build();
    }
    ...
    protected Step getStep43(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT43, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory43ItemReader).writer(dumpPartnerCorpHistory43ItemWriter).build();
    }
    ...
    protected Step getStep44(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT44, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory44ItemReader).writer(dumpPartnerCorpHistory44ItemWriter).build();
    }
    ...
    protected Step getStep45(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT45, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory45ItemReader).writer(dumpPartnerCorpHistory45ItemWriter).build();
    }
    ...
    protected Step getStep46(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT46, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory46ItemReader).writer(dumpPartnerCorpHistory46ItemWriter).build();
    }
    ...
    protected Step getStep47(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT47, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory47ItemReader).writer(dumpPartnerCorpHistory47ItemWriter).build();
    }
    ...
    protected Step getStep99(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT99, jobRepository)
                ...
                .reader(dumpSabunPartnerCorpHistory99ItemReader).writer(dumpPartnerCorpHistory99ItemWriter).build();
    }
