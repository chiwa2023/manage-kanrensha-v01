...
/**
 * partner_poli_org_history_06接続用Repository
 */
public interface PartnerPoliOrgHistory06Repository extends JpaRepository<PartnerPoliOrgHistory06Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory06Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory06Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
