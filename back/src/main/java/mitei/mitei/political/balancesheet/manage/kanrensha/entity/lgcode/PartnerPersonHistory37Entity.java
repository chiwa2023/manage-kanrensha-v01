...
/**
 * partner_person_history_37接続用Entity
 */
@Entity
@Table(name = "partner_person_history_37")
public class PartnerPersonHistory37Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
