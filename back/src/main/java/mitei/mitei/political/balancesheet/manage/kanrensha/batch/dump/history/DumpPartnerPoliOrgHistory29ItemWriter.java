 ...
 */
@Component
public class DumpPartnerPoliOrgHistory29ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory29Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory29ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory29Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory29Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
