 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory19ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory19Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory19ItemReader(
            final @Autowired PartnerPoliOrgHistory19Repository partnerPoliOrgHistory19Repository) {
        super();
