 ...
 */
@Component
public class DumpPartnerPersonHistory26ItemWriter extends FlatFileItemWriter<PartnerPersonHistory26Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory26ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory26Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory26Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
