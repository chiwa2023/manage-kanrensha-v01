 ...
 */
@Component
public class DumpPartnerPersonHistory44ItemReader extends RepositoryItemReader<PartnerPersonHistory44Entity> {
     ...
     */
    public DumpPartnerPersonHistory44ItemReader(
            final @Autowired PartnerPersonHistory44Repository partnerPersonHistory44Repository) {
        super();
