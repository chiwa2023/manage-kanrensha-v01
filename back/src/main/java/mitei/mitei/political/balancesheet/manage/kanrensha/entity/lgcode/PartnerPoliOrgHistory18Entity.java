...
/**
 * partner_poli_org_history_18接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_18")
public class PartnerPoliOrgHistory18Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
