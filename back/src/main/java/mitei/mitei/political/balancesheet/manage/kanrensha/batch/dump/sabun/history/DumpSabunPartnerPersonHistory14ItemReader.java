 ...
 */
@Component
public class DumpSabunPartnerPersonHistory14ItemReader extends RepositoryItemReader<PartnerPersonHistory14Entity> {
     ...
     */
    public DumpSabunPartnerPersonHistory14ItemReader(
            final @Autowired PartnerPersonHistory14Repository partnerPersonHistory14Repository) {
        super();
