 ...
 */
@Component
public class CallForEditMasterPoliOrgAccessEntityLogic {
     ...
     */
    public MasterPoliticalOrganizationAccessEntity practice(final KanrenshaPoliOrgDto dto)
            throws EmptyResultDataAccessException, ConcurrencyFailureException { // NOPMD UncheckedException

        // accessIdを使ってEntityを取得
        MasterPoliticalOrganizationAccessEntity entity = repository.findById(dto.getAccessId()).orElseThrow(
     ...
     *
     * @param dto    関連者政治団体Dto
     * @param entity MasterPoliticalOrganizationAccessEntity
     * @return 変更があればtrue
     */
    private boolean isEntityChanged( // SUPPRESS CHECKSTYLE NPath
            final KanrenshaPoliOrgDto dto, final MasterPoliticalOrganizationAccessEntity entity) {
