 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory06ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory06Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory06ItemReader(
            final @Autowired PartnerPoliOrgHistory06Repository partnerPoliOrgHistory06Repository) {
        super();
