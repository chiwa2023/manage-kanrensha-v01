 ...
 */
@Component
public class DumpPartnerPersonHistory41ItemWriter extends FlatFileItemWriter<PartnerPersonHistory41Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory41ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory41Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory41Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
