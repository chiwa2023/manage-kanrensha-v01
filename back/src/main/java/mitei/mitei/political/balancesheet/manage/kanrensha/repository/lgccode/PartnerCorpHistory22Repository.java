...
/**
 * partner_corp_history_22接続用Repository
 */
public interface PartnerCorpHistory22Repository extends JpaRepository<PartnerCorpHistory22Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_22 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory22Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory22Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
