...
/**
 * partner_corp_history_05接続用Repository
 */
public interface PartnerCorpHistory05Repository extends JpaRepository<PartnerCorpHistory05Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_05 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory05Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory05Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
