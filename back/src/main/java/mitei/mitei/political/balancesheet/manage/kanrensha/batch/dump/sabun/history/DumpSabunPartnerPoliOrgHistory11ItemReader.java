 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory11ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory11Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory11ItemReader(
            final @Autowired PartnerPoliOrgHistory11Repository partnerPoliOrgHistory11Repository) {
        super();
