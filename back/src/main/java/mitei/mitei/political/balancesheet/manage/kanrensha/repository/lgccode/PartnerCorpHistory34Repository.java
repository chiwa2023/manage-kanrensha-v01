...
/**
 * partner_corp_history_34接続用Repository
 */
public interface PartnerCorpHistory34Repository extends JpaRepository<PartnerCorpHistory34Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_34 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory34Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory34Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
