...
/**
 * partner_poli_org_history_47接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_47")
public class PartnerPoliOrgHistory47Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
