 ...
 */
@Component
public class DumpPartnerCorpHistory04ItemWriter extends FlatFileItemWriter<PartnerCorpHistory04Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory04ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory04Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory04Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
