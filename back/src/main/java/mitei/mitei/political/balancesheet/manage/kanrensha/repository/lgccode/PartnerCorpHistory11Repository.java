...
/**
 * partner_corp_history_11接続用Repository
 */
public interface PartnerCorpHistory11Repository extends JpaRepository<PartnerCorpHistory11Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_11 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory11Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory11Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
