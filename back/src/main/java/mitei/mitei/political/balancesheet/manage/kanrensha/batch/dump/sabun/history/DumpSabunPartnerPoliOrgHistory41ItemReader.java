 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory41ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory41Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory41ItemReader(
            final @Autowired PartnerPoliOrgHistory41Repository partnerPoliOrgHistory41Repository) {
        super();
