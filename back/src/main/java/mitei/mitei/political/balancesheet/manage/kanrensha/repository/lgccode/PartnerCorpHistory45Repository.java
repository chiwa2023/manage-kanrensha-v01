...
/**
 * partner_corp_history_45接続用Repository
 */
public interface PartnerCorpHistory45Repository extends JpaRepository<PartnerCorpHistory45Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_45 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory45Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory45Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
