 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory22ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory22Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory22ItemReader(
            final @Autowired PartnerPoliOrgHistory22Repository partnerPoliOrgHistory22Repository) {
        super();
