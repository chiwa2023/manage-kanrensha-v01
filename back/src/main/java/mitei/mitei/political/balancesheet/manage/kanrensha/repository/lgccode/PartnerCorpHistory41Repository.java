...
/**
 * partner_corp_history_41接続用Repository
 */
public interface PartnerCorpHistory41Repository extends JpaRepository<PartnerCorpHistory41Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_41 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory41Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory41Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
