 ...
 */
@Component
public class PartnerPersonAddMiniWkTblFixItemWriter extends JpaItemWriter<WkTblPartnerPersonAddMinEntity> {
     ...
     */
    public PartnerPersonAddMiniWkTblFixItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
