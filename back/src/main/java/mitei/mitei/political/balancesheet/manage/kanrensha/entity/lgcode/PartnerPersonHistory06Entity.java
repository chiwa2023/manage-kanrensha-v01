...
/**
 * partner_person_history_06接続用Entity
 */
@Entity
@Table(name = "partner_person_history_06")
public class PartnerPersonHistory06Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
