...
public interface PartnerCorpHistory04Repository extends JpaRepository<PartnerCorpHistory04Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory04Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory04Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
