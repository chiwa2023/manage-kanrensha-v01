 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory30ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory30Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory30ItemReader(
            final @Autowired PartnerPoliOrgHistory30Repository partnerPoliOrgHistory30Repository) {
        super();
