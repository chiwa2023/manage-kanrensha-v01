 ...
 */
@Component
public class PartnerPoliOrgAddMiniCsvItemWriter extends JpaItemWriter<WkTblPartnerPoliOrgAddMinEntity> {
     ...
     */
    public PartnerPoliOrgAddMiniCsvItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
    ...
    public void write(final Chunk<? extends WkTblPartnerPoliOrgAddMinEntity> items) {
        ...
        for (WkTblPartnerPoliOrgAddMinEntity entity : items) {
            ...
            entity.setWkTblPartnerPoliOrgAddMinCode(code);
        }
