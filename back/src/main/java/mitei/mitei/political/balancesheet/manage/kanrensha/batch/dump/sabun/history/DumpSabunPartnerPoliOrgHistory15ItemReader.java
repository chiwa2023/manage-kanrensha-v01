 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory15ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory15Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory15ItemReader(
            final @Autowired PartnerPoliOrgHistory15Repository partnerPoliOrgHistory15Repository) {
        super();
