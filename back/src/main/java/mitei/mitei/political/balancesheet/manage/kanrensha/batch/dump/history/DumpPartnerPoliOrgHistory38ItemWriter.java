 ...
 */
@Component
public class DumpPartnerPoliOrgHistory38ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory38Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory38ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory38Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory38Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
