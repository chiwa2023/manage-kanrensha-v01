 ...
 */
@Component
public class MasterPoliticalOrganizationAddStdWkTblFixItemWriter extends JpaItemWriter<WkTblMasterPoliOrgEntity> {
     ...
     */
    public MasterPoliticalOrganizationAddStdWkTblFixItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
