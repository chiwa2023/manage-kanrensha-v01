 ...
 */
@Component
public class DumpPartnerPersonHistory12ItemWriter extends FlatFileItemWriter<PartnerPersonHistory12Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory12ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory12Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory12Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
