 ...
 */
@Component
public class DumpPartnerCorpHistory35ItemWriter extends FlatFileItemWriter<PartnerCorpHistory35Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory35ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory35Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory35Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
