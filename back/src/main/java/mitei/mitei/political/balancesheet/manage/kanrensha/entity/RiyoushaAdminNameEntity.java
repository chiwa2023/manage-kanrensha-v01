...
/**
 * riyousha_admin_name接続用Entity
 */
@Entity
@Table(name = "riyousha_admin_name")
public class RiyoushaAdminNameEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "riyousha_admin_name_id")
    private Integer riyoushaAdminNameId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getRiyoushaAdminNameId() {
        return riyoushaAdminNameId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param riyoushaAdminNameId テーブルId
     */
    public void setRiyoushaAdminNameId(final Integer riyoushaAdminNameId) {
        this.riyoushaAdminNameId = riyoushaAdminNameId;
    }
