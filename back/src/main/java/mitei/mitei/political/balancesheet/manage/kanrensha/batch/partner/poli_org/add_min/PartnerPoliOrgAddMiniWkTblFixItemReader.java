 ...
 */
@Component
public class PartnerPoliOrgAddMiniWkTblFixItemReader extends RepositoryItemReader<WkTblPartnerPoliOrgAddMinResultEntity> {

    /**
     * コンストラクタ
     *
     * @param wkTblPartnerPoliOrgAddMinResultRepository 関連者政治団体最小登録処理結果ワークテーブルRepository
     */
    public PartnerPoliOrgAddMiniWkTblFixItemReader(
            final @Autowired WkTblPartnerPoliOrgAddMinResultRepository wkTblPartnerPoliOrgAddMinResultRepository) {

        super();
        super.setRepository(wkTblPartnerPoliOrgAddMinResultRepository);
