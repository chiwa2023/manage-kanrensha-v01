...
/**
 * partner_corp_history_29接続用Repository
 */
public interface PartnerCorpHistory29Repository extends JpaRepository<PartnerCorpHistory29Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_29 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory29Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory29Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
