...
/**
 * partner_poli_org_history_99接続用Repository
 */
public interface PartnerPoliOrgHistory99Repository extends JpaRepository<PartnerPoliOrgHistory99Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_99 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory99Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory99Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
