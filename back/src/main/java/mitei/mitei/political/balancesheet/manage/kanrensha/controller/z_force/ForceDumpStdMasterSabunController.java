...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.z_force.AsyncForceDumpStdMasterSabunService;

/**
 * マスタ標準差分ダンプController
 */
@RestController
@RequestMapping("/dump-master-std-sabun")
public class ForceDumpStdMasterSabunController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(final @RequestBody ForceDumpCapsuleDto capsuleDto) {
        ...
        asyncForceDumpStdMasterSabunService.practice(capsuleDto);
