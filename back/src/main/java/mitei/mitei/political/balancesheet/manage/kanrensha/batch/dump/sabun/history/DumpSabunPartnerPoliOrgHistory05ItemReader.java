 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory05ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory05Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory05ItemReader(
            final @Autowired PartnerPoliOrgHistory05Repository partnerPoliOrgHistory05Repository) {
        super();
