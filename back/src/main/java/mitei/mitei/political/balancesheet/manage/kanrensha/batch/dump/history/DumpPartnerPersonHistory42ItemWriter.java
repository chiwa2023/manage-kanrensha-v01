 ...
 */
@Component
public class DumpPartnerPersonHistory42ItemWriter extends FlatFileItemWriter<PartnerPersonHistory42Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory42ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory42Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory42Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
