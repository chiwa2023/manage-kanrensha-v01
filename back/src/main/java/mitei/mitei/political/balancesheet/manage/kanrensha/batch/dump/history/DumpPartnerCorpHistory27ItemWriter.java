 ...
 */
@Component
public class DumpPartnerCorpHistory27ItemWriter extends FlatFileItemWriter<PartnerCorpHistory27Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory27ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory27Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory27Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
