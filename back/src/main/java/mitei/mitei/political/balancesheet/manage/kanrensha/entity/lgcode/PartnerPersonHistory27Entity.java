...
/**
 * partner_person_history_27接続用Entity
 */
@Entity
@Table(name = "partner_person_history_27")
public class PartnerPersonHistory27Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
