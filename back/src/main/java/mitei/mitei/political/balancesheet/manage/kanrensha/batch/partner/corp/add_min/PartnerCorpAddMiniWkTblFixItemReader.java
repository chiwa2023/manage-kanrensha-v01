 ...
 */
@Component
public class PartnerCorpAddMiniWkTblFixItemReader extends RepositoryItemReader<WkTblPartnerCorpAddMinResultEntity> {

    /**
     * コンストラクタ
     *
     * @param wkTblPartnerCorpAddMinResultRepository 関連者企業・団体最小登録処理結果ワークテーブルRepository
     */
    public PartnerCorpAddMiniWkTblFixItemReader(
            final @Autowired WkTblPartnerCorpAddMinResultRepository wkTblPartnerCorpAddMinResultRepository) {

        super();
        super.setRepository(wkTblPartnerCorpAddMinResultRepository);
