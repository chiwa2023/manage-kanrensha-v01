 ...
 */
@Component
public class DumpPartnerCorpHistory42ItemWriter extends FlatFileItemWriter<PartnerCorpHistory42Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory42ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory42Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory42Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
