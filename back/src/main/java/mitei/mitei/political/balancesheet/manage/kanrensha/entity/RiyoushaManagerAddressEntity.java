...
/**
 * riyousha_manager_address接続用Entity
 */
@Entity
@Table(name = "riyousha_manager_address")
public class RiyoushaManagerAddressEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "riyousha_manager_address_id")
    private Integer riyoushaManagerAddressId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getRiyoushaManagerAddressId() {
        return riyoushaManagerAddressId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param riyoushaManagerAddressId テーブルId
     */
    public void setRiyoushaManagerAddressId(final Integer riyoushaManagerAddressId) {
        this.riyoushaManagerAddressId = riyoushaManagerAddressId;
    }
