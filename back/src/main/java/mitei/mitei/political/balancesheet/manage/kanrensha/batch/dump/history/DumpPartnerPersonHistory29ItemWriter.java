 ...
 */
@Component
public class DumpPartnerPersonHistory29ItemWriter extends FlatFileItemWriter<PartnerPersonHistory29Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory29ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory29Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory29Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
