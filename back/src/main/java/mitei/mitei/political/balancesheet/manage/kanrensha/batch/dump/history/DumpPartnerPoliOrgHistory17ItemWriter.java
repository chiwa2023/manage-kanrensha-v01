 ...
 */
@Component
public class DumpPartnerPoliOrgHistory17ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory17Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory17ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory17Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory17Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
