 ...
 */
@Component
public class DumpPartnerPersonHistory24ItemWriter extends FlatFileItemWriter<PartnerPersonHistory24Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory24ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory24Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory24Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
