 ...
 */
@Component
public class DumpSabunPartnerCorpHistory45ItemReader extends RepositoryItemReader<PartnerCorpHistory45Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory45ItemReader(
            final @Autowired PartnerCorpHistory45Repository partnerCorpHistory45Repository) {
        super();
