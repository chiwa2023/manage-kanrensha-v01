...
/**
 * partner_poli_org_history_13接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_13")
public class PartnerPoliOrgHistory13Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
