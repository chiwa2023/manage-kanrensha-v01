 ...
 */
@Component
public class DumpPartnerPoliOrgHistory05ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory05Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory05ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory05Entity> lineAggregator = new DelimitedLineAggregator<>();
