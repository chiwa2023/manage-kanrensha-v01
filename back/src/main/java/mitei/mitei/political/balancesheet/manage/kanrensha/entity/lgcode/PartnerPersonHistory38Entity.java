...
/**
 * partner_person_history_38接続用Entity
 */
@Entity
@Table(name = "partner_person_history_38")
public class PartnerPersonHistory38Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
