...
/**
 * partner_poli_org_history_42接続用Repository
 */
public interface PartnerPoliOrgHistory42Repository extends JpaRepository<PartnerPoliOrgHistory42Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_42 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory42Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory42Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
