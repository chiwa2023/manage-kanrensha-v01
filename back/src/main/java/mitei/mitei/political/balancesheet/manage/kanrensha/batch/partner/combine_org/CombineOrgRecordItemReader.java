 ...
 */
@Component
public class CombineOrgRecordItemReader extends RepositoryItemReader<WkTblPartnerCombineOrgEntity> {
     ...
     */
    public CombineOrgRecordItemReader(final @Autowired WkTblPartnerCombineOrgRepository wkTblCombineOrgRepository) {
