...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory01ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory02ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory03ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory04ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory05ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory06ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory07ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory08ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory09ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory10ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory11ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory12ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory13ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory14ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory15ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory16ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory17ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory18ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory19ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory20ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory21ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory22ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory23ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory24ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory25ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory26ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory27ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory28ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory29ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory30ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory31ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory32ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory33ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory34ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory35ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory36ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory37ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory38ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory39ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory40ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory41ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory42ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory43ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory44ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory45ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory46ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory47ItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.history.DumpPartnerPersonHistory99ItemWriter;
 ...
 */
@Configuration
public class DumpSabunPartnerPersonHistoryBatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "dumpSabunPartnerPersonHistory";
    ...
    @Autowired
    private DumpSabunPartnerPersonHistory01ItemReader dumpSabunPartnerPersonHistory01ItemReader;
    /** 関連者個人履歴(02)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory02ItemReader dumpSabunPartnerPersonHistory02ItemReader;
    /** 関連者個人履歴(03)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory03ItemReader dumpSabunPartnerPersonHistory03ItemReader;
    /** 関連者個人履歴(04)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory04ItemReader dumpSabunPartnerPersonHistory04ItemReader;
    /** 関連者個人履歴(05)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory05ItemReader dumpSabunPartnerPersonHistory05ItemReader;
    /** 関連者個人履歴(06)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory06ItemReader dumpSabunPartnerPersonHistory06ItemReader;
    /** 関連者個人履歴(07)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory07ItemReader dumpSabunPartnerPersonHistory07ItemReader;
    /** 関連者個人履歴(08)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory08ItemReader dumpSabunPartnerPersonHistory08ItemReader;
    /** 関連者個人履歴(09)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory09ItemReader dumpSabunPartnerPersonHistory09ItemReader;
    /** 関連者個人履歴(10)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory10ItemReader dumpSabunPartnerPersonHistory10ItemReader;
    /** 関連者個人履歴(11)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory11ItemReader dumpSabunPartnerPersonHistory11ItemReader;
    /** 関連者個人履歴(12)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory12ItemReader dumpSabunPartnerPersonHistory12ItemReader;
    /** 関連者個人履歴(13)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory13ItemReader dumpSabunPartnerPersonHistory13ItemReader;
    /** 関連者個人履歴(14)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory14ItemReader dumpSabunPartnerPersonHistory14ItemReader;
    /** 関連者個人履歴(15)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory15ItemReader dumpSabunPartnerPersonHistory15ItemReader;
    /** 関連者個人履歴(16)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory16ItemReader dumpSabunPartnerPersonHistory16ItemReader;
    /** 関連者個人履歴(17)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory17ItemReader dumpSabunPartnerPersonHistory17ItemReader;
    /** 関連者個人履歴(18)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory18ItemReader dumpSabunPartnerPersonHistory18ItemReader;
    /** 関連者個人履歴(19)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory19ItemReader dumpSabunPartnerPersonHistory19ItemReader;
    /** 関連者個人履歴(20)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory20ItemReader dumpSabunPartnerPersonHistory20ItemReader;
    /** 関連者個人履歴(21)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory21ItemReader dumpSabunPartnerPersonHistory21ItemReader;
    /** 関連者個人履歴(22)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory22ItemReader dumpSabunPartnerPersonHistory22ItemReader;
    /** 関連者個人履歴(23)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory23ItemReader dumpSabunPartnerPersonHistory23ItemReader;
    /** 関連者個人履歴(24)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory24ItemReader dumpSabunPartnerPersonHistory24ItemReader;
    /** 関連者個人履歴(25)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory25ItemReader dumpSabunPartnerPersonHistory25ItemReader;
    ...
    @Autowired
    private DumpSabunPartnerPersonHistory27ItemReader dumpSabunPartnerPersonHistory27ItemReader;
    /** 関連者個人履歴(28)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory28ItemReader dumpSabunPartnerPersonHistory28ItemReader;
    /** 関連者個人履歴(29)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory29ItemReader dumpSabunPartnerPersonHistory29ItemReader;
    /** 関連者個人履歴(30)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory30ItemReader dumpSabunPartnerPersonHistory30ItemReader;
    /** 関連者個人履歴(31)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory31ItemReader dumpSabunPartnerPersonHistory31ItemReader;
    /** 関連者個人履歴(32)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory32ItemReader dumpSabunPartnerPersonHistory32ItemReader;
    /** 関連者個人履歴(33)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory33ItemReader dumpSabunPartnerPersonHistory33ItemReader;
    /** 関連者個人履歴(34)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory34ItemReader dumpSabunPartnerPersonHistory34ItemReader;
    /** 関連者個人履歴(35)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory35ItemReader dumpSabunPartnerPersonHistory35ItemReader;
    /** 関連者個人履歴(36)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory36ItemReader dumpSabunPartnerPersonHistory36ItemReader;
    /** 関連者個人履歴(37)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory37ItemReader dumpSabunPartnerPersonHistory37ItemReader;
    /** 関連者個人履歴(38)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory38ItemReader dumpSabunPartnerPersonHistory38ItemReader;
    /** 関連者個人履歴(39)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory39ItemReader dumpSabunPartnerPersonHistory39ItemReader;
    /** 関連者個人履歴(40)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory40ItemReader dumpSabunPartnerPersonHistory40ItemReader;
    /** 関連者個人履歴(41)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory41ItemReader dumpSabunPartnerPersonHistory41ItemReader;
    /** 関連者個人履歴(42)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory42ItemReader dumpSabunPartnerPersonHistory42ItemReader;
    /** 関連者個人履歴(43)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory43ItemReader dumpSabunPartnerPersonHistory43ItemReader;
    /** 関連者個人履歴(44)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory44ItemReader dumpSabunPartnerPersonHistory44ItemReader;
    /** 関連者個人履歴(45)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory45ItemReader dumpSabunPartnerPersonHistory45ItemReader;
    /** 関連者個人履歴(46)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory46ItemReader dumpSabunPartnerPersonHistory46ItemReader;
    /** 関連者個人履歴(47)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory47ItemReader dumpSabunPartnerPersonHistory47ItemReader;
    /** 関連者個人履歴(99)CsvItemReader */
    @Autowired
    private DumpSabunPartnerPersonHistory99ItemReader dumpSabunPartnerPersonHistory99ItemReader;
    ...
    protected Step getStep01(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT01, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory01ItemReader).writer(dumpPartnerPersonHistory01ItemWriter).build();
    }
    ...
    protected Step getStep02(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT02, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory02ItemReader).writer(dumpPartnerPersonHistory02ItemWriter).build();
    }
    ...
    protected Step getStep03(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT03, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory03ItemReader).writer(dumpPartnerPersonHistory03ItemWriter).build();
    }
    ...
    protected Step getStep04(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT04, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory04ItemReader).writer(dumpPartnerPersonHistory04ItemWriter).build();
    }
    ...
    protected Step getStep05(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT05, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory05ItemReader).writer(dumpPartnerPersonHistory05ItemWriter).build();
    }
    ...
    protected Step getStep06(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT06, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory06ItemReader).writer(dumpPartnerPersonHistory06ItemWriter).build();
    }
    ...
    protected Step getStep07(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT07, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory07ItemReader).writer(dumpPartnerPersonHistory07ItemWriter).build();
    }
    ...
    protected Step getStep08(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT01, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory08ItemReader).writer(dumpPartnerPersonHistory08ItemWriter).build();
    }
    ...
    protected Step getStep09(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT09, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory09ItemReader).writer(dumpPartnerPersonHistory09ItemWriter).build();
    }
    ...
    protected Step getStep10(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT10, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory10ItemReader).writer(dumpPartnerPersonHistory10ItemWriter).build();
    }
    ...
    protected Step getStep11(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT11, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory11ItemReader).writer(dumpPartnerPersonHistory11ItemWriter).build();
    }
    ...
    protected Step getStep12(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT12, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory12ItemReader).writer(dumpPartnerPersonHistory12ItemWriter).build();
    }
    ...
    protected Step getStep13(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT13, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory13ItemReader).writer(dumpPartnerPersonHistory13ItemWriter).build();
    }
    ...
    protected Step getStep14(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT14, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory14ItemReader).writer(dumpPartnerPersonHistory14ItemWriter).build();
    }
    ...
    protected Step getStep15(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT15, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory15ItemReader).writer(dumpPartnerPersonHistory15ItemWriter).build();
    }
    ...
    protected Step getStep16(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT16, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory16ItemReader).writer(dumpPartnerPersonHistory16ItemWriter).build();
    }
    ...
    protected Step getStep17(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT17, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory17ItemReader).writer(dumpPartnerPersonHistory17ItemWriter).build();
    }
    ...
    protected Step getStep18(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT18, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory18ItemReader).writer(dumpPartnerPersonHistory18ItemWriter).build();
    }
    ...
    protected Step getStep19(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT19, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory19ItemReader).writer(dumpPartnerPersonHistory19ItemWriter).build();
    }
    ...
    protected Step getStep20(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT20, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory20ItemReader).writer(dumpPartnerPersonHistory20ItemWriter).build();
    }
    ...
    protected Step getStep21(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT21, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory21ItemReader).writer(dumpPartnerPersonHistory21ItemWriter).build();
    }
    ...
    protected Step getStep22(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT22, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory22ItemReader).writer(dumpPartnerPersonHistory22ItemWriter).build();
    }
    ...
    protected Step getStep23(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT23, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory23ItemReader).writer(dumpPartnerPersonHistory23ItemWriter).build();
    }
    ...
    protected Step getStep24(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT24, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory24ItemReader).writer(dumpPartnerPersonHistory24ItemWriter).build();
    }
    ...
    protected Step getStep25(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT25, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory25ItemReader).writer(dumpPartnerPersonHistory25ItemWriter).build();
    }
    ...
    protected Step getStep26(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT26, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory26ItemReader).writer(dumpPartnerPersonHistory26ItemWriter).build();
    }
    ...
    protected Step getStep27(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT27, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory27ItemReader).writer(dumpPartnerPersonHistory27ItemWriter).build();
    }
    ...
    protected Step getStep28(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT28, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory28ItemReader).writer(dumpPartnerPersonHistory28ItemWriter).build();
    }
    ...
    protected Step getStep29(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT29, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory29ItemReader).writer(dumpPartnerPersonHistory29ItemWriter).build();
    }
    ...
    protected Step getStep30(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT30, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory30ItemReader).writer(dumpPartnerPersonHistory30ItemWriter).build();
    }
    ...
    protected Step getStep31(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT31, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory31ItemReader).writer(dumpPartnerPersonHistory31ItemWriter).build();
    }
    ...
    protected Step getStep32(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT32, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory32ItemReader).writer(dumpPartnerPersonHistory32ItemWriter).build();
    }
    ...
    protected Step getStep33(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT33, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory33ItemReader).writer(dumpPartnerPersonHistory33ItemWriter).build();
    }
    ...
    protected Step getStep34(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT34, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory34ItemReader).writer(dumpPartnerPersonHistory34ItemWriter).build();
    }
    ...
    protected Step getStep35(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT35, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory35ItemReader).writer(dumpPartnerPersonHistory35ItemWriter).build();
    }
    ...
    protected Step getStep36(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT36, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory36ItemReader).writer(dumpPartnerPersonHistory36ItemWriter).build();
    }
    ...
    protected Step getStep37(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT37, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory37ItemReader).writer(dumpPartnerPersonHistory37ItemWriter).build();
    }
    ...
    protected Step getStep38(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT38, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory38ItemReader).writer(dumpPartnerPersonHistory38ItemWriter).build();
    }
    ...
    protected Step getStep39(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT39, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory39ItemReader).writer(dumpPartnerPersonHistory39ItemWriter).build();
    }
    ...
    protected Step getStep40(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT40, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory40ItemReader).writer(dumpPartnerPersonHistory40ItemWriter).build();
    }
    ...
    protected Step getStep41(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT41, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory41ItemReader).writer(dumpPartnerPersonHistory41ItemWriter).build();
    }
    ...
    protected Step getStep42(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT42, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory42ItemReader).writer(dumpPartnerPersonHistory42ItemWriter).build();
    }
    ...
    protected Step getStep43(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT43, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory43ItemReader).writer(dumpPartnerPersonHistory43ItemWriter).build();
    }
    ...
    protected Step getStep44(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT44, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory44ItemReader).writer(dumpPartnerPersonHistory44ItemWriter).build();
    }
    ...
    protected Step getStep45(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT45, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory45ItemReader).writer(dumpPartnerPersonHistory45ItemWriter).build();
    }
    ...
    protected Step getStep46(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT46, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory46ItemReader).writer(dumpPartnerPersonHistory46ItemWriter).build();
    }
    ...
    protected Step getStep47(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT47, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory47ItemReader).writer(dumpPartnerPersonHistory47ItemWriter).build();
    }
    ...
    protected Step getStep99(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        return new StepBuilder(STEP_OUTPUT99, jobRepository)
                ...
                .reader(dumpSabunPartnerPersonHistory99ItemReader).writer(dumpPartnerPersonHistory99ItemWriter).build();
    }
