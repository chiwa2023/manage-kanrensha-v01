 ...
 */
@Component
public class CombineOrgWkTblFixItemReader extends RepositoryItemReader<WkTblPartnerCombineOrgJudgeEntity> {

    /**
     * コンストラクタ
     *
     * @param wkCombineOrgJudgeRepository 個人団体紐づけ判定ワークテーブルRepository
     */
    public CombineOrgWkTblFixItemReader(
            final @Autowired WkTblPartnerCombineOrgJudgeRepository wkCombineOrgJudgeRepository) {

        super();
        super.setRepository(wkCombineOrgJudgeRepository);
