...
/**
 * partner_corp_history_40接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_40")
public class PartnerCorpHistory40Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
