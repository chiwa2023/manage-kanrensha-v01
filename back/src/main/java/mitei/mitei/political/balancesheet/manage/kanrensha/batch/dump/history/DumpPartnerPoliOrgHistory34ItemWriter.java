 ...
 */
@Component
public class DumpPartnerPoliOrgHistory34ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory34Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory34ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory34Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory34Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
