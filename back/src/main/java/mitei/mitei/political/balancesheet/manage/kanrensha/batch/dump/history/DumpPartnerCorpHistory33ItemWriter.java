 ...
 */
@Component
public class DumpPartnerCorpHistory33ItemWriter extends FlatFileItemWriter<PartnerCorpHistory33Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory33ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory33Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory33Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
