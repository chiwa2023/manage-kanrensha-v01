 ...
 */
@Component
public class DumpPartnerPersonHistory32ItemWriter extends FlatFileItemWriter<PartnerPersonHistory32Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory32ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory32Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory32Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
