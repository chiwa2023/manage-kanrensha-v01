...
/**
 * partner_corp_history_05接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_05")
public class PartnerCorpHistory05Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
