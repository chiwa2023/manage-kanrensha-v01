...
/**
 * partner_poli_org_history_11接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_11")
public class PartnerPoliOrgHistory11Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
