 ...
 */
@Component
public class DumpPartnerCorpHistory24ItemWriter extends FlatFileItemWriter<PartnerCorpHistory24Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory24ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory24Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory24Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
