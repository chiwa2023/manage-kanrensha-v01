 ...
 */
@Component
public class DumpPartnerCorpHistory40ItemWriter extends FlatFileItemWriter<PartnerCorpHistory40Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory40ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory40Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory40Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
