...
/**
 * partner_person_history_09接続用Entity
 */
@Entity
@Table(name = "partner_person_history_09")
public class PartnerPersonHistory09Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
