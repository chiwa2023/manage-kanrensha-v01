 ...
 */
public interface PartnerPersonHistory01Repository extends JpaRepository<PartnerPersonHistory01Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory01Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
