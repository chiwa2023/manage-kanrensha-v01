 ...
 */
@Component
public class DumpPartnerPersonHistory18ItemWriter extends FlatFileItemWriter<PartnerPersonHistory18Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory18ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory18Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory18Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
