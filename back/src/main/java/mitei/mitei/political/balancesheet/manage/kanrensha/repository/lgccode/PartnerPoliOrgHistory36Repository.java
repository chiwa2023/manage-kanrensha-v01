...
/**
 * partner_poli_org_history_36接続用Repository
 */
public interface PartnerPoliOrgHistory36Repository extends JpaRepository<PartnerPoliOrgHistory36Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_36 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory36Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory36Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
