 ...
 */
@Component
public class DumpPartnerPoliOrgHistory27ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory27Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory27ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory27Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory27Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
