...
/**
 * partner_corp_history_24接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_24")
public class PartnerCorpHistory24Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
