 ...
 */
@Component
public class DumpPartnerPoliOrgHistory40ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory40Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory40ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory40Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory40Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
