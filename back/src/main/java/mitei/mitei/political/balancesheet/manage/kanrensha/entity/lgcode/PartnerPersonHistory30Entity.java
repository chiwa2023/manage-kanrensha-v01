...
/**
 * partner_person_history_30接続用Entity
 */
@Entity
@Table(name = "partner_person_history_30")
public class PartnerPersonHistory30Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
