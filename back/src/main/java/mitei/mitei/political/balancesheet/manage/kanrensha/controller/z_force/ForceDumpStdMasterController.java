...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.z_force.AsyncForceDumpStdMasterService;

/**
 * マスタ標準ダンプController
 */
@RestController
@RequestMapping("/dump-master-std")
public class ForceDumpStdMasterController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(final @RequestBody ForceDumpCapsuleDto capsuleDto) {
        ...
        asyncForceDumpStdMasterService.practice(capsuleDto);
