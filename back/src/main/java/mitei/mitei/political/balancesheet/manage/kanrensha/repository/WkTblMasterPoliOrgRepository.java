...
/**
 * wk_tbl_master_poli_org接続用Repository
 */
public interface WkTblMasterPoliOrgRepository extends JpaRepository<WkTblMasterPoliOrgEntity, Integer> {
     ...
     * @return 検索結果
     */
    Page<WkTblMasterPoliOrgEntity> findByInsertUserCodeAndIsLatest(Integer userCode, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT distinct partner_name, all_address, poli_org_delegate FROM wk_tbl_master_poli_org WHERE insert_user_code = ?1 "
     ...
     * @return 検索結果
     */
    List<WkTblMasterPoliOrgEntity> findByPartnerNameAndAllAddressAndPoliOrgDelegateAndInsertUserCodeOrderByWkTblMasterPoliOrgIdAsc( // NOPMD
    ...
    Optional<WkTblMasterPoliOrgEntity> findFirstByOrderByWkTblMasterPoliOrgCodeDesc();
     ...
     * @return 検索結果
     */
    Page<WkTblMasterPoliOrgEntity> findByInsertUserCodeAndIsLatestAndIsAffected(Integer userCode, boolean isLatest,
     ...
     * @return 検索結果
     */
    List<WkTblMasterPoliOrgEntity> findByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(Integer userCode,
