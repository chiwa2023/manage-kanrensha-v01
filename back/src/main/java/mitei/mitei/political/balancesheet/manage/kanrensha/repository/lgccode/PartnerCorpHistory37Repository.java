...
/**
 * partner_corp_history_37接続用Repository
 */
public interface PartnerCorpHistory37Repository extends JpaRepository<PartnerCorpHistory37Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_37 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory37Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory37Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
