...
/**
 * partner_person_history_08接続用Entity
 */
@Entity
@Table(name = "partner_person_history_08")
public class PartnerPersonHistory08Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
