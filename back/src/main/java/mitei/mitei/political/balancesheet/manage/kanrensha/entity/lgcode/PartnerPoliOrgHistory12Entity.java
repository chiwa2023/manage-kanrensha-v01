...
/**
 * partner_poli_org_history_12接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_12")
public class PartnerPoliOrgHistory12Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
