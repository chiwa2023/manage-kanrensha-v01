 ...
 */
@Component
public class DumpSabunPartnerPersonHistory99ItemReader extends RepositoryItemReader<PartnerPersonHistory99Entity> {
     ...
     */
    public DumpSabunPartnerPersonHistory99ItemReader(
            final @Autowired PartnerPersonHistory99Repository partnerPersonHistory99Repository) {
        super();
