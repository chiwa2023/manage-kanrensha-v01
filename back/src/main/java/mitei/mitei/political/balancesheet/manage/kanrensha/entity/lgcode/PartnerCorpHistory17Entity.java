...
/**
 * partner_corp_history_17接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_17")
public class PartnerCorpHistory17Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
