 ...
 */
@Component
public class DumpPartnerPersonHistory08ItemWriter extends FlatFileItemWriter<PartnerPersonHistory08Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory08ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory08Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory08Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
