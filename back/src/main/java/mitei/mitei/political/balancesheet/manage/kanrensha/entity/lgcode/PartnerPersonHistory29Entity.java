...
/**
 * partner_person_history_29接続用Entity
 */
@Entity
@Table(name = "partner_person_history_29")
public class PartnerPersonHistory29Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
