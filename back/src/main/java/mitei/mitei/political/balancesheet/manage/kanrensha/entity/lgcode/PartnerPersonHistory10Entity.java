...
/**
 * partner_person_history_10接続用Entity
 */
@Entity
@Table(name = "partner_person_history_10")
public class PartnerPersonHistory10Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
