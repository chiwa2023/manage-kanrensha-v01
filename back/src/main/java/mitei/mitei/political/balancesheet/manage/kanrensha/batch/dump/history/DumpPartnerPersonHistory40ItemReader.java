 ...
 */
@Component
public class DumpPartnerPersonHistory40ItemReader extends RepositoryItemReader<PartnerPersonHistory40Entity> {
     ...
     */
    public DumpPartnerPersonHistory40ItemReader(
            final @Autowired PartnerPersonHistory40Repository partnerPersonHistory40Repository) {
        super();
