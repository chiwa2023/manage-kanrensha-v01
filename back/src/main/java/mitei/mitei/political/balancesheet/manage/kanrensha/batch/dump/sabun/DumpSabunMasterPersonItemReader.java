 ...
 */
@Component
public class DumpSabunMasterPersonItemReader extends RepositoryItemReader<MasterPersonEntity> {

    /**
     * コンストラクタ
     *
     * @param masterPersonRepository 関連者個人マスタRepository
     */
    public DumpSabunMasterPersonItemReader(final @Autowired MasterPersonRepository masterPersonRepository) {
        super();
