...
/**
 * partner_person_history_45接続用Entity
 */
@Entity
@Table(name = "partner_person_history_45")
public class PartnerPersonHistory45Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
