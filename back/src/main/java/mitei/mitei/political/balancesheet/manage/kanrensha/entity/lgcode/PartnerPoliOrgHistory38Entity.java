...
/**
 * partner_poli_org_history_38接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_38")
public class PartnerPoliOrgHistory38Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
