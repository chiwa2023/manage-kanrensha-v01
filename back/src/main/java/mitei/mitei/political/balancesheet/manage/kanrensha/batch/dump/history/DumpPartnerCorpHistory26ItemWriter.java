 ...
 */
@Component
public class DumpPartnerCorpHistory26ItemWriter extends FlatFileItemWriter<PartnerCorpHistory26Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory26ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory26Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory26Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
