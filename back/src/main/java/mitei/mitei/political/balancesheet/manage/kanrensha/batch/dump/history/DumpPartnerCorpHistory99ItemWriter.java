 ...
 */
@Component
public class DumpPartnerCorpHistory99ItemWriter extends FlatFileItemWriter<PartnerCorpHistory99Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory99ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory99Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory99Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
