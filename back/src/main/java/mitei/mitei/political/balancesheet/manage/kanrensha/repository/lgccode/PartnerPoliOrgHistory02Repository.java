...
/**
 * partner_poli_org_history_02接続用Repository
 */
public interface PartnerPoliOrgHistory02Repository extends JpaRepository<PartnerPoliOrgHistory02Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_02 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory02Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory02Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
