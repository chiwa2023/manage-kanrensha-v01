...
/**
 * partner_poli_org_history_10接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_10")
public class PartnerPoliOrgHistory10Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
