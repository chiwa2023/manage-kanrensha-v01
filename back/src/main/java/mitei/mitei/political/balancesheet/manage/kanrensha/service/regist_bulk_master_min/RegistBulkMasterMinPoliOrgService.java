...
public class RegistBulkMasterMinPoliOrgService {
     ...
     */
    @Transactional
    public Integer practice(final UpdateWkTblMinPoliOrgCapsuleDto capsuleDto) {
        ...
        return wkTblPartnerPoliOrgAddMinRepository.save(entityInput).getWkTblPartnerPoliOrgAddMinId();
    }
