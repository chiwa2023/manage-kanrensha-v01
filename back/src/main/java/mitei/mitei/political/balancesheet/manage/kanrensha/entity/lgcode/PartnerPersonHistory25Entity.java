...
/**
 * partner_person_history_25接続用Entity
 */
@Entity
@Table(name = "partner_person_history_25")
public class PartnerPersonHistory25Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
