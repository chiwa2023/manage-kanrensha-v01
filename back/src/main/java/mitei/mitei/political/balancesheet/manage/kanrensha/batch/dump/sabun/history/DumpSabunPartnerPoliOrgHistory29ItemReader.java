 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory29ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory29Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory29ItemReader(
            final @Autowired PartnerPoliOrgHistory29Repository partnerPoliOrgHistory29Repository) {
        super();
