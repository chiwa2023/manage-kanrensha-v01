 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory34ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory34Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory34ItemReader(
            final @Autowired PartnerPoliOrgHistory34Repository partnerPoliOrgHistory34Repository) {
        super();
