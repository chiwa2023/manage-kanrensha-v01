...
//     * @return 検索結果
//     */
//    @Query(value = "SELECT * FROM riyousha_manager_name WHERE saishin_kbn= 1 AND MATCH(riyousha_manager_name_name) AGAINST (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
//    List<RiyoushaManagerNameEntity> findFullText(String searchWords);
