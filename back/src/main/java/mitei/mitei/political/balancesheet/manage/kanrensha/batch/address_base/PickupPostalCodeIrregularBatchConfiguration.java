...
/**
 * 郵便番号不規則データ抽出BachConfig
 */
@Configuration
public class PickupPostalCodeIrregularBatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "pickupPostalCodeIrregular";
    ...
    @Autowired
    private PostalCodeToIrregularProceesor postalCodeToIrregularProceesor;
    ...
    protected Step getStepWrite(final JobRepository jobRepository,
        ...
        return new StepBuilder(STEP_INSERT_NAME, jobRepository)
                .<AddressPostalEntity, AddressPostalIrregularEntity>chunk(CHUNK_SIZE, transactionManager)
                .reader(postalCodeIrregularItemReader).processor(postalCodeToIrregularProceesor)
                .writer(postalCodeIrregularItemWriter).build();
    }
