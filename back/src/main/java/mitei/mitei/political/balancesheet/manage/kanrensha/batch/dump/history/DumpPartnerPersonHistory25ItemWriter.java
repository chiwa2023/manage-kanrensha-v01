 ...
 */
@Component
public class DumpPartnerPersonHistory25ItemWriter extends FlatFileItemWriter<PartnerPersonHistory25Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory25ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory25Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory25Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
