...
import mitei.mitei.political.balancesheet.manage.kanrensha.logic.year.y2025.InsertSaveStorageY2025Logic;
...
public class SwitchYearInsertSaveStorageService {
     ...
     * @return テーブルId
     */
    public Integer practice(final int year, final UserPersonLeastDto userDto, final Path path, final Short shoshouKbn) {
