 ...
 */
@Component
public class DumpPartnerPoliOrgHistory02ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory02Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory02ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory02Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory02Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
