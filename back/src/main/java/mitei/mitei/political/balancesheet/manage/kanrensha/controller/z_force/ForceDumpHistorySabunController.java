...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.z_force.AsyncForceDumpHistorySabunService;

/**
 * 履歴差分ダンプController
 */
@RestController
@RequestMapping("/dump-history-sabun")
public class ForceDumpHistorySabunController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(final @RequestBody ForceDumpCapsuleDto capsuleDto) {
        ...
        asyncForceDumpHistorySabunService.practice(capsuleDto);
