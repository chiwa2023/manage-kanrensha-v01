...
/**
 * partner_corp_history_35接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_35")
public class PartnerCorpHistory35Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
