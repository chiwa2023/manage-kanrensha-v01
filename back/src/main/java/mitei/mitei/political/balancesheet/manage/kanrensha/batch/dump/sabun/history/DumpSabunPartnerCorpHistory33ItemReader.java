 ...
 */
@Component
public class DumpSabunPartnerCorpHistory33ItemReader extends RepositoryItemReader<PartnerCorpHistory33Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory33ItemReader(
            final @Autowired PartnerCorpHistory33Repository partnerCorpHistory33Repository) {
        super();
