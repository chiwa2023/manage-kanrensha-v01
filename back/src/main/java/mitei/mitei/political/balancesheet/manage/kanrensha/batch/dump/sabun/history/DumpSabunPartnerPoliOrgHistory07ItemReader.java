 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory07ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory07Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory07ItemReader(
            final @Autowired PartnerPoliOrgHistory07Repository partnerPoliOrgHistory07Repository) {
        super();
