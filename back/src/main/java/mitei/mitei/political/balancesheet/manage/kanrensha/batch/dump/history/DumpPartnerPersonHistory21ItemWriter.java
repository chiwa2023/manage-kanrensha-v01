 ...
 */
@Component
public class DumpPartnerPersonHistory21ItemWriter extends FlatFileItemWriter<PartnerPersonHistory21Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory21ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory21Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory21Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
