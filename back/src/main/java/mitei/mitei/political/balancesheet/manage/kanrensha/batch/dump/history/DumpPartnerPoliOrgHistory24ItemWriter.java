 ...
 */
@Component
public class DumpPartnerPoliOrgHistory24ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory24Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory24ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory24Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory24Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
