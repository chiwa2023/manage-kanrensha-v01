 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory17ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory17Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory17ItemReader(
            final @Autowired PartnerPoliOrgHistory17Repository partnerPoliOrgHistory17Repository) {
        super();
