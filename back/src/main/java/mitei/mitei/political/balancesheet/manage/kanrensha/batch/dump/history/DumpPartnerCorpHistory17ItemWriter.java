 ...
 */
@Component
public class DumpPartnerCorpHistory17ItemWriter extends FlatFileItemWriter<PartnerCorpHistory17Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory17ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory17Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory17Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
