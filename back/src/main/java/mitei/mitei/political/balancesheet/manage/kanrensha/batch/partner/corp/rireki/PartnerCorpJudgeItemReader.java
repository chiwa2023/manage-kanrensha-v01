 ...
 */
@Component
public class PartnerCorpJudgeItemReader extends RepositoryItemReader<WkTblPartnerCorpHistoryEntity> {

    /**
     * コンストラクタ
     *
     * @param wkTblPartnerCorpHistoryRepository 関連者企業・団体ワークテーブルRepository
     */
    public PartnerCorpJudgeItemReader(
            final @Autowired WkTblPartnerCorpHistoryRepository wkTblPartnerCorpHistoryRepository) {
