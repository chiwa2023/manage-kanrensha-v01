...
/**
 * partner_poli_org_history_01接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_01")
public class PartnerPoliOrgHistoryBaseEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
