...
/**
 * partner_corp_history_09接続用Repository
 */
public interface PartnerCorpHistory09Repository extends JpaRepository<PartnerCorpHistory09Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_09 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory09Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory09Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
