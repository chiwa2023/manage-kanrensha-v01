...
/**
 * partner_corp_history_10接続用Repository
 */
public interface PartnerCorpHistory10Repository extends JpaRepository<PartnerCorpHistory10Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_10 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory10Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory10Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
