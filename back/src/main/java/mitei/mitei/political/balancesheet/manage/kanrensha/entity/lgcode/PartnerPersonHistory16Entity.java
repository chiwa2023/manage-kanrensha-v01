...
/**
 * partner_person_history_16接続用Entity
 */
@Entity
@Table(name = "partner_person_history_16")
public class PartnerPersonHistory16Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
