 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory35ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory35Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory35ItemReader(
            final @Autowired PartnerPoliOrgHistory35Repository partnerPoliOrgHistory35Repository) {
        super();
