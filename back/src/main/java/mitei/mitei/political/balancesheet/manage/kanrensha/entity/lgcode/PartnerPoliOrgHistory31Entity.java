...
/**
 * partner_poli_org_history_31接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_31")
public class PartnerPoliOrgHistory31Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
