...
/**
 * partner_poli_org_history_29接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_29")
public class PartnerPoliOrgHistory29Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
