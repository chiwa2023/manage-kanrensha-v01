 ...
 */
@Component
public class DumpPartnerPoliOrgHistory25ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory25Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory25ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory25Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory25Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
