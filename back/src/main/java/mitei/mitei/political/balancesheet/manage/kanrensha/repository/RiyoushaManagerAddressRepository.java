...
//     * @return 検索結果
//     */
//    @Query(value = "SELECT * FROM riyousha_manager_address WHERE saishin_kbn= 1 AND MATCH(riyousha_manager_address_name) AGAINST (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
//    List<RiyoushaManagerAddressEntity> findFullText(String searchWords);
