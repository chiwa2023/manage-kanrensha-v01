 ...
 */
@Component
public class DumpSabunPartnerCorpHistory20ItemReader extends RepositoryItemReader<PartnerCorpHistory20Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory20ItemReader(
            final @Autowired PartnerCorpHistory20Repository partnerCorpHistory20Repository) {
        super();
