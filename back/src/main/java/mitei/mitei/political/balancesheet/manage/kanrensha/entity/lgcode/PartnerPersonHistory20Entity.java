...
/**
 * partner_person_history_20接続用Entity
 */
@Entity
@Table(name = "partner_person_history_20")
public class PartnerPersonHistory20Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
