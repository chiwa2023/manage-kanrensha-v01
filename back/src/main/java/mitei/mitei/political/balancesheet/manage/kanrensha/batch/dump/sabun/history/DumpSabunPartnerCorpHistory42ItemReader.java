 ...
 */
@Component
public class DumpSabunPartnerCorpHistory42ItemReader extends RepositoryItemReader<PartnerCorpHistory42Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory42ItemReader(
            final @Autowired PartnerCorpHistory42Repository partnerCorpHistory42Repository) {
        super();
