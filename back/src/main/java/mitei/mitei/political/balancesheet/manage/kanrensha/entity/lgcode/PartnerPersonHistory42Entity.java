...
/**
 * partner_person_history_42接続用Entity
 */
@Entity
@Table(name = "partner_person_history_42")
public class PartnerPersonHistory42Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
