...
/**
 * partner_corp_history_99接続用Repository
 */
public interface PartnerCorpHistory99Repository extends JpaRepository<PartnerCorpHistory99Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_99 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory99Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory99Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
