 ...
 */
@Component
public class DumpPartnerPersonHistory35ItemWriter extends FlatFileItemWriter<PartnerPersonHistory35Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory35ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory35Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory35Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
