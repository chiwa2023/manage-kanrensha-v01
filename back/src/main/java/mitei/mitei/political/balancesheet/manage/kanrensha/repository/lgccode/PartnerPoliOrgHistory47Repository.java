...
/**
 * partner_poli_org_history_47接続用Repository
 */
public interface PartnerPoliOrgHistory47Repository extends JpaRepository<PartnerPoliOrgHistory47Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_47 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory47Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory47Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
