 ...
 */
@Component
public class DumpPartnerPersonHistory16ItemWriter extends FlatFileItemWriter<PartnerPersonHistory16Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory16ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory16Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory16Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
