...
/**
 * partner_corp_history_21接続用Repository
 */
public interface PartnerCorpHistory21Repository extends JpaRepository<PartnerCorpHistory21Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_21 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory21Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory21Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
