...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.regist_bulk_history.ExecuteBatchHistoryPoliOrgService;
...
public class ExecuteBatchHistoryPoliOrgController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        executeBatchHistoryPoliOrgService.practice(Paths.get(fileDto.getSavedDir(), fileDto.getFileName()).toString(),
