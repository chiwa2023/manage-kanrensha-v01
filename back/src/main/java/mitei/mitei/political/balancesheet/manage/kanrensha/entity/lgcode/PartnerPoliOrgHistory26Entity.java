...
/**
 * partner_poli_org_history_26接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_26")
public class PartnerPoliOrgHistory26Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
