...
/**
 * partner_corp_history_46接続用Repository
 */
public interface PartnerCorpHistory46Repository extends JpaRepository<PartnerCorpHistory46Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_46 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory46Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory46Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
