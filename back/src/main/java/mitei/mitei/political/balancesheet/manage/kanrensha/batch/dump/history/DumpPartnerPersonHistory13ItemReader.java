 ...
 */
@Component
public class DumpPartnerPersonHistory13ItemReader extends RepositoryItemReader<PartnerPersonHistory13Entity> {
     ...
     */
    public DumpPartnerPersonHistory13ItemReader(
            final @Autowired PartnerPersonHistory13Repository partnerPersonHistory13Repository) {
        super();
