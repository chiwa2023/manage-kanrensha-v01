 ...
 */
@Service
public class SearchBulkMasterStdPoliOrgService {
     ...
     * @return 検索結果
     */
    public SearchWkTblStdPoliOrgPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblMasterPoliOrgRepository.countByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
        ...
        SearchWkTblStdPoliOrgPagingResultDto resultDto = new SearchWkTblStdPoliOrgPagingResultDto();
        resultDto.setAllCount(allCount);
        resultDto.setLimit(limit);
        resultDto.setPageNumber(pageNumber);
        resultDto.setListWktblPoliOrg(wkTblMasterPoliOrgRepository
