...
import mitei.mitei.political.balancesheet.manage.kanrensha.dto.wktbl_std.SearchWkTblStdPersonPagingResultDto;
...
public class SearchBulkMasterStdPersonService {
    ...
    public SearchWkTblStdPersonPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblMasterPersonRepository.countByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
        ...
        resultDto.setListWktblPerson(wkTblMasterPersonRepository
