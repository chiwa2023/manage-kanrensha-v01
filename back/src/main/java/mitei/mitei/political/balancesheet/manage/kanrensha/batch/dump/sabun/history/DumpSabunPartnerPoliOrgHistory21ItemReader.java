 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory21ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory21Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory21ItemReader(
            final @Autowired PartnerPoliOrgHistory21Repository partnerPoliOrgHistory21Repository) {
        super();
