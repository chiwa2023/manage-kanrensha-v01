...
/**
 * partner_corp_history_42接続用Repository
 */
public interface PartnerCorpHistory42Repository extends JpaRepository<PartnerCorpHistory42Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_42 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory42Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory42Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
