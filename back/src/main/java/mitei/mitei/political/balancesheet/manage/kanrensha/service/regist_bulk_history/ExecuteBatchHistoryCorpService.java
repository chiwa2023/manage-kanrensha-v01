...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.partner.corp.rireki.InsertKanrenshaCorpHistoryBatchConfiguration;
...
public class ExecuteBatchHistoryCorpService {
    ...
    public void practice(final String readFilePath, final UserPersonLeastDto userDto) {
        ...
        try {
            jobLauncher.run(insertKanrenshaCorpHistory, jobParameters);
