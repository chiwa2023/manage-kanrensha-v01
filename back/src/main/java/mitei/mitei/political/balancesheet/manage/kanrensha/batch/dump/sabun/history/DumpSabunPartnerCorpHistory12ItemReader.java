 ...
 */
@Component
public class DumpSabunPartnerCorpHistory12ItemReader extends RepositoryItemReader<PartnerCorpHistory12Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory12ItemReader(
            final @Autowired PartnerCorpHistory12Repository partnerCorpHistory12Repository) {
        super();
