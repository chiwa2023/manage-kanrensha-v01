 ...
 */
@Component
public class DumpPartnerCorpHistory20ItemWriter extends FlatFileItemWriter<PartnerCorpHistory20Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory20ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory20Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory20Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
