 ...
 */
@Component
public class DumpPartnerPersonHistory28ItemWriter extends FlatFileItemWriter<PartnerPersonHistory28Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory28ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory28Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory28Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
