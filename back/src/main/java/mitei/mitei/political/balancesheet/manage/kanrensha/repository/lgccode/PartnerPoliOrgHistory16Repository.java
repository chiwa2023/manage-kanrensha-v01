...
/**
 * partner_poli_org_history_16接続用Repository
 */
public interface PartnerPoliOrgHistory16Repository extends JpaRepository<PartnerPoliOrgHistory16Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_16 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory16Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory16Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
