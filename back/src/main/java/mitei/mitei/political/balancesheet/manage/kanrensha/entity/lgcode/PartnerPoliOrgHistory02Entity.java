...
/**
 * partner_poli_org_history_02接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_02")
public class PartnerPoliOrgHistory02Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
