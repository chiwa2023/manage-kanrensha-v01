 ...
 */
@Component
public class DumpPartnerCorpHistory32ItemWriter extends FlatFileItemWriter<PartnerCorpHistory32Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory32ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory32Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory32Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
