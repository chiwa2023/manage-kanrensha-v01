 ...
 */
@Component
public class DumpPartnerCorpHistory36ItemWriter extends FlatFileItemWriter<PartnerCorpHistory36Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory36ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory36Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory36Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
