...
/**
 * partner_poli_org_history_07接続用Repository
 */
public interface PartnerPoliOrgHistory07Repository extends JpaRepository<PartnerPoliOrgHistory07Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_07 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory07Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory07Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
