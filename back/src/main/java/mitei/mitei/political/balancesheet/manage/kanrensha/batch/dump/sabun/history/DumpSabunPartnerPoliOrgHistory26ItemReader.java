 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory26ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory26Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory26ItemReader(
            final @Autowired PartnerPoliOrgHistory26Repository partnerPoliOrgHistory26Repository) {
        super();
