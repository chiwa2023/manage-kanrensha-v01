 ...
 */
@Component
public class DumpPartnerPersonHistory33ItemReader extends RepositoryItemReader<PartnerPersonHistory33Entity> {
     ...
     */
    public DumpPartnerPersonHistory33ItemReader(
            final @Autowired PartnerPersonHistory33Repository partnerPersonHistory33Repository) {
        super();
