 ...
 */
@Component
public class DumpPartnerPoliOrgHistory44ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory44Entity> {
     ...
     */
    public DumpPartnerPoliOrgHistory44ItemReader(
            final @Autowired PartnerPoliOrgHistory44Repository partnerPoliOrgHistory44Repository) {
        super();
