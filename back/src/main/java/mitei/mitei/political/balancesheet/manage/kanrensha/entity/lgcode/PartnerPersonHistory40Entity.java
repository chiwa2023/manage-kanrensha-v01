...
/**
 * partner_person_history_40接続用Entity
 */
@Entity
@Table(name = "partner_person_history_40")
public class PartnerPersonHistory40Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
