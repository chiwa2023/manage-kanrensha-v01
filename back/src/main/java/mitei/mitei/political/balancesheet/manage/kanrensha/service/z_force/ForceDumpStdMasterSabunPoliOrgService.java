...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.sabun.DumpSabunMasterPoliticalOrganizationBatchConfiguration;
...
public class ForceDumpStdMasterSabunPoliOrgService {
    ...
    public void practice(final LocalDate startDate, final LocalDate endDate) {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, SabunMasterStd.SABUN_STD_POLI_ORG).toString())
                .toJobParameters();
