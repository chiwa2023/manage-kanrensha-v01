 ...
 */
@Component
public class CombineOrgCsvItemReader extends FlatFileItemReader<PartnerCombineOrgDto> {
     ...
     */
    public CombineOrgCsvItemReader(final @Autowired PartnerCombineOrgLineMapper lineMapper) {
        super();
