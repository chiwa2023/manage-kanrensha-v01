 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory23ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory23Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory23ItemReader(
            final @Autowired PartnerPoliOrgHistory23Repository partnerPoliOrgHistory23Repository) {
        super();
