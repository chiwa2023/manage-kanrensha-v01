 ...
 */
@Component
public class DumpPartnerPoliOrgHistory32ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory32Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory32ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory32Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory32Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
