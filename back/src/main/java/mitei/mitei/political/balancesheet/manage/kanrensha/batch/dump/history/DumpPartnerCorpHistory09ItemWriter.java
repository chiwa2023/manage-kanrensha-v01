 ...
 */
@Component
public class DumpPartnerCorpHistory09ItemWriter extends FlatFileItemWriter<PartnerCorpHistory09Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory09ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory09Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory09Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
