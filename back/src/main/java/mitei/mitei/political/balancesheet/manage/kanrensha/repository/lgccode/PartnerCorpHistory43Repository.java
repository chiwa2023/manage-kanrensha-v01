...
/**
 * partner_corp_history_43接続用Repository
 */
public interface PartnerCorpHistory43Repository extends JpaRepository<PartnerCorpHistory43Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_43 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory43Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory43Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
