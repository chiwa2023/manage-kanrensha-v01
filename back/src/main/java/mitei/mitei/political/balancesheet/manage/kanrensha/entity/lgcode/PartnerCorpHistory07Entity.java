...
/**
 * partner_corp_history_07接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_07")
public class PartnerCorpHistory07Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
