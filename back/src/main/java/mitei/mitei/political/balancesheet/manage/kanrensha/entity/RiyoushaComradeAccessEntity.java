...
/**
 * riyousha_comrade_access接続用Entity
 */
@Entity
@Table(name = "riyousha_comrade_access")
public class RiyoushaComradeAccessEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "riyousha_comrade_access_id")
    private Integer riyoushaComradeAccessId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getRiyoushaComradeAccessId() {
        return riyoushaComradeAccessId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param riyoushaComradeAccessId テーブルId
     */
    public void setRiyoushaComradeAccessId(final Integer riyoushaComradeAccessId) {
        this.riyoushaComradeAccessId = riyoushaComradeAccessId;
    }
