...
/**
 * partner_poli_org_history_03接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_03")
public class PartnerPoliOrgHistory03Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
