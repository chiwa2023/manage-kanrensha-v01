 ...
 */
@Component
public class DumpPartnerPoliOrgHistory42ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory42Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory42ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory42Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory42Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
