 ...
 */
@Component
public class DumpPartnerPoliOrgHistory23ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory23Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory23ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory23Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory23Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
