...
/**
 * partner_poli_org_history_15接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_15")
public class PartnerPoliOrgHistory15Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
