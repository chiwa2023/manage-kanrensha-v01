...
/**
 * partner_poli_org_history_22接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_22")
public class PartnerPoliOrgHistory22Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
