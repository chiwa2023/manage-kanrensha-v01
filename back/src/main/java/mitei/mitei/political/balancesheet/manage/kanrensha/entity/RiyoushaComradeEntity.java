...
/**
 * riyousha_comrade接続用Entity
 */
@Entity
@Table(name = "riyousha_comrade")
public class RiyoushaComradeEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
