...
/**
 * partner_corp_history_33接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_33")
public class PartnerCorpHistory33Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
