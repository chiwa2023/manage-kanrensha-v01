...
/**
 * partner_person_history_41接続用Entity
 */
@Entity
@Table(name = "partner_person_history_41")
public class PartnerPersonHistory41Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
