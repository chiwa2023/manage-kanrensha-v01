...
/**
 * partner_poli_org_history_26接続用Repository
 */
public interface PartnerPoliOrgHistory26Repository extends JpaRepository<PartnerPoliOrgHistory26Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_26 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory26Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory26Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
