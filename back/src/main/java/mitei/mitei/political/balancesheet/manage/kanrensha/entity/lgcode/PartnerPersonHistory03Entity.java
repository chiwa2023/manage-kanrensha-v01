...
/**
 * partner_person_history_03接続用Entity
 */
@Entity
@Table(name = "partner_person_history_03")
public class PartnerPersonHistory03Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
