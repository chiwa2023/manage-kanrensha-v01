...
/**
 * partner_poli_org_history_12接続用Repository
 */
public interface PartnerPoliOrgHistory12Repository extends JpaRepository<PartnerPoliOrgHistory12Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_12 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory12Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory12Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
