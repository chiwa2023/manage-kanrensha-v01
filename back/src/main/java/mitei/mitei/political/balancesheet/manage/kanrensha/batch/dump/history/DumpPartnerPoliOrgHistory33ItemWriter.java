 ...
 */
@Component
public class DumpPartnerPoliOrgHistory33ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory33Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory33ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory33Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory33Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
