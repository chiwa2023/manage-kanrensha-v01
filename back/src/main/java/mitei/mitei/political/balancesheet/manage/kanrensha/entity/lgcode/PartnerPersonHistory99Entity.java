...
/**
 * partner_person_history_99接続用Entity
 */
@Entity
@Table(name = "partner_person_history_99")
public class PartnerPersonHistory99Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
