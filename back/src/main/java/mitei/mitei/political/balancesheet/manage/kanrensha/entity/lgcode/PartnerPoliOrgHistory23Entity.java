...
/**
 * partner_poli_org_history_23接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_23")
public class PartnerPoliOrgHistory23Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
