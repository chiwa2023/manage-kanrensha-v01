...
/**
 * partner_corp_history_22接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_22")
public class PartnerCorpHistory22Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
