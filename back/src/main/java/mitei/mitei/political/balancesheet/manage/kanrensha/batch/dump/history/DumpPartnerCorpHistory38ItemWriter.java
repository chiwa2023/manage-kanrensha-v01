 ...
 */
@Component
public class DumpPartnerCorpHistory38ItemWriter extends FlatFileItemWriter<PartnerCorpHistory38Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory38ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory38Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory38Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
