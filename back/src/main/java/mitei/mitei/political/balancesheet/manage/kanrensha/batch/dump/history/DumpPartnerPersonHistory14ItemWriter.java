 ...
 */
@Component
public class DumpPartnerPersonHistory14ItemWriter extends FlatFileItemWriter<PartnerPersonHistory14Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory14ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory14Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory14Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
