 ...
 */
@Component
public class DumpPartnerCorpHistory10ItemWriter extends FlatFileItemWriter<PartnerCorpHistory10Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory10ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory10Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory10Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
