 ...
 */
@Component
public class DumpPartnerPersonHistory22ItemWriter extends FlatFileItemWriter<PartnerPersonHistory22Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory22ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory22Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory22Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
