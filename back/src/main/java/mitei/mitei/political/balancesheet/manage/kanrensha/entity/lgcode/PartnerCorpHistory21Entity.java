...
/**
 * partner_corp_history_21接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_21")
public class PartnerCorpHistory21Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
