 ...
 */
@Component
public class DumpPartnerCorpHistory07ItemWriter extends FlatFileItemWriter<PartnerCorpHistory07Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory07ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory07Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory07Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
