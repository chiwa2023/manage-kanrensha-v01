...
/**
 * partner_corp_history_20接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_20")
public class PartnerCorpHistory20Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
