...
/**
 * partner_poli_org_history_15接続用Repository
 */
public interface PartnerPoliOrgHistory15Repository extends JpaRepository<PartnerPoliOrgHistory15Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_15 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory15Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory15Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
