 ...
 */
@Component
public class PartnerPersonAddMiniCsvItemReader extends FlatFileItemReader<PartnerPersonAddMiniDto> {
     ...
     */
    public PartnerPersonAddMiniCsvItemReader(final @Autowired PartnerPersonAddMiniLineMapper lineMapper) {
        super();
