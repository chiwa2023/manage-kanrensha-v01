 ...
 */
@Component
public class DumpPartnerCorpHistory12ItemWriter extends FlatFileItemWriter<PartnerCorpHistory12Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory12ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory12Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory12Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
