...
/**
 * partner_poli_org_history_45接続用Repository
 */
public interface PartnerPoliOrgHistory45Repository extends JpaRepository<PartnerPoliOrgHistory45Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_45 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory45Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
