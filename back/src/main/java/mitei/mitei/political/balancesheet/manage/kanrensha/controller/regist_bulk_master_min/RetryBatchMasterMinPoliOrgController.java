...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.regist_bulk_master_min.RetryBatchMasterMinPoliOrgService;
...
public class RetryBatchMasterMinPoliOrgController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        retryBatchMasterMinPoliOrgService.practice(capsuleDto.getUserDto());
