 ...
 */
@Component
public class DumpPartnerPersonHistory11ItemWriter extends FlatFileItemWriter<PartnerPersonHistory11Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory11ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory11Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory11Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
