 ...
 */
@Component
public class DumpPartnerCorpHistory15ItemWriter extends FlatFileItemWriter<PartnerCorpHistory15Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory15ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory15Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory15Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
