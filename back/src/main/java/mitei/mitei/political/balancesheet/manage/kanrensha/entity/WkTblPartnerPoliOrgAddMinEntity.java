...
/**
 * wk_tbl_partner_poli_org_add_min接続用Entity
 */
@Entity
@Table(name = "wk_tbl_partner_poli_org_add_min")
public class WkTblPartnerPoliOrgAddMinEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
     ...
     * テーブルIdを設定する
     *
     * @param wkTblPartnerPoliOrgAddMinId テーブルId
     */
    ...
    /** 関連者政治団体コード */
    @Column(name = "wk_tbl_partner_poli_org_add_min_code")
    private Integer wkTblPartnerPoliOrgAddMinCode = INIT_Integer;
     ...
     * @return 関連者政治団体コード
     */
    public Integer getWkTblPartnerPoliOrgAddMinCode() {
        return wkTblPartnerPoliOrgAddMinCode;
    }

    /**
     * 関連者政治団体コードを設定する
     *
     * @param wkTblPartnerPoliOrgAddMinCode 関連者政治団体コード
     */
    public void setWkTblPartnerPoliOrgAddMinCode(final Integer wkTblPartnerPoliOrgAddMinCode) {
        this.wkTblPartnerPoliOrgAddMinCode = wkTblPartnerPoliOrgAddMinCode;
    }
