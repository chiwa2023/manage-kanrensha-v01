 ...
 */
@Component
public class DumpPartnerPoliOrgHistory46ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory46Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory46ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory46Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory46Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
