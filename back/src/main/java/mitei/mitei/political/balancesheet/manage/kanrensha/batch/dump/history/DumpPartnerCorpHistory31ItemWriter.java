 ...
 */
@Component
public class DumpPartnerCorpHistory31ItemWriter extends FlatFileItemWriter<PartnerCorpHistory31Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory31ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory31Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory31Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
