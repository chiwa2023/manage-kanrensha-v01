 ...
 */
@Component
public class DumpPartnerPoliOrgHistory13ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory13Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory13ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory13Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory13Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
