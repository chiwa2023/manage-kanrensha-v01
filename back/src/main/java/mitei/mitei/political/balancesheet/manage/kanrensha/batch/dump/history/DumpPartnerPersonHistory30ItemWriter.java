 ...
 */
@Component
public class DumpPartnerPersonHistory30ItemWriter extends FlatFileItemWriter<PartnerPersonHistory30Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory30ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory30Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory30Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
