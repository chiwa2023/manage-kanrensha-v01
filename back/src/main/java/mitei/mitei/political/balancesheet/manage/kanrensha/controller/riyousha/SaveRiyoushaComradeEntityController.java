...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.riyousha.SaveRiyoushaComradeEntityService;

/**
 * 利用者APIユーザ保存Controller
 */
@RestController
@RequestMapping("/user-riyousha")
public class SaveRiyoushaComradeEntityController {
     ...
     * @return 汎用処理結果Dto
     */
    @PostMapping("/save-comrade")
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
            final @RequestBody SaveRiyoushaComradeCapsuleDto capsuleDto) {
