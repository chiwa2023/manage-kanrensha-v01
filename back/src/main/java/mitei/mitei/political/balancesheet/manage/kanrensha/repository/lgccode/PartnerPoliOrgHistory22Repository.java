...
/**
 * partner_poli_org_history_22接続用Repository
 */
public interface PartnerPoliOrgHistory22Repository extends JpaRepository<PartnerPoliOrgHistory22Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_22 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory22Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory22Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
