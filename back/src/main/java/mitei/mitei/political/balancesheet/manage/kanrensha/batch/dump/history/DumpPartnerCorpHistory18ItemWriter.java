 ...
 */
@Component
public class DumpPartnerCorpHistory18ItemWriter extends FlatFileItemWriter<PartnerCorpHistory18Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory18ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory18Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory18Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
