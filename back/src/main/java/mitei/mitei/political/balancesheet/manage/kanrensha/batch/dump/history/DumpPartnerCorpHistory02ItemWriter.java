 ...
 */
@Component
public class DumpPartnerCorpHistory02ItemWriter extends FlatFileItemWriter<PartnerCorpHistory02Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory02ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory02Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory02Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
