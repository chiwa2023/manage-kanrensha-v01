 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory37ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory37Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory37ItemReader(
            final @Autowired PartnerPoliOrgHistory37Repository partnerPoliOrgHistory37Repository) {
        super();
