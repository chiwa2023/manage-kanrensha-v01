...
/**
 * partner_person_history_36接続用Entity
 */
@Entity
@Table(name = "partner_person_history_36")
public class PartnerPersonHistory36Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
