...
/**
 * partner_poli_org_history_24接続用Repository
 */
public interface PartnerPoliOrgHistory24Repository extends JpaRepository<PartnerPoliOrgHistory24Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_24 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory24Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory24Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
