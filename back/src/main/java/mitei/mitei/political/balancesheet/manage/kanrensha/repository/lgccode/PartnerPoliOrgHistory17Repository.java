...
/**
 * partner_poli_org_history_17接続用Repository
 */
public interface PartnerPoliOrgHistory17Repository extends JpaRepository<PartnerPoliOrgHistory17Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_17 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory17Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory17Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
