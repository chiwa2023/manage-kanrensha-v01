...
/**
 * partner_person_history_04接続用Entity
 */
@Entity
@Table(name = "partner_person_history_04")
public class PartnerPersonHistory04Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
