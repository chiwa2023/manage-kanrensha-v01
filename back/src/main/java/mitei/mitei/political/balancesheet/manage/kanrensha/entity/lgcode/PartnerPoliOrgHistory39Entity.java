...
/**
 * partner_poli_org_history_39接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_39")
public class PartnerPoliOrgHistory39Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
