...
/**
 * partner_poli_org_history_40接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_40")
public class PartnerPoliOrgHistory40Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
