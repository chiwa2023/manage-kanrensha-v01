...
public class PartnerPersonAddStdLineMapper implements LineMapper<PartnerPersonAddStdDto> {
     ...
     * コンストラクタ
     */
    public PartnerPersonAddStdLineMapper() {
        listGaitou.add("はい");
        listGaitou.add("1");
        listGaitou.add("１");
        listGaitou.add("true");
     ...
     */
    @Override
    public PartnerPersonAddStdDto mapLine(final String line, final int lineNumber) throws Exception {
        ...
        // 職業法人番号
        dto.setCorpNo(this.removeQuote(cell[POS_CORP_NO]));
        // 職業法人住所
        dto.setCorpAddress(this.removeQuote(cell[POS_CORP_ADDRESS]));
        // 職業法人名
        dto.setCorpName(this.removeQuote(cell[POS_CORP_NAME]));
