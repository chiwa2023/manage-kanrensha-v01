 ...
 */
@Component
public class DumpPartnerPoliOrgHistory43ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory43Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory43ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory43Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory43Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
