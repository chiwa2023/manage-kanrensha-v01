...
/**
 * master_person_access接続用Entity
 */
@Entity
@Table(name = "master_person_access")
public class MasterPersonAccessEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "master_person_access_id")
    private Integer masterPersonAccessId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getMasterPersonAccessId() {
        return masterPersonAccessId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param masterPersonAccessId テーブルId
     */
    public void setMasterPersonAccessId(final Integer masterPersonAccessId) {
        this.masterPersonAccessId = masterPersonAccessId;
    }
