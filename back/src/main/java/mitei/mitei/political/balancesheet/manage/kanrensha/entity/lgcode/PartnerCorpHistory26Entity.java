...
/**
 * partner_corp_history_26接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_26")
public class PartnerCorpHistory26Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
