...
/**
 * partner_person_history_43接続用Entity
 */
@Entity
@Table(name = "partner_person_history_43")
public class PartnerPersonHistory43Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
