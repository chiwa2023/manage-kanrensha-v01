...
/**
 * riyousha_comrade_name接続用Entity
 */
@Entity
@Table(name = "riyousha_comrade_name")
public class RiyoushaComradeNameEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "riyousha_comrade_name_id")
    private Integer riyoushaComradeNameId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getRiyoushaComradeNameId() {
        return riyoushaComradeNameId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param riyoushaComradeNameId テーブルId
     */
    public void setRiyoushaComradeNameId(final Integer riyoushaComradeNameId) {
        this.riyoushaComradeNameId = riyoushaComradeNameId;
    }
     ...
     * 利用者管理者Idを設定する
     *
     * @param riyoushaComradeId 利用者管理者Id
     */
     ...
     * 利用者管理者名称を設定する
     *
     * @param riyoushaComradeName 利用者管理者名称
     */
