 ...
 */
@Component
public class DumpPartnerCorpHistory16ItemWriter extends FlatFileItemWriter<PartnerCorpHistory16Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory16ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory16Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory16Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
