 ...
 */
@Component
public class DumpSabunPartnerCorpHistory14ItemReader extends RepositoryItemReader<PartnerCorpHistory14Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory14ItemReader(
            final @Autowired PartnerCorpHistory14Repository partnerCorpHistory14Repository) {
        super();
