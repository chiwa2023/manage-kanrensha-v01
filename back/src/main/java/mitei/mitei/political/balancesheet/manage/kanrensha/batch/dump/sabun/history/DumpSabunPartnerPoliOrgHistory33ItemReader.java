 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory33ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory33Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory33ItemReader(
            final @Autowired PartnerPoliOrgHistory33Repository partnerPoliOrgHistory33Repository) {
        super();
