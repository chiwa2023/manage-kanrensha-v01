...
/**
 * partner_person_history_34接続用Entity
 */
@Entity
@Table(name = "partner_person_history_34")
public class PartnerPersonHistory34Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
