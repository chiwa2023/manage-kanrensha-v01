...
/**
 * partner_corp_history_40接続用Repository
 */
public interface PartnerCorpHistory40Repository extends JpaRepository<PartnerCorpHistory40Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_40 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory40Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory40Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
