...
/**
 * partner_corp_history_20接続用Repository
 */
public interface PartnerCorpHistory20Repository extends JpaRepository<PartnerCorpHistory20Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_20 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory20Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory20Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
