...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.DumpMasterCorporationBatchConfiguration;
...
public class ForceDumpStdMasterCorpService {
    ...
    public void practice(final LocalDate endDate) {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, MasterStd.MASTER_STD_CORP).toString())
                .toJobParameters();

        try {
            jobLauncher.run(dumpMasterCorporation, jobParameters);
