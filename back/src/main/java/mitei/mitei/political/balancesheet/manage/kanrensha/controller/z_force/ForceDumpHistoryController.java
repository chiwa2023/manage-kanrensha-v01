...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.z_force.AsyncForceDumpHistoryService;

/**
 * 履歴ダンプController
 */
@RestController
@RequestMapping("/dump-history")
public class ForceDumpHistoryController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(final @RequestBody ForceDumpCapsuleDto capsuleDto) {
        ...
        asyncForceDumpHistoryService.practice(capsuleDto);
