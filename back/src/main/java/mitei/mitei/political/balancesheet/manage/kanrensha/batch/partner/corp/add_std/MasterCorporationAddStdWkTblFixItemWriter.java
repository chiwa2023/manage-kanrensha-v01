 ...
 */
@Component
public class MasterCorporationAddStdWkTblFixItemWriter extends JpaItemWriter<WkTblMasterCorpEntity> {
     ...
     */
    public MasterCorporationAddStdWkTblFixItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
