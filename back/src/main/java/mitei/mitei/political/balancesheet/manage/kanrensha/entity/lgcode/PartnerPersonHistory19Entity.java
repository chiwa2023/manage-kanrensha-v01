...
/**
 * partner_person_history_19接続用Entity
 */
@Entity
@Table(name = "partner_person_history_19")
public class PartnerPersonHistory19Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
