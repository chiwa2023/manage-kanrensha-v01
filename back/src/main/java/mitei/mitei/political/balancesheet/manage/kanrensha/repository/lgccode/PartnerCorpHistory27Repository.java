...
/**
 * partner_corp_history_27接続用Repository
 */
public interface PartnerCorpHistory27Repository extends JpaRepository<PartnerCorpHistory27Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_27 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory27Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory27Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
