...
/**
 * partner_poli_org_history_17接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_17")
public class PartnerPoliOrgHistory17Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
