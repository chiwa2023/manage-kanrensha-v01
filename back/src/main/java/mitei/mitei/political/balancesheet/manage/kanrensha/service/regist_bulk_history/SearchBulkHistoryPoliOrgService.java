 ...
 */
@Service
public class SearchBulkHistoryPoliOrgService {
     ...
     * @return 検索結果
     */
    public SearchWkTblHistoryPoliOrgPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblPartnerPoliOrgHistoryRepository
        ...
        SearchWkTblHistoryPoliOrgPagingResultDto resultDto = new SearchWkTblHistoryPoliOrgPagingResultDto();
        resultDto.setAllCount(allCount);
        resultDto.setLimit(limit);
        resultDto.setPageNumber(pageNumber);
        resultDto.setListWktblPoliOrg(wkTblPartnerPoliOrgHistoryRepository
