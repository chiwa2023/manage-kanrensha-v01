 ...
 */
@Component
public class PartnerCorpAddMiniCsvItemWriter extends JpaItemWriter<WkTblPartnerCorpAddMinEntity> {
     ...
     */
    public PartnerCorpAddMiniCsvItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
    ...
    public void write(final Chunk<? extends WkTblPartnerCorpAddMinEntity> items) {
        ...
        for (WkTblPartnerCorpAddMinEntity entity : items) {
            ...
            entity.setWkTblPartnerCorpAddMinCode(code);
        }
