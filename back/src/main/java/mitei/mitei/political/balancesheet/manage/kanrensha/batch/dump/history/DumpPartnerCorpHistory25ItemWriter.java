 ...
 */
@Component
public class DumpPartnerCorpHistory25ItemWriter extends FlatFileItemWriter<PartnerCorpHistory25Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory25ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory25Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory25Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
