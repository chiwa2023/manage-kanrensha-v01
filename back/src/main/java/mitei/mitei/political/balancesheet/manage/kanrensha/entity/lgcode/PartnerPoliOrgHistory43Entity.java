...
/**
 * partner_poli_org_history_43接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_43")
public class PartnerPoliOrgHistory43Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
