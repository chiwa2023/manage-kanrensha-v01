...
/**
 * partner_poli_org_history_19接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_19")
public class PartnerPoliOrgHistory19Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
