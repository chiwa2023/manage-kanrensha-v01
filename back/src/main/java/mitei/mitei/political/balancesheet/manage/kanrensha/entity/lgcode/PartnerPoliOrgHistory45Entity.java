...
/**
 * partner_poli_org_history_45接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_45")
public class PartnerPoliOrgHistory45Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
