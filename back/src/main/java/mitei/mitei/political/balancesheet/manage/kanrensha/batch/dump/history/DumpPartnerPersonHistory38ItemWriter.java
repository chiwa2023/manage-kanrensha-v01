 ...
 */
@Component
public class DumpPartnerPersonHistory38ItemWriter extends FlatFileItemWriter<PartnerPersonHistory38Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory38ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory38Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory38Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
