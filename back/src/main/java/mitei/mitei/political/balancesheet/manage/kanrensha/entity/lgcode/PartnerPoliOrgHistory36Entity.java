...
/**
 * partner_poli_org_history_36接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_36")
public class PartnerPoliOrgHistory36Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
