 ...
 */
@Component
public class DumpPartnerPersonHistory17ItemWriter extends FlatFileItemWriter<PartnerPersonHistory17Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory17ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory17Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory17Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
