...
/**
 * master_corporation_access接続用Entity
 */
@Entity
@Table(name = "master_corporation_access")
public class MasterCorporationAccessEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "master_corporation_access_id")
    private Integer masterCorporationAccessId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getMasterCorporationAccessId() {
        return masterCorporationAccessId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param masterCorporationAccessId テーブルId
     */
    public void setMasterCorporationAccessId(final Integer masterCorporationAccessId) {
        this.masterCorporationAccessId = masterCorporationAccessId;
    }
     ...
     * 関連者個人Idを設定する
     *
     * @param masterCorporationId 関連者個人Id
     */
     ...
     * 関連者個人コードを設定する
     *
     * @param corpKanrenshaCode 関連者個人コード
     */
