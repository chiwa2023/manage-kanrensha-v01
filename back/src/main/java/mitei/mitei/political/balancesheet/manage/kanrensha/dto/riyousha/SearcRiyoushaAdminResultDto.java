 ...
 * 利用者管理者検索結果Dto
 */
public class SearcRiyoushaAdminResultDto extends AbstractPagingIntegerDto // NOPMD DataClass
    ...
    /** 利用者運営者リスト */
    private List<RiyoushaAdminEntity> listRiyoushaAdmin = new ArrayList<>();
     ...
     * @return 利用者運営者リスト
     */
    public List<RiyoushaAdminEntity> getListRiyoushaAdmin() {
     ...
     */
    public void setListRiyoushaAdmin(final List<RiyoushaAdminEntity> listRiyoushaAdmin) {
