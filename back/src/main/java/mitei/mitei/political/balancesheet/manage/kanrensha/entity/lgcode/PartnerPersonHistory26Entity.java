...
/**
 * partner_person_history_26接続用Entity
 */
@Entity
@Table(name = "partner_person_history_26")
public class PartnerPersonHistory26Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
