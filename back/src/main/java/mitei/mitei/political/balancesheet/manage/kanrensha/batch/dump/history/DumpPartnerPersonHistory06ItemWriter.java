 ...
 */
@Component
public class DumpPartnerPersonHistory06ItemWriter extends FlatFileItemWriter<PartnerPersonHistory06Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory06ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory06Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory06Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
