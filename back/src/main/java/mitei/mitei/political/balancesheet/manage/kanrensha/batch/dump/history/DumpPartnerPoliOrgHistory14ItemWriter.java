 ...
 */
@Component
public class DumpPartnerPoliOrgHistory14ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory14Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory14ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory14Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory14Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
