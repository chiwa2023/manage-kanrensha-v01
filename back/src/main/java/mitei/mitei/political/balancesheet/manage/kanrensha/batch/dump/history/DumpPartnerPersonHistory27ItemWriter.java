 ...
 */
@Component
public class DumpPartnerPersonHistory27ItemWriter extends FlatFileItemWriter<PartnerPersonHistory27Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory27ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory27Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory27Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
