...
/**
 * partner_poli_org_history_37接続用Repository
 */
public interface PartnerPoliOrgHistory37Repository extends JpaRepository<PartnerPoliOrgHistory37Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_37 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory37Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory37Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
