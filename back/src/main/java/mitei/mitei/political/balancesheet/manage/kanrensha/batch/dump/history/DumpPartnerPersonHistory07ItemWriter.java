 ...
 */
@Component
public class DumpPartnerPersonHistory07ItemWriter extends FlatFileItemWriter<PartnerPersonHistory07Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory07ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory07Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory07Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
