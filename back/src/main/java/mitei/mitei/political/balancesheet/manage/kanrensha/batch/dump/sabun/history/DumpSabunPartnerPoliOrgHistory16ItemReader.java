 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory16ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory16Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory16ItemReader(
            final @Autowired PartnerPoliOrgHistory16Repository partnerPoliOrgHistory16Repository) {
        super();
