...
/**
 * partner_person_history_24接続用Repository
 */
public interface PartnerPersonHistory24Repository extends JpaRepository<PartnerPersonHistory24Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_person_history_24 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory24Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory24Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
