 ...
 */
@Component
public class DumpPartnerPoliOrgHistory09ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory09Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory09ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory09Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory09Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
