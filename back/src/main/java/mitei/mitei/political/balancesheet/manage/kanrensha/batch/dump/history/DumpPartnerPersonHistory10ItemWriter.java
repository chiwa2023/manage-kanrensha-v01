 ...
 */
@Component
public class DumpPartnerPersonHistory10ItemWriter extends FlatFileItemWriter<PartnerPersonHistory10Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory10ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory10Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory10Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
