...
/**
 * partner_poli_org_history_99接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_99")
public class PartnerPoliOrgHistory99Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
