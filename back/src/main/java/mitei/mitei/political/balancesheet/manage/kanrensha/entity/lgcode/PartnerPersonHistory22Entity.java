...
/**
 * partner_person_history_22接続用Entity
 */
@Entity
@Table(name = "partner_person_history_22")
public class PartnerPersonHistory22Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
