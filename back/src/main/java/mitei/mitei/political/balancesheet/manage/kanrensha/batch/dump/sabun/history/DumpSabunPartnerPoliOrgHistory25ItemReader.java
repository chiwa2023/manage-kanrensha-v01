 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory25ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory25Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory25ItemReader(
            final @Autowired PartnerPoliOrgHistory25Repository partnerPoliOrgHistory25Repository) {
        super();
