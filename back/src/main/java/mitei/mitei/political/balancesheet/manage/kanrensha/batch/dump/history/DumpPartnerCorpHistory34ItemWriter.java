 ...
 */
@Component
public class DumpPartnerCorpHistory34ItemWriter extends FlatFileItemWriter<PartnerCorpHistory34Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory34ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory34Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory34Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
