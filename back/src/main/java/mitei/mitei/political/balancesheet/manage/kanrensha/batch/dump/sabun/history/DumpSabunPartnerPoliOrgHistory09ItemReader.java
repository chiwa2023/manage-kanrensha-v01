 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory09ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory09Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory09ItemReader(
            final @Autowired PartnerPoliOrgHistory09Repository partnerPoliOrgHistory09Repository) {
        super();
