 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory13ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory13Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory13ItemReader(
            final @Autowired PartnerPoliOrgHistory13Repository partnerPoliOrgHistory13Repository) {
        super();
