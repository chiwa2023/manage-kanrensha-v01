...
/**
 * partner_poli_org_history_32接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_32")
public class PartnerPoliOrgHistory32Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
