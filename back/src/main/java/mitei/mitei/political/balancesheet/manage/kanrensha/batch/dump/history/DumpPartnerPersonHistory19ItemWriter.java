 ...
 */
@Component
public class DumpPartnerPersonHistory19ItemWriter extends FlatFileItemWriter<PartnerPersonHistory19Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory19ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory19Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory19Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
