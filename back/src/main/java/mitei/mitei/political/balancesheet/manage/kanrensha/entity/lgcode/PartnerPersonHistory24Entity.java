...
/**
 * partner_person_history_24接続用Entity
 */
@Entity
@Table(name = "partner_person_history_24")
public class PartnerPersonHistory24Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
