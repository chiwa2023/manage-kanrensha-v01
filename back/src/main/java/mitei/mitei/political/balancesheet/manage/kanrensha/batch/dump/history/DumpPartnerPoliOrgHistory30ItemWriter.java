 ...
 */
@Component
public class DumpPartnerPoliOrgHistory30ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory30Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory30ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory30Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory30Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
