...
/**
 * partner_person_history_47接続用Entity
 */
@Entity
@Table(name = "partner_person_history_47")
public class PartnerPersonHistory47Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
