...
/**
 * partner_person_history_12接続用Entity
 */
@Entity
@Table(name = "partner_person_history_12")
public class PartnerPersonHistory12Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
