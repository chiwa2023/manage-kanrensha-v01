...
/**
 * partner_corp_history_47接続用Repository
 */
public interface PartnerCorpHistory47Repository extends JpaRepository<PartnerCorpHistory47Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_47 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory47Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory47Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
    ...
    @Query(value = "SELECT  1 AS kanrensha_kbn ,partner_name ,all_address "
            ...
            + "   FROM partner_person_history_47 "
            ...
            + "   FROM partner_poli_org_history_47 "
            + "       WHERE partner_name = ?1 AND all_address = ?2"
            + "           AND is_latest = 1"
            , nativeQuery = true)
