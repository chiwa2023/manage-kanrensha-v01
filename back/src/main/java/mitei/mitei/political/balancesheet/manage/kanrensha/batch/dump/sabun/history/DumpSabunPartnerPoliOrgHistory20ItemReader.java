 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory20ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory20Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory20ItemReader(
            final @Autowired PartnerPoliOrgHistory20Repository partnerPoliOrgHistory20Repository) {
        super();
