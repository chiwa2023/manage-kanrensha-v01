...
/**
 * partner_poli_org_history_29接続用Repository
 */
public interface PartnerPoliOrgHistory29Repository extends JpaRepository<PartnerPoliOrgHistory29Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_29 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory29Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory29Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
