...
/**
 * partner_person_history_03接続用Repository
 */
public interface PartnerPersonHistory03Repository extends JpaRepository<PartnerPersonHistory03Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_person_history_03 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory03Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory03Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
    ...
    @Query(value = "SELECT  1 AS kanrensha_kbn ,partner_name ,all_address "
            ...
            + "   FROM partner_person_history_03 "
            ...
            + "   FROM partner_poli_org_history_03 "
