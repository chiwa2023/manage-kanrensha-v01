 ...
 */
@Component
public class DumpPartnerPersonHistory45ItemReader extends RepositoryItemReader<PartnerPersonHistory45Entity> {
     ...
     */
    public DumpPartnerPersonHistory45ItemReader(
            final @Autowired PartnerPersonHistory45Repository partnerPersonHistory45Repository) {
        super();
