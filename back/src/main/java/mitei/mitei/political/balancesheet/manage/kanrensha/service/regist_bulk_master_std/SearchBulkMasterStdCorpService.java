 ...
 */
@Service
public class SearchBulkMasterStdCorpService {
     ...
     * @return 検索結果
     */
    public SearchWkTblStdCorpPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblMasterCorpRepository.countByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
        ...
        resultDto.setListWktblCorp(wkTblMasterCorpRepository
