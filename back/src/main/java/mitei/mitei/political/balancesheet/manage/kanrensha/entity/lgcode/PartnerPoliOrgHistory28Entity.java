...
/**
 * partner_poli_org_history_28接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_28")
public class PartnerPoliOrgHistory28Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
