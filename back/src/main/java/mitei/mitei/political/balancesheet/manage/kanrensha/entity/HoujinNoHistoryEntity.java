...
/**
 * houjin_no_History接続用Entity
 */
@Entity
@Table(name = "houjin_no_history")
public class HoujinNoHistoryEntity implements Serializable { // NOPMD DataClass
    ...
    @Column(name = "houjin_no_history_id")
    private Long houjinNoHistoryId = INIT_Long;
     ...
     * @return テーブルId
     */
    public Long getHoujinNoHistoryId() {
        return houjinNoHistoryId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param houjinNoHistoryId テーブルId
     */
    public void setHoujinNoHistoryId(final Long houjinNoHistoryId) {
        this.houjinNoHistoryId = houjinNoHistoryId;
    }
     ...
     * 法人番号最新Idを設定する
     *
     * @param houjinNoLatestId 法人番号最新Id
     */
