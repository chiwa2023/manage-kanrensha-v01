...
/**
 * partner_corp_history_35接続用Repository
 */
public interface PartnerCorpHistory35Repository extends JpaRepository<PartnerCorpHistory35Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_35 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory35Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory35Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
