...
/**
 * partner_poli_org_history_38接続用Repository
 */
public interface PartnerPoliOrgHistory38Repository extends JpaRepository<PartnerPoliOrgHistory38Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_38 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory38Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory38Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
