 ...
 */
@Component
public class DumpPartnerPoliOrgHistory21ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory21Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory21ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory21Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory21Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
