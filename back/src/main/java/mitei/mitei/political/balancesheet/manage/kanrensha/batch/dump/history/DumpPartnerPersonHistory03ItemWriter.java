 ...
 */
@Component
public class DumpPartnerPersonHistory03ItemWriter extends FlatFileItemWriter<PartnerPersonHistory03Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory03ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory03Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory03Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
