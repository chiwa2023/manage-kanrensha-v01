...
/**
 * partner_corp_history_08接続用Repository
 */
public interface PartnerCorpHistory08Repository extends JpaRepository<PartnerCorpHistory08Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_08 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory08Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory08Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
