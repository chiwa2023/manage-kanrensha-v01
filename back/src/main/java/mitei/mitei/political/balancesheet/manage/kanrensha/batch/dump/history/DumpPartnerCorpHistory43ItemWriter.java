 ...
 */
@Component
public class DumpPartnerCorpHistory43ItemWriter extends FlatFileItemWriter<PartnerCorpHistory43Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory43ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory43Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory43Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
