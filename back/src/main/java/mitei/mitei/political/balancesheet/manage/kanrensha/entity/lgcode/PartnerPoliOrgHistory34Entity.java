...
/**
 * partner_poli_org_history_34接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_34")
public class PartnerPoliOrgHistory34Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
