 ...
 */
@Component
public class DumpSabunPartnerCorpHistory39ItemReader extends RepositoryItemReader<PartnerCorpHistory39Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory39ItemReader(
            final @Autowired PartnerCorpHistory39Repository partnerCorpHistory39Repository) {
        super();
