 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory01ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory01Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory01ItemReader(
            final @Autowired PartnerPoliOrgHistory01Repository partnerPoliOrgHistory01Repository) {
        super();
