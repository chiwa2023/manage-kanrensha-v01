 ...
 */
@Component
public class DumpPartnerPersonHistory45ItemWriter extends FlatFileItemWriter<PartnerPersonHistory45Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory45ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory45Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory45Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
