...
/**
 * partner_person_history_40接続用Repository
 */
public interface PartnerPersonHistory40Repository extends JpaRepository<PartnerPersonHistory40Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_person_history_40 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory40Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory40Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
    ...
    @Query(value = "SELECT  1 AS kanrensha_kbn ,partner_name ,all_address "
            ...
            + "   FROM partner_person_history_40 "
            ...
            + "   FROM partner_poli_org_history_40 "
