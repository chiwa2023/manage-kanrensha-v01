...
/**
 * partner_person_history_44接続用Entity
 */
@Entity
@Table(name = "partner_person_history_44")
public class PartnerPersonHistory44Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
