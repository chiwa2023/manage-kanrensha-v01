 ...
 */
@Component
public class DumpPartnerPersonHistory01ItemWriter extends FlatFileItemWriter<PartnerPersonHistory01Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory01ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory01Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory01Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
