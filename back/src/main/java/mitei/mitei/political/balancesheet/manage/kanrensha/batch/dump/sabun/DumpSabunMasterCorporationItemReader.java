 ...
 */
@Component
public class DumpSabunMasterCorporationItemReader extends RepositoryItemReader<MasterCorporationEntity> {

    /**
     * コンストラクタ
     *
     * @param masterCorporationRepository 関連者企業マスタRepository
     */
    public DumpSabunMasterCorporationItemReader(
            final @Autowired MasterCorporationRepository masterCorporationRepository) {
        super();
