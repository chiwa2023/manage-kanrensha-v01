...
/**
 * partner_person_history_07接続用Entity
 */
@Entity
@Table(name = "partner_person_history_07")
public class PartnerPersonHistory07Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
