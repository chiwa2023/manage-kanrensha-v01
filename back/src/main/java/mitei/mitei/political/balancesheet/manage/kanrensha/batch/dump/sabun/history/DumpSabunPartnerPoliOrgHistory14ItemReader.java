 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory14ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory14Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory14ItemReader(
            final @Autowired PartnerPoliOrgHistory14Repository partnerPoliOrgHistory14Repository) {
        super();
