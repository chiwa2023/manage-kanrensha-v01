 ...
 */
@Component
public class DumpPartnerPoliOrgHistory35ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory35Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory35ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory35Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory35Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
