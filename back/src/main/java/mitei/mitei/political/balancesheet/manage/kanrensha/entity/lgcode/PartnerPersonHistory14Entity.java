...
/**
 * partner_person_history_14接続用Entity
 */
@Entity
@Table(name = "partner_person_history_14")
public class PartnerPersonHistory14Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
