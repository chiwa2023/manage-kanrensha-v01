 ...
 */
@Component
public class DumpPartnerCorpHistory21ItemWriter extends FlatFileItemWriter<PartnerCorpHistory21Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory21ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory21Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory21Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
