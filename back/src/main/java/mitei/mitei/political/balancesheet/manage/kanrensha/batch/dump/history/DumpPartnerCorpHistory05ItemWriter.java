 ...
 */
@Component
public class DumpPartnerCorpHistory05ItemWriter extends FlatFileItemWriter<PartnerCorpHistory05Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory05ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory05Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory05Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
