 ...
 */
@Component
public class MasterPoliticalOrganizationAddStdCsvItemReader extends FlatFileItemReader<PartnerPoliOrgAddStdDto> {
     ...
     */
    public MasterPoliticalOrganizationAddStdCsvItemReader(final @Autowired PartnerPoliOrgAddStdLineMapper lineMapper) {
        super();
