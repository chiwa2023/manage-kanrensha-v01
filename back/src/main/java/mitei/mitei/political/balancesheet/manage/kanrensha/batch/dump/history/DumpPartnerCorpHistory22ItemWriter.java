 ...
 */
@Component
public class DumpPartnerCorpHistory22ItemWriter extends FlatFileItemWriter<PartnerCorpHistory22Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory22ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory22Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory22Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
