 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory36ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory36Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory36ItemReader(
            final @Autowired PartnerPoliOrgHistory36Repository partnerPoliOrgHistory36Repository) {
        super();
