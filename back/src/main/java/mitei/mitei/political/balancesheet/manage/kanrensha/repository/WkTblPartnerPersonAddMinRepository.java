...
public interface WkTblPartnerPersonAddMinRepository extends JpaRepository<WkTblPartnerPersonAddMinEntity, Integer> {
    ...
    Optional<WkTblPartnerPersonAddMinEntity> findFirstByOrderByWkTblPartnerPersonAddMinCodeDesc();
     ...
     * @return 検索結果
     */
    Page<WkTblPartnerPersonAddMinEntity> findByInsertUserCodeAndIsLatestAndIsAffectedAndIsFinish(Integer userCode,
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT distinct partner_name, all_address, person_shokugyou FROM wk_tbl_partner_person_add_min WHERE insert_user_code = ?1 "
