...
/**
 * partner_poli_org_history_20接続用Repository
 */
public interface PartnerPoliOrgHistory20Repository extends JpaRepository<PartnerPoliOrgHistory20Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_20 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory20Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory20Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
