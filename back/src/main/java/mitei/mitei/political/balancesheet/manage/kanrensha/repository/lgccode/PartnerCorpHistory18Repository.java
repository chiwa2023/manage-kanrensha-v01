...
/**
 * partner_corp_history_18接続用Repository
 */
public interface PartnerCorpHistory18Repository extends JpaRepository<PartnerCorpHistory18Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_18 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory18Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory18Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
