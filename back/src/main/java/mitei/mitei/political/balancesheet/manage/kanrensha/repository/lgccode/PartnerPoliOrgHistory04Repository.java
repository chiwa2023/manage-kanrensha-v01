...
/**
 * partner_poli_org_history_04接続用Repository
 */
public interface PartnerPoliOrgHistory04Repository extends JpaRepository<PartnerPoliOrgHistory04Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_04 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory04Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory04Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
