...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.partner.corp.add_min.AddMinKanrenshaCorpMasterBatchConfiguration;
...
public class ExecuteBatchMasterMinCorpService {
    ...
    public void practice(final String readFilePath, final UserPersonLeastDto userDto) {
        ...
        try {
            jobLauncher.run(addMinKanrenshaCorpMaster, jobParameters);
