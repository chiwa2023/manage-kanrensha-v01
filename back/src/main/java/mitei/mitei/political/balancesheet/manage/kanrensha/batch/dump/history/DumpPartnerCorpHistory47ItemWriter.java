 ...
 */
@Component
public class DumpPartnerCorpHistory47ItemWriter extends FlatFileItemWriter<PartnerCorpHistory47Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory47ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory47Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory47Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
