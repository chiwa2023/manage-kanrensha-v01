...
/**
 * partner_poli_org_history_44接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_44")
public class PartnerPoliOrgHistory44Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
