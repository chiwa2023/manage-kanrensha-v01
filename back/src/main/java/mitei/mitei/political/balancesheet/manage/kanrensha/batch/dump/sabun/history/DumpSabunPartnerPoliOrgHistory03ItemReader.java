 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory03ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory03Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory03ItemReader(
            final @Autowired PartnerPoliOrgHistory03Repository partnerPoliOrgHistory03Repository) {
        super();
