...
public class AddUserService {
    ...
    public NewComerDto practice(final NewComerDto newComerDto) {
        ...
        // 自分が登録者であることを設定
        UserPersonLeastDto leastDto = new UserPersonLeastDto();
        leastDto.setUserPersonCode(code);
        leastDto.setUserPersonName(name);
        ...
        leastDto.setUserPersonId(userPersonEntity.getUserPersonId());
        setTableDataHistoryUtil.practiceInsert(leastDto, userRoleEntity);
