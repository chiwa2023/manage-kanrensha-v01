 ...
 */
@Component
public class DumpPartnerCorpHistory03ItemWriter extends FlatFileItemWriter<PartnerCorpHistory03Entity> {
    ...
    public DumpPartnerCorpHistory03ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory03Entity> lineAggregator = new DelimitedLineAggregator<>();
