 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory12ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory12Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory12ItemReader(
            final @Autowired PartnerPoliOrgHistory12Repository partnerPoliOrgHistory12Repository) {
        super();
