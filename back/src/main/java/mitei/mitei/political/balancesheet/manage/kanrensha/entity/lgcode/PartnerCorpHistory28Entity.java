...
/**
 * partner_corp_history_28接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_28")
public class PartnerCorpHistory28Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
