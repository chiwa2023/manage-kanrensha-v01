 ...
 */
@Component
public class DumpPartnerCorpHistory11ItemWriter extends FlatFileItemWriter<PartnerCorpHistory11Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory11ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory11Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory11Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
