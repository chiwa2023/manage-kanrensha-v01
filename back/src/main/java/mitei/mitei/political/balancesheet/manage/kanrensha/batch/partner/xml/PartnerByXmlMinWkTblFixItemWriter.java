 ...
 */
@Component
public class PartnerByXmlMinWkTblFixItemWriter extends JpaItemWriter<WkTblMasterAllByXmlEntity> {
     ...
     */
    public PartnerByXmlMinWkTblFixItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
