...
/**
 * partner_corp_history_13接続用Repository
 */
public interface PartnerCorpHistory13Repository extends JpaRepository<PartnerCorpHistory13Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_13 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory13Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory13Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
