 ...
 */
@Component
public class DumpSabunPartnerPersonHistory43ItemReader extends RepositoryItemReader<PartnerPersonHistory43Entity> {
     ...
     */
    public DumpSabunPartnerPersonHistory43ItemReader(
            final @Autowired PartnerPersonHistory43Repository partnerPersonHistory43Repository) {
        super();
