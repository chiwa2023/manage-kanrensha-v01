...
public class GetPartnerCorpSameHistoryService {
     ...
     * @return 検索結果
     */
    public List<PartnerCorpHistoryBaseEntity> practice( // SUPPRESS CHECKSTYLE ReturnCount NOPMD
        ...
        switch (getPrefectureLgCodeService.practice(address)) {
            ...
            case GetPrefectureLgCodeService.PREF_02:
                return partnerCorpHistory02Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_03:
                return partnerCorpHistory03Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_04:
                return partnerCorpHistory04Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_05:
                return partnerCorpHistory05Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_06:
                return partnerCorpHistory06Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_07:
                return partnerCorpHistory07Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_08:
                return partnerCorpHistory08Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_09:
                return partnerCorpHistory09Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_10:
                return partnerCorpHistory10Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_11:
                return partnerCorpHistory11Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_12:
                return partnerCorpHistory12Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_13:
                return partnerCorpHistory13Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_14:
                return partnerCorpHistory14Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_15:
                return partnerCorpHistory15Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_16:
                return partnerCorpHistory16Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_17:
                return partnerCorpHistory17Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_18:
                return partnerCorpHistory18Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_19:
                return partnerCorpHistory19Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_20:
                return partnerCorpHistory20Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_21:
                return partnerCorpHistory21Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_22:
                return partnerCorpHistory22Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_23:
                return partnerCorpHistory23Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_24:
                return partnerCorpHistory24Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_25:
                return partnerCorpHistory25Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_26:
                return partnerCorpHistory26Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_27:
                return partnerCorpHistory27Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_28:
                return partnerCorpHistory28Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_29:
                return partnerCorpHistory29Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_30:
                return partnerCorpHistory30Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_31:
                return partnerCorpHistory31Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_32:
                return partnerCorpHistory32Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_33:
                return partnerCorpHistory33Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_34:
                return partnerCorpHistory34Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_35:
                return partnerCorpHistory35Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_36:
                return partnerCorpHistory36Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_37:
                return partnerCorpHistory37Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_38:
                return partnerCorpHistory38Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_39:
                return partnerCorpHistory39Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_40:
                return partnerCorpHistory40Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_41:
                return partnerCorpHistory41Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_42:
                return partnerCorpHistory42Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_43:
                return partnerCorpHistory43Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_44:
                return partnerCorpHistory44Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_45:
                return partnerCorpHistory45Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_46:
                return partnerCorpHistory46Repository.selectByProperty(name, address, delegate);
            case GetPrefectureLgCodeService.PREF_47:
                return partnerCorpHistory47Repository.selectByProperty(name, address, delegate);
            default:
                return partnerCorpHistory99Repository.selectByProperty(name, address, delegate);
        }
    }
}
