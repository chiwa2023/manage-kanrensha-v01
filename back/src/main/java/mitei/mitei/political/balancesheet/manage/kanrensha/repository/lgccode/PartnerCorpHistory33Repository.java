...
/**
 * partner_corp_history_33接続用Repository
 */
public interface PartnerCorpHistory33Repository extends JpaRepository<PartnerCorpHistory33Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_33 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory33Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory33Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
