 ...
 */
@Component
public class DumpPartnerCorpHistory22ItemReader extends RepositoryItemReader<PartnerCorpHistory22Entity> {
     ...
     */
    public DumpPartnerCorpHistory22ItemReader(
            final @Autowired PartnerCorpHistory22Repository partnerCorpHistory22Repository) {
        super();
