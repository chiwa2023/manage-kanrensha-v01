 ...
 */
@Component
public class DumpPartnerPoliOrgHistory19ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory19Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory19ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory19Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory19Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
