 ...
 */
@Service
public class SearchBulkHistoryCorpService {
     ...
     * @return 検索結果
     */
    public SearchWkTblHistoryCorpPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblPartnerCorpHistoryRepository
        ...
        resultDto.setListWktblCorp(wkTblPartnerCorpHistoryRepository
