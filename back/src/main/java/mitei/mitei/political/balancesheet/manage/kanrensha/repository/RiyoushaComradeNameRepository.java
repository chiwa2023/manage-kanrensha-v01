...
//     * @return 検索結果
//     */
//    @Query(value = "SELECT * FROM riyousha_comrade_name WHERE saishin_kbn= 1 AND MATCH(riyousha_comrade_name_name) AGAINST (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
//    List<RiyoushaComradeNameEntity> findFullText(String searchWords);
}
