...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.z_force.AsyncForceDumpMinMasterSabunService;

/**
 * マスタ最小差分ダンプController
 */
@RestController
@RequestMapping("/dump-master-min-sabun")
public class ForceDumpMinMasterSabunController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(final @RequestBody ForceDumpCapsuleDto capsuleDto) {
        ...
        asyncForceDumpMinMasterSabunService.practice(capsuleDto);
