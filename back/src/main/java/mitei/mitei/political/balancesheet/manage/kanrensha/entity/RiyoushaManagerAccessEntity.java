...
/**
 * riyousha_manager_access接続用Entity
 */
@Entity
@Table(name = "riyousha_manager_access")
public class RiyoushaManagerAccessEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "riyousha_manager_access_id")
    private Integer riyoushaManagerAccessId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getRiyoushaManagerAccessId() {
        return riyoushaManagerAccessId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param riyoushaManagerAccessId テーブルId
     */
    public void setRiyoushaManagerAccessId(final Integer riyoushaManagerAccessId) {
        this.riyoushaManagerAccessId = riyoushaManagerAccessId;
    }
     ...
     * API接続続利用者Idを設定する
     *
     * @param riyoushaManagerId API接続続利用者Id
     */
     ...
     * API接続続利用者名称を設定する
     *
     * @param riyoushaManagerName API接続続利用者名称
     */
