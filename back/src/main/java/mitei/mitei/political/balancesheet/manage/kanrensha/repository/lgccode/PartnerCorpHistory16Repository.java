...
/**
 * partner_corp_history_16接続用Repository
 */
public interface PartnerCorpHistory16Repository extends JpaRepository<PartnerCorpHistory16Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_16 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory16Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory16Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
