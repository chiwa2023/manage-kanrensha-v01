...
/**
 * partner_corp_history_08接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_08")
public class PartnerCorpHistory08Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
