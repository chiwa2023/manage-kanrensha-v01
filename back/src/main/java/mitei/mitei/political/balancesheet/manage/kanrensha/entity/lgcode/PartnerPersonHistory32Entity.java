...
/**
 * partner_person_history_32接続用Entity
 */
@Entity
@Table(name = "partner_person_history_32")
public class PartnerPersonHistory32Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
