...
/**
 * partner_poli_org_history_24接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_24")
public class PartnerPoliOrgHistory24Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
