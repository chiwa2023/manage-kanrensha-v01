...
/**
 * partner_poli_org_history_03接続用Repository
 */
public interface PartnerPoliOrgHistory03Repository extends JpaRepository<PartnerPoliOrgHistory03Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_03 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory03Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory03Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
