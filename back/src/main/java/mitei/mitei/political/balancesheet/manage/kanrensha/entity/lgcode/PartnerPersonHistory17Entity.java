...
/**
 * partner_person_history_17接続用Entity
 */
@Entity
@Table(name = "partner_person_history_17")
public class PartnerPersonHistory17Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
