...
/**
 * partner_corp_history_04接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_04")
public class PartnerCorpHistory04Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
