...
/**
 * partner_poli_org_history_33接続用Repository
 */
public interface PartnerPoliOrgHistory33Repository extends JpaRepository<PartnerPoliOrgHistory33Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_33 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory33Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory33Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
