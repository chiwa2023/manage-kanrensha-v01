 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory46ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory46Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory46ItemReader(
            final @Autowired PartnerPoliOrgHistory46Repository partnerPoliOrgHistory46Repository) {
        super();
