 ...
 */
@Component
public class DumpPartnerPersonHistory47ItemWriter extends FlatFileItemWriter<PartnerPersonHistory47Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory47ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory47Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory47Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
