 ...
 */
public class SearchWkTblStdCorpPagingResultDto extends AbstractPagingIntegerDto // NOPMD DataClass
    ...
    /** 企業／団体登録候補リスト */
    private List<WkTblMasterCorpEntity> listWktblCorp = new ArrayList<>();
     ...
     * @return 企業／団体登録候補リスト
     */
    public List<WkTblMasterCorpEntity> getListWktblCorp() {
     ...
     */
    public void setListWktblCorp(final List<WkTblMasterCorpEntity> listWktblCorp) {
