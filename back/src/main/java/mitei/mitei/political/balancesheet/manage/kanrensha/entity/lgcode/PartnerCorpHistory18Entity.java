...
/**
 * partner_corp_history_18接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_18")
public class PartnerCorpHistory18Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
