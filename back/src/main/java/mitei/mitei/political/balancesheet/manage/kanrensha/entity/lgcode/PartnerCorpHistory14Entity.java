...
/**
 * partner_corp_history_01接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_14")
public class PartnerCorpHistory14Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "partner_corp_history_id")
    private Integer partnerCorpHistoryId = INIT_Integer;
     ...
     * @return 関連者企業・団体履歴Id
     */
    public Integer getPartnerCorpHistoryId() {
        return partnerCorpHistoryId;
    }

    /**
     * 関連者企業・団体履歴Idを設定する
     *
     * @param partnerCorpHistoryId 関連者企業・団体履歴Id
     */
    public void setPartnerCorpHistoryId(final Integer partnerCorpHistoryId) {
        this.partnerCorpHistoryId = partnerCorpHistoryId;
    }
