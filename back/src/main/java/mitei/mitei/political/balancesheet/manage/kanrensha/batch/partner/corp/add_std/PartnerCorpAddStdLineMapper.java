 ...
 */
@Component
public class PartnerCorpAddStdLineMapper implements LineMapper<PartnerCorpAddStdDto> {
     ...
     * コンストラクタ
     */
    public PartnerCorpAddStdLineMapper() {
        listGaitou.add("はい");
        listGaitou.add("1");
        listGaitou.add("１");
        listGaitou.add("true");
     ...
     */
    @Override
    public PartnerCorpAddStdDto mapLine(final String line, final int lineNumber) throws Exception {
        ...
        // 企業・団体代表者カラム位置
        dto.setCorpDelegate(this.removeQuote(cell[POS_ORG_DELEGATE]));
        // 企業・団体代表者カラム位置
