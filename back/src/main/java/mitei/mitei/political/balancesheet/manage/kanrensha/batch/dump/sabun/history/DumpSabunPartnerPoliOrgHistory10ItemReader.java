 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory10ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory10Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory10ItemReader(
            final @Autowired PartnerPoliOrgHistory10Repository partnerPoliOrgHistory10Repository) {
        super();
