 ...
 */
@Component
public class DumpPartnerPersonHistory39ItemWriter extends FlatFileItemWriter<PartnerPersonHistory39Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory39ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory39Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory39Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
