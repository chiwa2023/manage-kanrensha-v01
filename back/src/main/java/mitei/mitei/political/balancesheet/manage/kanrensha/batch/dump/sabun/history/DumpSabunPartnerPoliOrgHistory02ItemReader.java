 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory02ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory02Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory02ItemReader(
            final @Autowired PartnerPoliOrgHistory02Repository partnerPoliOrgHistory02Repository) {
        super();
