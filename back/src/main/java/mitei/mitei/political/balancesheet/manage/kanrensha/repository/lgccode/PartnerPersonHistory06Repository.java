...
/**
 * partner_person_history_06接続用Repository
 */
public interface PartnerPersonHistory06Repository extends JpaRepository<PartnerPersonHistory06Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_person_history_06 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory06Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory06Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
    ...
    @Query(value = "SELECT  1 AS kanrensha_kbn ,partner_name ,all_address "
            ...
            + "   FROM partner_person_history_06 "
            ...
            + "   FROM partner_poli_org_history_06 "
