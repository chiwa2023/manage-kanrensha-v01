...
/**
 * partner_poli_org_history_09接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_09")
public class PartnerPoliOrgHistory09Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
