...
/**
 * partner_poli_org_history_27接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_27")
public class PartnerPoliOrgHistory27Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
