...
/**
 * partner_poli_org_history_37接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_37")
public class PartnerPoliOrgHistory37Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
