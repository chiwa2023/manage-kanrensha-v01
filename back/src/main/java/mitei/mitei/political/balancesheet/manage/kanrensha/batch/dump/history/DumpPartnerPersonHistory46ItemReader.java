 ...
 */
@Component
public class DumpPartnerPersonHistory46ItemReader extends RepositoryItemReader<PartnerPersonHistory46Entity> {
     ...
     */
    public DumpPartnerPersonHistory46ItemReader(
            final @Autowired PartnerPersonHistory46Repository partnerPersonHistory46Repository) {
        super();
