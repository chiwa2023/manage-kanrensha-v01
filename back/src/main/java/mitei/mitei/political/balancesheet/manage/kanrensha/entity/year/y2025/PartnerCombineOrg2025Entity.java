...
/**
 * partner_combine_org_2025接続用Entity
 */
@Entity
@Table(name = "partner_combine_org_2025")
public class PartnerCombineOrg2025Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "partner_combine_org_id")
    private Integer partnerCombineOrgId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getPartnerCombineOrgId() {
        return partnerCombineOrgId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param partnerCombineOrgId テーブルId
     */
    public void setPartnerCombineOrgId(final Integer partnerCombineOrgId) {
        this.partnerCombineOrgId = partnerCombineOrgId;
    }

    /** 紐づけコード */
    @Column(name = "partner_combine_org_code")
    private Integer partnerCombineOrgCode = INIT_Integer;
     ...
     * @return 紐づけコード
     */
    public Integer getPartnerCombineOrgCode() {
        return partnerCombineOrgCode;
    }

    /**
     * 紐づけコードを設定する
     *
     * @param partnerCombineOrgCode 紐づけコード
     */
    public void setPartnerCombineOrgCode(final Integer partnerCombineOrgCode) {
        this.partnerCombineOrgCode = partnerCombineOrgCode;
    }
