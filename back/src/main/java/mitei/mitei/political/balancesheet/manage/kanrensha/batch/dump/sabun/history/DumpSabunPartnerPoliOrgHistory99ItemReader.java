 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory99ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory99Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory99ItemReader(
            final @Autowired PartnerPoliOrgHistory99Repository partnerPoliOrgHistory99Repository) {
        super();
