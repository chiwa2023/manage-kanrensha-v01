...
/**
 * partner_poli_org_history_44接続用Repository
 */
public interface PartnerPoliOrgHistory44Repository extends JpaRepository<PartnerPoliOrgHistory44Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_44 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory44Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory44Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
