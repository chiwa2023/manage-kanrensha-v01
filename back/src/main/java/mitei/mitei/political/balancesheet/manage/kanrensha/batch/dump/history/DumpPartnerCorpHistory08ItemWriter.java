 ...
 */
@Component
public class DumpPartnerCorpHistory08ItemWriter extends FlatFileItemWriter<PartnerCorpHistory08Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory08ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory08Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory08Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
