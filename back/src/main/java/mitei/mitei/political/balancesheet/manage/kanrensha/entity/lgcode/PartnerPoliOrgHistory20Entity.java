...
/**
 * partner_poli_org_history_20接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_20")
public class PartnerPoliOrgHistory20Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
