 ...
 */
@Component
public class DumpPartnerCorpHistory01ItemWriter extends FlatFileItemWriter<PartnerCorpHistory01Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory01ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory01Entity> lineAggregator = new DelimitedLineAggregator<>();
