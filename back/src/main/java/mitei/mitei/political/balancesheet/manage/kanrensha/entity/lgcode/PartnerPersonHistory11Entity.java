...
/**
 * partner_person_history_11接続用Entity
 */
@Entity
@Table(name = "partner_person_history_11")
public class PartnerPersonHistory11Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
