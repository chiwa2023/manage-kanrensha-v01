...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.regist_bulk_master_std.SearchBulkMasterStdPoliOrgService;
...
public class SearchBulkMasterStdPoliOrgController {
    ...
    public ResponseEntity<SearchWkTblStdPoliOrgPagingResultDto> practice(
            final @RequestBody SearchWkTbPagingCapsuleDto capsuleDto) {
        return ResponseEntity.ok(searchBulkMasterStdPoliOrgService.practice(capsuleDto));
    }
