...
/**
 * partner_person_history_05接続用Entity
 */
@Entity
@Table(name = "partner_person_history_05")
public class PartnerPersonHistory05Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
