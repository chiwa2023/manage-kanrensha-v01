...
/**
 * riyousha_comrade_address接続用Entity
 */
@Entity
@Table(name = "riyousha_comrade_address")
public class RiyoushaComradeAddressEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "riyousha_comrade_address_id")
    private Integer riyoushaComradeAddressId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getRiyoushaComradeAddressId() {
        return riyoushaComradeAddressId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param riyoushaComradeAddressId テーブルId
     */
    public void setRiyoushaComradeAddressId(final Integer riyoushaComradeAddressId) {
        this.riyoushaComradeAddressId = riyoushaComradeAddressId;
    }

    /** API接続続利用者Id */
    @Column(name = "riyousha_comrade_id")
     ...
     * API接続続利用者Idを設定する
     *
     * @param riyoushaComradeId API接続続利用者Id
     */
    ...
    /** API接続続利用者名称 */
    @Column(name = "riyousha_comrade_name")
     ...
     * API接続続利用者名称を設定する
     *
     * @param riyoushaComradeName API接続続利用者名称
     */
