...
/**
 * wk_tbl_master_corp接続用Entity
 */
@Entity
@Table(name = "wk_tbl_master_corp")
public class WkTblMasterCorpEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
     ...
     * テーブルIdを設定する
     *
     * @param wkTblMasterCorpId テーブルId
     */
    ...
    /** ワークテーブルコード */
    @Column(name = "wk_tbl_master_corp_code")
    private Integer wkTblMasterCorpCode = INIT_Integer;
     ...
     * @return ワークテーブルコード
     */
    public Integer getWkTblMasterCorpCode() {
        return wkTblMasterCorpCode;
    }

    /**
     * ワークテーブルコードを設定する
     *
     * @param wkTblMasterCorpCode ワークテーブルコード
     */
    public void setWkTblMasterCorpCode(final Integer wkTblMasterCorpCode) {
        this.wkTblMasterCorpCode = wkTblMasterCorpCode;
    }
