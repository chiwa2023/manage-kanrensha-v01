 ...
 */
@Component
public class PartnerCorpAddMiniCsvItemReader extends FlatFileItemReader<PartnerCorpAddMiniDto> {
     ...
     */
    public PartnerCorpAddMiniCsvItemReader(final @Autowired PartnerCorpAddMiniLineMapper lineMapper) {
        super();
