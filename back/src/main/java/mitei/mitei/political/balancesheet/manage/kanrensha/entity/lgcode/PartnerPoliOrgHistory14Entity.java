...
/**
 * partner_poli_org_history_14接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_14")
public class PartnerPoliOrgHistory14Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
