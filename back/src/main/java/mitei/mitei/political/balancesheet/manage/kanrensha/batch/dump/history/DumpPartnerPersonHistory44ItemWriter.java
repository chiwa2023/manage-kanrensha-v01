 ...
 */
@Component
public class DumpPartnerPersonHistory44ItemWriter extends FlatFileItemWriter<PartnerPersonHistory44Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory44ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory44Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory44Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
