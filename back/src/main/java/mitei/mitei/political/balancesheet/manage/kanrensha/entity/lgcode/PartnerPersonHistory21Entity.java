...
/**
 * partner_person_history_21接続用Entity
 */
@Entity
@Table(name = "partner_person_history_21")
public class PartnerPersonHistory21Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
