 ...
 */
@Component
public class DumpPartnerPersonHistory09ItemWriter extends FlatFileItemWriter<PartnerPersonHistory09Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory09ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory09Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory09Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
