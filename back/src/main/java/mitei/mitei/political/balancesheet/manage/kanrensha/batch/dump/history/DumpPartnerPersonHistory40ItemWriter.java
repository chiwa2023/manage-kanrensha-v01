 ...
 */
@Component
public class DumpPartnerPersonHistory40ItemWriter extends FlatFileItemWriter<PartnerPersonHistory40Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory40ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory40Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory40Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
