...
/**
 * master_corporation_base接続用Entity
 */
@Entity
@Table(name = "master_corporation_base")
public class MasterCorporationBaseEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "master_corporation_base_id")
    private Integer masterCorporationBaseId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getMasterCorporationBaseId() {
        return masterCorporationBaseId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param masterCorporationBaseId テーブルId
     */
    public void setMasterCorporationBaseId(final Integer masterCorporationBaseId) {
        this.masterCorporationBaseId = masterCorporationBaseId;
    }
