...
/**
 * partner_person_history_15接続用Entity
 */
@Entity
@Table(name = "partner_person_history_15")
public class PartnerPersonHistory15Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
