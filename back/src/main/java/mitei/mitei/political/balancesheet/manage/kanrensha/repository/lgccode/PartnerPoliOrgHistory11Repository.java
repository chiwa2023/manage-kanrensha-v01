...
/**
 * partner_poli_org_history_11接続用Repository
 */
public interface PartnerPoliOrgHistory11Repository extends JpaRepository<PartnerPoliOrgHistory11Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_11 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory11Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory11Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
