...
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.DumpMasterPoliticalOrganizationItemWriter;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.DumpMasterPoliticalOrganizationProcessor;
import mitei.mitei.political.balancesheet.manage.kanrensha.batch.dump.MasterPoliticalOrganizationDto;
 ...
 */
@Configuration
public class DumpSabunMasterPoliticalOrganizationBatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "dumpSabunMasterPoliticalOrganization";
    ...
    @Autowired
    private DumpSabunMasterPoliticalOrganizationItemReader dumpSabunMasterPoliticalOrganizationItemReader;
    ...
    protected Step getStepDump(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        ...
        return new StepBuilder(STEP_DUMP, jobRepository)
                .<MasterPoliticalOrganizationEntity, MasterPoliticalOrganizationDto>chunk(CHUNK_SIZE,
                        transactionManager)
                .reader(dumpSabunMasterPoliticalOrganizationItemReader)
                .processor(dumpMasterPoliticalOrganizationProcessor).writer(dumpMasterPoliticalOrganizationItemWriter)
                .build();
    }
