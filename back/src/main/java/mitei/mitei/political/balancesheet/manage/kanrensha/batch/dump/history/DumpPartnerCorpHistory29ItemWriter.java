 ...
 */
@Component
public class DumpPartnerCorpHistory29ItemWriter extends FlatFileItemWriter<PartnerCorpHistory29Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory29ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory29Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory29Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
