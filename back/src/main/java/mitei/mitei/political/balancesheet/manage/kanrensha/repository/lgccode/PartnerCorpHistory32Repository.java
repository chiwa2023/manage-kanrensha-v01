...
/**
 * partner_corp_history_32接続用Repository
 */
public interface PartnerCorpHistory32Repository extends JpaRepository<PartnerCorpHistory32Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_32 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory32Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory32Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
