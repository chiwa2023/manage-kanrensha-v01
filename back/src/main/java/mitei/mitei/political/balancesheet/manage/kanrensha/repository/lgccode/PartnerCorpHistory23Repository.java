...
/**
 * partner_corp_history_23接続用Repository
 */
public interface PartnerCorpHistory23Repository extends JpaRepository<PartnerCorpHistory23Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_23 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory23Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory23Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
