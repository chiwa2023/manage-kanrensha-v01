 ...
 */
@Component
public class DumpPartnerPoliOrgHistory31ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory31Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory31ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory31Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory31Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
