...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.regist_bulk_master_std.ExecuteBatchMasterStdCorpService;
...
public class ExecuteBatchMasterStdCorpController {

    /** 非同期処理登録専用Service */
    @Autowired
    private ExecuteBatchMasterStdCorpService executeBatchMasterStdCorpService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        executeBatchMasterStdCorpService.practice(Paths.get(fileDto.getSavedDir(), fileDto.getFileName()).toString(),
