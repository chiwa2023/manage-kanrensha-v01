...
/**
 * partner_poli_org_history_30接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_30")
public class PartnerPoliOrgHistory30Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
