 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory08ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory08Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory08ItemReader(
            final @Autowired PartnerPoliOrgHistory08Repository partnerPoliOrgHistory08Repository) {
        super();
