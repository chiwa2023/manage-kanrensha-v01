...
/**
 * partner_poli_org_history_25接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_25")
public class PartnerPoliOrgHistory25Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
