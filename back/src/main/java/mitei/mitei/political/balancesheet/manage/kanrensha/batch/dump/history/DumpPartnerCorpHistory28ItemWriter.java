 ...
 */
@Component
public class DumpPartnerCorpHistory28ItemWriter extends FlatFileItemWriter<PartnerCorpHistory28Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory28ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory28Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory28Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
