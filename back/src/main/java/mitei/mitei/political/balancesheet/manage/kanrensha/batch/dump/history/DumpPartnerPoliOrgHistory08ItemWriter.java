 ...
 */
@Component
public class DumpPartnerPoliOrgHistory08ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory08Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory08ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory08Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory08Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
