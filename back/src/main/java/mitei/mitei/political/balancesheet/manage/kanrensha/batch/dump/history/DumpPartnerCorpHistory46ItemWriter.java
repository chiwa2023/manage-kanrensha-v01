 ...
 */
@Component
public class DumpPartnerCorpHistory46ItemWriter extends FlatFileItemWriter<PartnerCorpHistory46Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory46ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory46Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory46Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
