...
/**
 * partner_corp_history_23接続用Entity
 */
@Entity
@Table(name = "partner_corp_history_23")
public class PartnerCorpHistory23Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
