...
import mitei.mitei.political.balancesheet.manage.kanrensha.service.regist_bulk_master_std.ExecuteBatchMasterStdPoliOrgService;
...
public class ExecuteBatchMasterStdPoliOrgController {

    /** 非同期処理登録専用Service */
    @Autowired
    private ExecuteBatchMasterStdPoliOrgService executeBatchMasterStdPoliOrgService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        executeBatchMasterStdPoliOrgService.practice(Paths.get(fileDto.getSavedDir(), fileDto.getFileName()).toString(),
