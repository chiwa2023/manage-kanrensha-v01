 ...
 */
@Component
public class MasterCorporationAddStdWkTblFixItemReader extends RepositoryItemReader<WkTblMasterCorpJudgeEntity> {

    /**
     * コンストラクタ
     *
     * @param wkTblMasterCorporationJudgeRepository 関連者企業・団体マスタ標準登録処理結果ワークテーブルRepository
     */
    public MasterCorporationAddStdWkTblFixItemReader(
            final @Autowired WkTblMasterCorpJudgeRepository wkTblMasterCorporationJudgeRepository) {

        super();
        super.setRepository(wkTblMasterCorporationJudgeRepository);
