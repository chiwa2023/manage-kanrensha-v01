 ...
 */
@Component
public class DumpPartnerCorpHistory14ItemWriter extends FlatFileItemWriter<PartnerCorpHistory14Entity> {

    /**
     * コンストラクタ
     *
     */
    public DumpPartnerCorpHistory14ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory14Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory14Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
