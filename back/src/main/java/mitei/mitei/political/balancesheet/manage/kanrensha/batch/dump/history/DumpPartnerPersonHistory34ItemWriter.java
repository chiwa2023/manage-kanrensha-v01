 ...
 */
@Component
public class DumpPartnerPersonHistory34ItemWriter extends FlatFileItemWriter<PartnerPersonHistory34Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory34ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory34Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory34Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
