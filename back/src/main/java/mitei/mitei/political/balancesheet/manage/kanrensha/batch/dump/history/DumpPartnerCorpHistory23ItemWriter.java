 ...
 */
@Component
public class DumpPartnerCorpHistory23ItemWriter extends FlatFileItemWriter<PartnerCorpHistory23Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerCorpHistory23ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerCorpHistory23Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerCorpHistory23Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
