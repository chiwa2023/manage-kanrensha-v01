...
/**
 * partner_person_history_33接続用Entity
 */
@Entity
@Table(name = "partner_person_history_33")
public class PartnerPersonHistory33Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
