...
/**
 * partner_poli_org_history_41接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_41")
public class PartnerPoliOrgHistory41Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
