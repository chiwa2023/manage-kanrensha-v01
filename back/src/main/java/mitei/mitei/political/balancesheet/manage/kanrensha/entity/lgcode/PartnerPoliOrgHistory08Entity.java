...
/**
 * partner_poli_org_history_08接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_08")
public class PartnerPoliOrgHistory08Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
