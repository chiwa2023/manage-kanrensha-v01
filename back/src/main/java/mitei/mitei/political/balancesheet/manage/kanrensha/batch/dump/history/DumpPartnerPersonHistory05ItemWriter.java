 ...
 */
@Component
public class DumpPartnerPersonHistory05ItemWriter extends FlatFileItemWriter<PartnerPersonHistory05Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory05ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory05Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory05Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
