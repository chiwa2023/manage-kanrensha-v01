...
/**
 * partner_poli_org_history_21接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_21")
public class PartnerPoliOrgHistory21Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
