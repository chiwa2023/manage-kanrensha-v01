...
/**
 * 企業・団体法人番号追加ワークテーブルItemWriter
 */
@Component
public class PlusCorpHoujinNoInputItemWriter extends JpaItemWriter<WkTblPartnerCorpPlusHojinNoEntity> {

    /** 企業・団体法人番号追加ワークテーブルRepository */
    @Autowired
     ...
     */
    public PlusCorpHoujinNoInputItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
     ...
     */
    @Override
    public void write(final Chunk<? extends WkTblPartnerCorpPlusHojinNoEntity> items) {

        for (WkTblPartnerCorpPlusHojinNoEntity entity : items) {
            setTableDataHistoryUtil.practiceInsert(userDto, entity);
        }

        wkTblPartnerCorpPlusHojinNoRepository.saveAll(items);
    }
}
