 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory27ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory27Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory27ItemReader(
            final @Autowired PartnerPoliOrgHistory27Repository partnerPoliOrgHistory27Repository) {
        super();
