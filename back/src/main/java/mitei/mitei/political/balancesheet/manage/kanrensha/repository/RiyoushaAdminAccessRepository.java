...
//     * @return 検索結果
//     */
//    @Query(value = "SELECT * FROM riyousha_admin_access WHERE saishin_kbn= 1 AND MATCH(riyousha_admin_access_name) AGAINST (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
//    List<RiyoushaAdminAccessEntity> findFullText(String searchWords);
