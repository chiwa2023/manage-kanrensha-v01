 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory43ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory43Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory43ItemReader(
            final @Autowired PartnerPoliOrgHistory43Repository partnerPoliOrgHistory43Repository) {
        super();
