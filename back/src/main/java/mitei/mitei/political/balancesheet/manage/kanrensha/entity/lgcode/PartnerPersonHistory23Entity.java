...
/**
 * partner_person_history_23接続用Entity
 */
@Entity
@Table(name = "partner_person_history_23")
public class PartnerPersonHistory23Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
