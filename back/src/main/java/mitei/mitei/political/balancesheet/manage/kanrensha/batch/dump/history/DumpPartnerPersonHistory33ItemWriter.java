 ...
 */
@Component
public class DumpPartnerPersonHistory33ItemWriter extends FlatFileItemWriter<PartnerPersonHistory33Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory33ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory33Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory33Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
