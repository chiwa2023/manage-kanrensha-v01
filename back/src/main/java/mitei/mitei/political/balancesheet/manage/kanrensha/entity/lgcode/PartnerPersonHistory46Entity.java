...
/**
 * partner_person_history_46接続用Entity
 */
@Entity
@Table(name = "partner_person_history_46")
public class PartnerPersonHistory46Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
