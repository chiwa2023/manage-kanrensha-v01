...
/**
 * partner_person_history_18接続用Entity
 */
@Entity
@Table(name = "partner_person_history_18")
public class PartnerPersonHistory18Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
