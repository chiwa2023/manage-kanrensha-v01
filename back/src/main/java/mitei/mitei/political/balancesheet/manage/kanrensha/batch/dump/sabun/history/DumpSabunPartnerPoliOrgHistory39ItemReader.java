 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory39ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory39Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory39ItemReader(
            final @Autowired PartnerPoliOrgHistory39Repository partnerPoliOrgHistory39Repository) {
        super();
