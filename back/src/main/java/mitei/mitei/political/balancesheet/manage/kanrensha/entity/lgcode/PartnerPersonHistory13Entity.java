...
/**
 * partner_person_history_13接続用Entity
 */
@Entity
@Table(name = "partner_person_history_13")
public class PartnerPersonHistory13Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
