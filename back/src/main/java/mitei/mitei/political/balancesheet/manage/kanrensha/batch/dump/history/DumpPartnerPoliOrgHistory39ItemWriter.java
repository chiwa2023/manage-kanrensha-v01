 ...
 */
@Component
public class DumpPartnerPoliOrgHistory39ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory39Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory39ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory39Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory39Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
