...
/**
 * partner_corp_history_07接続用Repository
 */
public interface PartnerCorpHistory07Repository extends JpaRepository<PartnerCorpHistory07Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_07 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory07Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory07Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
