...
/**
 * partner_corp_history_28接続用Repository
 */
public interface PartnerCorpHistory28Repository extends JpaRepository<PartnerCorpHistory28Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_28 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory28Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory28Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
