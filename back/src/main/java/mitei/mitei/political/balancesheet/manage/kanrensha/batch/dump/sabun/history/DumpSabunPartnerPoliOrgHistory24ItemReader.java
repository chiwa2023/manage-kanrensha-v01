 ...
 */
@Component
public class DumpSabunPartnerPoliOrgHistory24ItemReader extends RepositoryItemReader<PartnerPoliOrgHistory24Entity> {
     ...
     */
    public DumpSabunPartnerPoliOrgHistory24ItemReader(
            final @Autowired PartnerPoliOrgHistory24Repository partnerPoliOrgHistory24Repository) {
        super();
