...
/**
 * partner_poli_org_history_35接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_35")
public class PartnerPoliOrgHistory35Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
