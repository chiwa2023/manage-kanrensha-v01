 ...
 */
@Component
public class DumpPartnerPoliOrgHistory22ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory22Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory22ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory22Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory22Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
