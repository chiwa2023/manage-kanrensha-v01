...
/**
 * partner_person_history_35接続用Entity
 */
@Entity
@Table(name = "partner_person_history_35")
public class PartnerPersonHistory35Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
