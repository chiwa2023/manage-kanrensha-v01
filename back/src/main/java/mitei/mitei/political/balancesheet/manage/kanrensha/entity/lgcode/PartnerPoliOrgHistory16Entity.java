...
/**
 * partner_poli_org_history_16接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_16")
public class PartnerPoliOrgHistory16Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
