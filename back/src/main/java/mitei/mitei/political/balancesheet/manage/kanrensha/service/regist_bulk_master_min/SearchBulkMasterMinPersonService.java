...
public class SearchBulkMasterMinPersonService {
    ...
    public SearchWkTblMinPersonPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblPartnerPersonAddMinRepository.countByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
        ...
        resultDto.setListWktblPerson(wkTblPartnerPersonAddMinRepository
