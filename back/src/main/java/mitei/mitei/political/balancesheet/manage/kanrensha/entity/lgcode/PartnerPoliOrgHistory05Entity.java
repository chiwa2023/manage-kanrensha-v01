...
/**
 * partner_poli_org_history_05接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_05")
public class PartnerPoliOrgHistory05Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
