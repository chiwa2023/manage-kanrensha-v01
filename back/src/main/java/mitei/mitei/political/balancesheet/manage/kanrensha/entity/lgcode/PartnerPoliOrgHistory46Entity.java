...
/**
 * partner_poli_org_history_46接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_46")
public class PartnerPoliOrgHistory46Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
