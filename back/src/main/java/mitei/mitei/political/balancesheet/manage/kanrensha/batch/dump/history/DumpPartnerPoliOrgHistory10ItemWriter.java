 ...
 */
@Component
public class DumpPartnerPoliOrgHistory10ItemWriter extends FlatFileItemWriter<PartnerPoliOrgHistory10Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPoliOrgHistory10ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPoliOrgHistory10Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPoliOrgHistory10Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
