...
/**
 * partner_poli_org_history_10接続用Repository
 */
public interface PartnerPoliOrgHistory10Repository extends JpaRepository<PartnerPoliOrgHistory10Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_10 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory10Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory10Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
