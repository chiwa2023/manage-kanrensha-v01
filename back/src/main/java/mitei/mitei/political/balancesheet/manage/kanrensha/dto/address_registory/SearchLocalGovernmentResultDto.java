 ...
 * 地方自治体検索結果Dto
 */
public class SearchLocalGovernmentResultDto extends AbstractPagingIntegerDto // NOPMD DataClass
    ...
    /** 地方自治体リスト */
    private List<AddressAllCityEntity> listAllCity = new ArrayList<>();
     ...
     * @return 地方自治体リスト
     */
    public List<AddressAllCityEntity> getListAllCity() {
        return listAllCity;
    }
     ...
     * 地方自治体リストを設定する
     *
     * @param listAllCity 地方自治体リスト
     */
    public void setListAllCity(final List<AddressAllCityEntity> listAllCity) {
