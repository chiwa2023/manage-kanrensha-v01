 ...
 */
@Configuration
public class DumpMasterCorporationBatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "dumpMasterCorporation";
    ...
    protected Step getStepDump(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        ...
        return new StepBuilder(STEP_DUMP, jobRepository)
                ...
                .reader(dumpMasterCorporationItemReader).processor(dumpMasterCorporationProcessor)
