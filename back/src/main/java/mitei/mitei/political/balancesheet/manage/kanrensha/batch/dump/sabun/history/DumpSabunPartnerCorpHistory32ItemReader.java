 ...
 */
@Component
public class DumpSabunPartnerCorpHistory32ItemReader extends RepositoryItemReader<PartnerCorpHistory32Entity> {
     ...
     */
    public DumpSabunPartnerCorpHistory32ItemReader(
            final @Autowired PartnerCorpHistory32Repository partnerCorpHistory32Repository) {
        super();
