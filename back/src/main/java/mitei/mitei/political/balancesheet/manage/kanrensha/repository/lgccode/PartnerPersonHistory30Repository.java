...
public interface PartnerPersonHistory30Repository extends JpaRepository<PartnerPersonHistory30Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory30Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPersonHistory30Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
