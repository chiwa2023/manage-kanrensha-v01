...
/**
 * partner_corp_history_44接続用Repository
 */
public interface PartnerCorpHistory44Repository extends JpaRepository<PartnerCorpHistory44Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_44 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory44Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory44Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
