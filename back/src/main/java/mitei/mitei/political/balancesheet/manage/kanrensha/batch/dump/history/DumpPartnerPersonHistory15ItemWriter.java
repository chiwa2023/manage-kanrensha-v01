 ...
 */
@Component
public class DumpPartnerPersonHistory15ItemWriter extends FlatFileItemWriter<PartnerPersonHistory15Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory15ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory15Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory15Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
