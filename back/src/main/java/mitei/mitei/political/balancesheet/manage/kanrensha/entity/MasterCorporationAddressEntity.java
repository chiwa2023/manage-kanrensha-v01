...
/**
 * master_corporation_address接続用Entity
 */
@Entity
@Table(name = "master_corporation_address")
public class MasterCorporationAddressEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "master_corporation_address_id")
    private Integer masterCorporationAddressId = INIT_Integer;
     ...
     * @return テーブルId
     */
    public Integer getMasterCorporationAddressId() {
        return masterCorporationAddressId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param masterCorporationAddressId テーブルId
     */
    public void setMasterCorporationAddressId(final Integer masterCorporationAddressId) {
        this.masterCorporationAddressId = masterCorporationAddressId;
    }
