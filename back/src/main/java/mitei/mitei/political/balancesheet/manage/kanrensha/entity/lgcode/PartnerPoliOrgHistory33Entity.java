...
/**
 * partner_poli_org_history_33接続用Entity
 */
@Entity
@Table(name = "partner_poli_org_history_33")
public class PartnerPoliOrgHistory33Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
