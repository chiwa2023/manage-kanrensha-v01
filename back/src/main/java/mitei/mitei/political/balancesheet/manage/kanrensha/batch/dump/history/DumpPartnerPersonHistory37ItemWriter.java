 ...
 */
@Component
public class DumpPartnerPersonHistory37ItemWriter extends FlatFileItemWriter<PartnerPersonHistory37Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory37ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory37Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory37Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
