...
/**
 * partner_poli_org_history_25接続用Repository
 */
public interface PartnerPoliOrgHistory25Repository extends JpaRepository<PartnerPoliOrgHistory25Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_25 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory25Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory25Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
