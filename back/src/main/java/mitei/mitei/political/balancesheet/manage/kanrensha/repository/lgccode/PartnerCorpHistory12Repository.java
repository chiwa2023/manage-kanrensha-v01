...
/**
 * partner_corp_history_12接続用Repository
 */
public interface PartnerCorpHistory12Repository extends JpaRepository<PartnerCorpHistory12Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_corp_history_12 " + " WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory12Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerCorpHistory12Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
