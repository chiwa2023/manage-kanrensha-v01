...
/**
 * partner_poli_org_history_19接続用Repository
 */
public interface PartnerPoliOrgHistory19Repository extends JpaRepository<PartnerPoliOrgHistory19Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM partner_poli_org_history_19 WHERE partner_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory19Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    Page<PartnerPoliOrgHistory19Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
