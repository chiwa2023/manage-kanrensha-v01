 ...
 */
@Component
public class PartnerPersonAddMiniLineMapper implements LineMapper<PartnerPersonAddMiniDto> {
     ...
     */
    @Override
    public PartnerPersonAddMiniDto mapLine(final String line, final int lineNumber) throws Exception {
        PartnerPersonAddMiniDto dto = new PartnerPersonAddMiniDto();
