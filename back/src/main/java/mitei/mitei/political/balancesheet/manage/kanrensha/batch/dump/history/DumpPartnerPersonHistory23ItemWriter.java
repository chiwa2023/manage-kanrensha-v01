 ...
 */
@Component
public class DumpPartnerPersonHistory23ItemWriter extends FlatFileItemWriter<PartnerPersonHistory23Entity> {

    /**
     * コンストラクタ
     */
    public DumpPartnerPersonHistory23ItemWriter() {
        super();
        DelimitedLineAggregator<PartnerPersonHistory23Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<PartnerPersonHistory23Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
