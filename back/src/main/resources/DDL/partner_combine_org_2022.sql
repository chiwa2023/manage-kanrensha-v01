CREATE TABLE `partner_combine_org_2022` (
  `partner_combine_org_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `partner_combine_org_code` int DEFAULT NULL COMMENT '紐づけコード',
  ...
  PRIMARY KEY (`partner_combine_org_id`)
