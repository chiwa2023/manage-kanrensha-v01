CREATE TABLE `wk_tbl_master_person_judge` (
  `wk_tbl_master_person_judge_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_master_person_id` int DEFAULT NULL COMMENT 'ワークテーブルマスタId',
  ...
  PRIMARY KEY (`wk_tbl_master_person_judge_id`)
