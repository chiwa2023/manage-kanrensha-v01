CREATE TABLE `master_political_organization_property` (
  `master_political_organization_property_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  ...
  PRIMARY KEY (`master_political_organization_property_id`)
