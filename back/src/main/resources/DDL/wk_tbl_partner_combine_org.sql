CREATE TABLE `wk_tbl_partner_combine_org` (
  `wk_tbl_partner_combine_org_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_partner_combine_org_code` int DEFAULT NULL COMMENT '紐づけコード',
  ...
  PRIMARY KEY (`wk_tbl_partner_combine_org_id`)
