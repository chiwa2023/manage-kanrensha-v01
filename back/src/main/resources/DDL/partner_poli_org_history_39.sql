CREATE TABLE `partner_poli_org_history_39` (
  `partner_poli_org_history_id` int NOT NULL AUTO_INCREMENT COMMENT '関連者政治団体履歴Id',
  ...
  `poli_org_kanrensha_code` varchar(30) DEFAULT NULL COMMENT '政治団体関連者コード',
  ...
  PRIMARY KEY (`partner_poli_org_history_id`),
  UNIQUE KEY `unique_data` (`partner_name`,`all_address`,`poli_org_delegate`,`poli_org_kanrensha_code`)
