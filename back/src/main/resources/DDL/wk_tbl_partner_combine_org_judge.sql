CREATE TABLE `wk_tbl_partner_combine_org_judge` (
  `wk_tbl_partner_combine_org_judge_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_partner_combine_org_id` int DEFAULT NULL COMMENT 'ワークテーブルマスタId',
  ...
  PRIMARY KEY (`wk_tbl_partner_combine_org_judge_id`)
