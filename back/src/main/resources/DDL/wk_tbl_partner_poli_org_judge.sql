CREATE TABLE `wk_tbl_partner_poli_org_judge` (
  `wk_partner_poli_org_judge_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_partner_poli_org_history_id` int DEFAULT NULL COMMENT '関連者企業・団体履歴Id',
  ...
  PRIMARY KEY (`wk_partner_poli_org_judge_id`)
