CREATE TABLE `login_status` (
  ...
  `password` varchar(200) DEFAULT NULL COMMENT 'パスワード',
  `is_success` tinyint DEFAULT NULL COMMENT 'ログイン可否',
  `fail_reason` varchar(200) DEFAULT NULL COMMENT 'ログイン失敗理由',
  `disabled` tinyint DEFAULT NULL COMMENT '無効状態',
  `diabled_reason` varchar(200) DEFAULT NULL COMMENT '無効状態理由',
