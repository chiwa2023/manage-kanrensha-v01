CREATE TABLE `wk_tbl_partner_person_history` (
  `wk_partner_person_history_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_partner_person_history_code` int DEFAULT NULL COMMENT '関連者企業・団体コード',
  ...
  PRIMARY KEY (`wk_partner_person_history_id`)
