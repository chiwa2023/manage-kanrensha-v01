CREATE TABLE `riyousha_manager_address` (
  `riyousha_manager_address_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `riyousha_manager_id` int DEFAULT NULL COMMENT '利用者運営者Id',
  ...
  PRIMARY KEY (`riyousha_manager_address_id`)
