CREATE TABLE `master_political_organization` (
  `master_political_organization_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  ...
  `poli_org_delegate` varchar(100) DEFAULT NULL COMMENT '企業・団体代表者',
  ...
  PRIMARY KEY (`master_political_organization_id`)
