CREATE TABLE `wk_tbl_partner_person_judge` (
  `wk_partner_person_judge_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_partner_person_history_id` int DEFAULT NULL COMMENT '関連者企業・団体履歴Id',
  ...
  PRIMARY KEY (`wk_partner_person_judge_id`)
