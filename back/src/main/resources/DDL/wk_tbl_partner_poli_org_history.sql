CREATE TABLE `wk_tbl_partner_poli_org_history` (
  `wk_partner_poli_org_history_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_partner_poli_org_history_code` int DEFAULT NULL COMMENT '関連者企業・団体コード',
  ...
  `poli_org_kanrensha_code` varchar(30) DEFAULT NULL COMMENT '企業・団体関連者コード',
  ...
  PRIMARY KEY (`wk_partner_poli_org_history_id`)
