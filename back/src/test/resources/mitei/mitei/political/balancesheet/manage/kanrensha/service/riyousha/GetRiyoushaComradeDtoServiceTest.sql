...
DELETE FROM `riyousha_comrade_access`;
ALTER TABLE `riyousha_comrade_access` auto_increment = 0;
DELETE FROM `riyousha_comrade_address`;
ALTER TABLE `riyousha_comrade_address` auto_increment = 0;
DELETE FROM `riyousha_comrade_name`;
ALTER TABLE `riyousha_comrade_name` auto_increment = 0;
...
INSERT INTO `riyousha_comrade_address` (`riyousha_comrade_address_id`,`riyousha_comrade_id`,`riyousha_comrade_code`,`riyousha_comrade_name`,`is_latest`,`address_postal`,`address_block`,`address_building`,`postal1`,`postal2`,`lg_code`,`machiaza_id`,`blk_id`,`rsdt_id`,`rsdt2_id`,`is_postal_edit`,`is_block_edit`,`is_building_edit`,`insert_user_id`,`insert_user_code`,`insert_user_name`,`insert_timestamp`,`delete_user_id`,`delete_user_code`,`delete_user_name`,`delete_timestamp`) 
...
INSERT INTO `riyousha_comrade_name` (`riyousha_comrade_name_id`,`riyousha_comrade_id`,`riyousha_comrade_code`,`riyousha_comrade_name`,`is_latest`,`is_not_org`,`last_name`,`first_name`,`middle_name`,`last_name_kana`,`first_name_kana`,`middle_name_kana`,`org_name`,`org_name_kana`,`insert_user_id`,`insert_user_code`,`insert_user_name`,`insert_timestamp`,`delete_user_id`,`delete_user_code`,`delete_user_name`,`delete_timestamp`) 
