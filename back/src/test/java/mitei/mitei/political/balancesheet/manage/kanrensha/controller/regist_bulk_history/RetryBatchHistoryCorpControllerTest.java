...
/**
 * RetryBatchHistoryCorpController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class RetryBatchHistoryCorpControllerTest {
    ...
    @Sql({ "../../service/regist_bulk_history/sample_wk_tbl_partner_corp_history.sql",
            "../../service/regist_bulk_history/delete_hsitory_corp.sql" })
    void test() throws Exception {
        ...
        String path = "/regist-bulk-history/retry-corp";
