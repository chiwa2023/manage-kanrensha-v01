...
class AddStdKanrenshaPersonMasterBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(AddStdKanrenshaPersonMasterBatchConfiguration.JOB_NAME, addStdKanrenshaPersonMaster.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(addStdKanrenshaPersonMaster);
