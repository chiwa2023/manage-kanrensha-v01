...
class RegistBulkHistoryPersonControllerTest {
    ...
    @Test
    @Tag("TableTruncate")
    @Sql("../../service/regist_bulk_history/sample_wk_tbl_partner_person_history.sql")
    @Transactional
    void test() throws Exception {
        ...
        WkTblPartnerPersonHistoryEntity entityInput01 = wkTblPartnerPersonHistoryRepository.findById(101).get();
        ...
        String path = "/regist-bulk-history/update-person";
