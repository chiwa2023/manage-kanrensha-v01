...
/**
 * RetryBatchHistoryPoliOrgController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class RetryBatchHistoryPoliOrgControllerTest {
    ...
    @Sql({ "../../service/regist_bulk_history/sample_wk_tbl_partner_poli_org_history.sql",
            "../../service/regist_bulk_history/delete_hsitory_poli_org.sql" })
    void test() throws Exception {
        ...
        String path = "/regist-bulk-history/retry-poli-org";
