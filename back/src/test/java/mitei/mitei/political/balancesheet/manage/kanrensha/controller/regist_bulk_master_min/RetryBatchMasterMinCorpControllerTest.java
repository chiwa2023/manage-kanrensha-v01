...
/**
 * RetryBatchMasterMinCorpController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class RetryBatchMasterMinCorpControllerTest {
    ...
    @Sql({ "../../service/regist_bulk_master_min/sample_wk_tbl_partner_corp_add_min.sql",
            "../../service/regist_bulk_master_min/delete_hsitory_corp.sql",
            "../../service/regist_bulk_master_min/delete_master_corporation.sql" })
    void test() throws Exception {
        ...
        String path = "/regist-bulk-master-min/retry-corp";
