...
/**
 * RetryMinKanrenshaPoliOrgMasterBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class RetryMinKanrenshaPoliOrgMasterBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryMinKanrenshaPoliOrgMasterBatchConfiguration.JOB_NAME,
                retryMinKanrenshaPoliOrgMaster.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(retryMinKanrenshaPoliOrgMaster);
