...
/**
 * SuspendDuplicateWkTblMasterCorporationAddStdTasklet単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SuspendDuplicateWkTblMasterCorporationAddStdTaskletTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("duplicate_sample_wk_tbl_master_corp.sql")
    void test() throws Exception {

        final String reason = "アップロードファイル内で重複しているデータです";

        suspendDuplicateWkTblMasterCorporationAddStdTasklet.beforeStep(this.getStepExecution());
        suspendDuplicateWkTblMasterCorporationAddStdTasklet.execute(null, null);

        WkTblMasterCorpEntity entity501 = wkTblMasterCorpRepository.findById(501).get();
        ...
        WkTblMasterCorpEntity entity502 = wkTblMasterCorpRepository.findById(502).get();
        ...
        WkTblMasterCorpEntity entity601 = wkTblMasterCorpRepository.findById(601).get();
