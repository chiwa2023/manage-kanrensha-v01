...
/**
 * DumpPartnerPoliOrgHistory28ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpPartnerPoliOrgHistory28ItemWriterTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/poli__org28.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpPartnerPoliOrgHistory28ItemWriter.beforeStep(stepExecution);

        PartnerPoliOrgHistory28Entity entity00 = new PartnerPoliOrgHistory28Entity();
        ...
        List<PartnerPoliOrgHistory28Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends PartnerPoliOrgHistory28Entity> items = new Chunk<>(list);
        dumpPartnerPoliOrgHistory28ItemWriter.open(stepExecution.getExecutionContext());
        dumpPartnerPoliOrgHistory28ItemWriter.write(items);
