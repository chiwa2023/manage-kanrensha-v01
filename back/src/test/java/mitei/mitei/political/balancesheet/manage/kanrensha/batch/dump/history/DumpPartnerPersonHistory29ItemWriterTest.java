...
/**
 * DumpPartnerPersonHistory29ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpPartnerPersonHistory29ItemWriterTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/person_29.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpPartnerPersonHistory29ItemWriter.beforeStep(stepExecution);

        PartnerPersonHistory29Entity entity00 = new PartnerPersonHistory29Entity();
        ...
        List<PartnerPersonHistory29Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends PartnerPersonHistory29Entity> items = new Chunk<>(list);
        dumpPartnerPersonHistory29ItemWriter.open(stepExecution.getExecutionContext());
        dumpPartnerPersonHistory29ItemWriter.write(items);
