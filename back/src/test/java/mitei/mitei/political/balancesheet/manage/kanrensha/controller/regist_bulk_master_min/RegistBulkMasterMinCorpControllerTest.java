...
class RegistBulkMasterMinCorpControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        WkTblPartnerCorpAddMinEntity entityInput01 = wkTblPartnerCorpAddMinRepository.findById(102).get();
        ...
        String path = "/regist-bulk-master-min/update-corp";
