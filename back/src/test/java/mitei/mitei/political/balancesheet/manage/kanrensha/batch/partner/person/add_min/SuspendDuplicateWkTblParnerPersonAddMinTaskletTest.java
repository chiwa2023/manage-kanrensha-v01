...
/**
 * SuspendDuplicateWkTblParnerPersonAddMinTasklet単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SuspendDuplicateWkTblParnerPersonAddMinTaskletTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("duplicatee_sample_wk_tbl_partner_person_add_min.sql")
    void test() throws Exception {

        final String reason = "アップロードファイル内で重複しているデータです";

        suspendDuplicateWkTblParnerPersonAddMinTasklet.beforeStep(this.getStepExecution());
        suspendDuplicateWkTblParnerPersonAddMinTasklet.execute(null, null);

        WkTblPartnerPersonAddMinEntity entity501 = wkTblPartnerPersonAddMinRepository.findById(501).get();
        ...
        WkTblPartnerPersonAddMinEntity entity502 = wkTblPartnerPersonAddMinRepository.findById(502).get();
        ...
        WkTblPartnerPersonAddMinEntity entity601 = wkTblPartnerPersonAddMinRepository.findById(601).get();
