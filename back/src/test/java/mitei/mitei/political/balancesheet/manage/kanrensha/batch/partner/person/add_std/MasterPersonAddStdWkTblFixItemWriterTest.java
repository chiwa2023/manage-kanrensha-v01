...
class MasterPersonAddStdWkTblFixItemWriterTest {
    ...
    void test() throws Exception {
        ...
        final int executeId = 297;
        WkTblMasterPersonEntity entityCall = wkTblMasterPersonRepository.findById(executeId).get();
        ...
        masterPersonAddStdWkTblFixItemWriter.beforeStep(this.getStepExecution());
        masterPersonAddStdWkTblFixItemWriter.write(items);

        WkTblMasterPersonEntity entityAns = wkTblMasterPersonRepository.findById(executeId).get();
