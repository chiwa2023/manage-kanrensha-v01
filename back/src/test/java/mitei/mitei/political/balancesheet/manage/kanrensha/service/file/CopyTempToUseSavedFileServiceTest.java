...
class CopyTempToUseSavedFileServiceTest {
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "delete_save_file_storage_2025.sql", "delete_task_plan_2025.sql", "sample_task_info.sql" })
    void test() throws Exception {

        String fileName = "mt_city_all.csv";

        Path pathSrc = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(), "/batch/address_base/", fileName);
