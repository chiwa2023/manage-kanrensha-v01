...
/**
 * InviteNewPersonPublishCodeController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InviteNewPersonPublishCodeControllerTest {
    ...
    @Transactional
    @WithMockUser
    @Sql("../../service/riyousha/InviteNewPersonPublishCodeServiceTest.sql")
    void test() throws Exception {
        ...
        String path = "/user-riyousha/publish-accept-code";
