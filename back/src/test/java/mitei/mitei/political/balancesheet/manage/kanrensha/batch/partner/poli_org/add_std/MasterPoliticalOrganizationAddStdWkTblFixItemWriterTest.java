...
/**
 * MasterPoliticalOrganizationAddStdWkTblFixItemWriter単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class MasterPoliticalOrganizationAddStdWkTblFixItemWriterTest {
    ...
    void test() throws Exception {
        ...
        final int executeId = 536;
        WkTblMasterPoliOrgEntity entityCall = wkTblMasterPoliOrgRepository.findById(executeId).get();
        ...
        masterPoliticalOrganizationAddStdWkTblFixItemWriter.beforeStep(this.getStepExecution());
        masterPoliticalOrganizationAddStdWkTblFixItemWriter.write(items);

        WkTblMasterPoliOrgEntity entityAns = wkTblMasterPoliOrgRepository.findById(executeId).get();
