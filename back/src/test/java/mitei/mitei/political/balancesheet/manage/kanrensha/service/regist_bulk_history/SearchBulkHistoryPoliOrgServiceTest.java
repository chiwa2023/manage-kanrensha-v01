...
/**
 * SearchBulkHistoryPoliOrgService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchBulkHistoryPoliOrgServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        SearchWkTblHistoryPoliOrgPagingResultDto resultDto00 = searchBulkHistoryPoliOrgService.practice(capsuleDto00);
        ...
        SearchWkTblHistoryPoliOrgPagingResultDto resultDto01 = searchBulkHistoryPoliOrgService.practice(capsuleDto01);
        ...
        SearchWkTblHistoryPoliOrgPagingResultDto resultDto02 = searchBulkHistoryPoliOrgService.practice(capsuleDto02);
        ...
        SearchWkTblHistoryPoliOrgPagingResultDto resultDto03 = searchBulkHistoryPoliOrgService.practice(capsuleDto03);
        ...
        SearchWkTblHistoryPoliOrgPagingResultDto resultDto04 = searchBulkHistoryPoliOrgService.practice(capsuleDto04);
