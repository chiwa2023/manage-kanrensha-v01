...
/**
 * ForceDumpMinMasterSabunCorpService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpMinMasterSabunCorpServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpMinMasterSabunCorpService.practice(LocalDate.of(2024, 1, 1), LocalDate.of(2025, 1, 1)));
    }
