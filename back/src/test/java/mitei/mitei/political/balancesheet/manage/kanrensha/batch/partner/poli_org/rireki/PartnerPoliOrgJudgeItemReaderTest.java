...
/**
 * PartnerPoliOrgJudgeItemReader単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class PartnerPoliOrgJudgeItemReaderTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        partnerPoliOrgJudgeItemReader.beforeStep(this.getStepExecution());

        assertEquals(313, partnerPoliOrgJudgeItemReader.read().getWkPartnerPoliOrgHistoryId());
        assertEquals(314, partnerPoliOrgJudgeItemReader.read().getWkPartnerPoliOrgHistoryId());
        assertEquals(315, partnerPoliOrgJudgeItemReader.read().getWkPartnerPoliOrgHistoryId());
        assertNull(partnerPoliOrgJudgeItemReader.read());
