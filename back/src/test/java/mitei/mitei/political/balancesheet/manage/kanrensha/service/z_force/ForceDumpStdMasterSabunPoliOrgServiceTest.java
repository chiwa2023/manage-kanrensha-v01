...
/**
 * ForceDumpStdMasterSabunPoliOrgService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpStdMasterSabunPoliOrgServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceDumpStdMasterSabunPoliOrgService.practice(LocalDate.of(2024, 1, 1),
