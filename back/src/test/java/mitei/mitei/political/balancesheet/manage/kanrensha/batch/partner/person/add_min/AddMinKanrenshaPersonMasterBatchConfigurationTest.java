...
class AddMinKanrenshaPersonMasterBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(AddMinKanrenshaPersonMasterBatchConfiguration.JOB_NAME, addMinKanrenshaPersonMaster.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(addMinKanrenshaPersonMaster);
