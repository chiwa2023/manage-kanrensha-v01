...
/**
 * DumpPartnerCorpHistory29ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpPartnerCorpHistory29ItemWriterTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/abc_29.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpPartnerCorpHistory29ItemWriter.beforeStep(stepExecution);

        PartnerCorpHistory29Entity entity00 = new PartnerCorpHistory29Entity();
        ...
        // Chunkを作成してセット
        Chunk<? extends PartnerCorpHistory29Entity> items = new Chunk<>(list);
        dumpPartnerCorpHistory29ItemWriter.open(stepExecution.getExecutionContext());
        dumpPartnerCorpHistory29ItemWriter.write(items);
