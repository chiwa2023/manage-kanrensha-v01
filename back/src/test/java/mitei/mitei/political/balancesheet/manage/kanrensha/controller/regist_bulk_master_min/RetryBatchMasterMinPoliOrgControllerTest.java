...
/**
 * RetryBatchMasterMinPoliOrgController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class RetryBatchMasterMinPoliOrgControllerTest {
    ...
    @Sql({ "../../service/regist_bulk_master_min/sample_wk_tbl_partner_poli_org_add_min.sql",
            "../../service/regist_bulk_master_min/delete_hsitory_poli_org.sql",
            "../../service/regist_bulk_master_min/delete_master_political_organizatin.sql" })
    void test() throws Exception {
        ...
        String path = "/regist-bulk-master-min/retry-poli-org";
