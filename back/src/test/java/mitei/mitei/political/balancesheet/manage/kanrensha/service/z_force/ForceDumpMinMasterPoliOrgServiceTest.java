...
/**
 * ForceDumpMinMasterPoliOrgService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpMinMasterPoliOrgServiceTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void test() {
        assertDoesNotThrow(() -> forceDumpMinMasterPoliOrgService.practice(LocalDate.of(2024, 1, 1)));
    }
