...
/**
 * SearchBulkMasterStdCorpService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchBulkMasterStdCorpServiceTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private SearchBulkMasterStdCorpService searchBulkMasterStdCorpService;
    ...
    void test() {
        ...
        SearchWkTblStdCorpPagingResultDto resultDto00 = searchBulkMasterStdCorpService.practice(capsuleDto00);
        ...
        SearchWkTblStdCorpPagingResultDto resultDto01 = searchBulkMasterStdCorpService.practice(capsuleDto01);
        ...
        SearchWkTblStdCorpPagingResultDto resultDto02 = searchBulkMasterStdCorpService.practice(capsuleDto02);
        ...
        SearchWkTblStdCorpPagingResultDto resultDto03 = searchBulkMasterStdCorpService.practice(capsuleDto03);
        ...
        SearchWkTblStdCorpPagingResultDto resultDto04 = searchBulkMasterStdCorpService.practice(capsuleDto04);
