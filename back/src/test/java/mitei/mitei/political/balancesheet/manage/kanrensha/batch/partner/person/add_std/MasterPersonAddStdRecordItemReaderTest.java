...
class MasterPersonAddStdRecordItemReaderTest {
    ...
    void test() throws Exception {
        ...
        masterPersonAddStdRecordItemReader.beforeStep(this.getStepExecution());

        // 297:対象ユーザでない、299:最新でない、298:編集対象でないため読まれない
        assertEquals(296, masterPersonAddStdRecordItemReader.read().getWkTblMasterPersonId());
