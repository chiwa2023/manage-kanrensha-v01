...
/**
 * PickupRiyoushaOrgOptionComradeController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class PickupRiyoushaOrgOptionComradeControllerTest {
    ...
    @Transactional
    @WithMockUser
    @Sql("../../service/riyousha/PickupRiyoushaOrgOptionComradeServiceTest.sql")
    void test() throws Exception {
        ...
        String path = "/user-riyousha/org-comrade-option";
