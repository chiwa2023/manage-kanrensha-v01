...
/**
 * InsertKanrenshaPoliOrgHistoryBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class InsertKanrenshaPoliOrgHistoryBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(InsertKanrenshaPoliOrgHistoryBatchConfiguration.JOB_NAME, insertKanrenshaPoliOrgHistory.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(insertKanrenshaPoliOrgHistory);
