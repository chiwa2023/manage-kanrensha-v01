...
/**
 * PlusCorpHoujinNoOutputItemReader単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class PlusCorpHoujinNoOutputItemReaderTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        plusCorpHoujinNoOutputItemReader.beforeStep(this.getStepExecution());

        // 104:対象ユーザでない、105:最新でない、106:編集対象でないため読まれない
        assertEquals(626, plusCorpHoujinNoOutputItemReader.read().getWkTblPartnerCorpPlusHojinNoId());
        assertEquals(627, plusCorpHoujinNoOutputItemReader.read().getWkTblPartnerCorpPlusHojinNoId());
        assertEquals(628, plusCorpHoujinNoOutputItemReader.read().getWkTblPartnerCorpPlusHojinNoId());
        assertNull(plusCorpHoujinNoOutputItemReader.read());
    }
