...
class MasterPersonAddStdWkTblFixItemReaderTest {
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("sample_wk_tbl_master_person_judge.sql")
    void test() throws Exception {

        masterPersonAddStdWkTblFixItemReader.beforeStep(this.getStepExecution());

        assertEquals(321, masterPersonAddStdWkTblFixItemReader.read().getWkTblMasterPersonJudgeId());
