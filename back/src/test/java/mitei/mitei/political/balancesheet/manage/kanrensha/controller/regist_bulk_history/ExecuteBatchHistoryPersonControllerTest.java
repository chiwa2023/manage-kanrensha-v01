...
class ExecuteBatchHistoryPersonControllerTest {
    ...
    @Test
    @Tag("TableTruncate")
    @Sql("../../service/regist_bulk_history/delete_hsitory_person.sql")
    void test()throws Exception {
        ...
        capsuleDto.getStorageFileDto().setFileName("関連者個人履歴.csv");

        ObjectMapper objectMapper = GetObjectMapperWithTimeModuleUtil.practice();

        String path = "/regist-bulk-history/execute-person";
