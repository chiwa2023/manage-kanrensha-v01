...
/**
 * AcceptGetNewPersonPublishCodeController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class AcceptGetNewPersonPublishCodeControllerTest {
    ...
    @Transactional
    @WithMockUser
    @Sql("../../service/riyousha/AcceptGetNewPersonPublishCodeServiceTest.sql")
    void test() throws Exception {
        ...
        String path = "/user-riyousha/get-accept-code-list";
