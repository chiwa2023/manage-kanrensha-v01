...
/**
 * PickupRiyoushaOrgOptionManagerController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class PickupRiyoushaOrgOptionManagerControllerTest {
    ...
    @Transactional
    @WithMockUser
    @Sql("../../service/riyousha/PickupRiyoushaOrgOptionManagerServiceTest.sql")
    void test()throws Exception {
        ...
        String path = "/user-riyousha/org-manager-option";
