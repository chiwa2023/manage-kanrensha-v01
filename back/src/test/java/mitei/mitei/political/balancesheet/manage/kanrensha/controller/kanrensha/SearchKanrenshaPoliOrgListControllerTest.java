...
/**
 * SearchKanrenshaPoliOrgListController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchKanrenshaPoliOrgListControllerTest {
    // CHECKSTYLE:OFF
    ...
    @Transactional
    @WithMockUser
    @Sql("../../service/kanrensha/master_political_organization.sql")
    void test() throws Exception {
        ...
        String path = "/user-kanrensha/search-poli-org";
