...
/**
 * CallMasterPersonAddressEntityLogic単体テスト
 *
 * @author chiwaki2023
...
@Sql("sample_master_person_address.sql")
class CallMasterPersonAddressEntityLogicTest {
    // CHECKSTYLE:OFF
    ...
    void testEmpty() throws Exception {
        ...
        MasterPersonAddressEntity addressEntity = callMasterPersonAddressEntityLogic.practice(code);
        assertEquals(code, addressEntity.getPersonKanrenshaCode());
    }
    ...
    void testNowData() throws Exception {
        ...
        MasterPersonAddressEntity addressEntity = callMasterPersonAddressEntityLogic.practice(code);
        assertEquals(1, addressEntity.getMasterPersonAddressId());
    }
    ...
    void testDataStructureFailure() throws Exception {
        ...
        assertThrows(DataRetrievalFailureException.class, () -> callMasterPersonAddressEntityLogic.practice(code));
    }
    ...
    void testHistory() throws Exception {
        ...
        MasterPersonAddressEntity addressEntity = callMasterPersonAddressEntityLogic.practice(code);
        assertEquals(6, addressEntity.getMasterPersonAddressId());
    }
