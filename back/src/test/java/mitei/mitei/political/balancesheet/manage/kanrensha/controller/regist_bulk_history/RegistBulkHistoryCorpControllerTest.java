...
class RegistBulkHistoryCorpControllerTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Tag("TableTruncate")
    @Sql("../../service/regist_bulk_history/sample_wk_tbl_partner_corp_history.sql")
    @Transactional
    void test() throws Exception {
        ...
        WkTblPartnerCorpHistoryEntity entityInput01 = wkTblPartnerCorpHistoryRepository.findById(101).get();
        ...
        String path = "/regist-bulk-history/update-corp";
