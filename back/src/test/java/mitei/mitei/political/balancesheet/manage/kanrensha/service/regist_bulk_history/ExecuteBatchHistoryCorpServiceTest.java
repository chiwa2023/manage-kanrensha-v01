...
/**
 * ExecuteBatchHistoryCorpService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ExecuteBatchHistoryCorpServiceTest {
    ...
    void test() {
        ...
        Path readFilePath = Paths.get("190/test/", "関連者企業団体履歴.csv");
        assertDoesNotThrow(() -> executeBatchHistoryCorpService.practice(readFilePath.toString(), userDto));
    }
