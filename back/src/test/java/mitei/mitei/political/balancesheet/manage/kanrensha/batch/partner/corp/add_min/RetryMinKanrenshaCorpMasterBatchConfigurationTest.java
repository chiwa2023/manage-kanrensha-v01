...
/**
 * RetryMinKanrenshaCorpMasterBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class RetryMinKanrenshaCorpMasterBatchConfigurationTest {

    /** 起動をするJob */
    @Qualifier(RetryMinKanrenshaCorpMasterBatchConfiguration.JOB_NAME)
    @Autowired
    private Job retryMinKanrenshaCorpMaster;
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryMinKanrenshaCorpMasterBatchConfiguration.JOB_NAME, retryMinKanrenshaCorpMaster.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(retryMinKanrenshaCorpMaster);

        JobParameters jobParameters = new JobParametersBuilder(
                retryMinKanrenshaCorpMaster.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
