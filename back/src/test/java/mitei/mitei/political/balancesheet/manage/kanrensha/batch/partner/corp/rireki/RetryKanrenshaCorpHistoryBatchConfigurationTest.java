...
/**
 * RetryKanrenshaCorpHistoryBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class RetryKanrenshaCorpHistoryBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryKanrenshaCorpHistoryBatchConfiguration.JOB_NAME, retryKanrenshaCorpHistory.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(retryKanrenshaCorpHistory);
