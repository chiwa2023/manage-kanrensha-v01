...
/**
 * AcceptSaveNewPersonController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class AcceptSaveNewPersonControllerTest {
    ...
    @Transactional
    @WithMockUser
    @Sql("../../service/riyousha/AcceptSaveNewPersonServiceTest.sql")
    void test()throws Exception {
        ...
        String path = "/user-riyousha/save-accept-code";
