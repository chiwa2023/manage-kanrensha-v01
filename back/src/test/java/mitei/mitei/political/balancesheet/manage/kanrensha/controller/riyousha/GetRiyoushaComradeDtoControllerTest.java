...
import mitei.mitei.political.balancesheet.manage.kanrensha.dto.riyousha.GetRiyoushaComradeCapsuleDto;
...
/**
 * GetRiyoushaComradeDtoController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetRiyoushaComradeDtoControllerTest {
    ...
    void test() throws Exception {
        ...
        // Setup
        RiyoushaComradeEntity entity = new RiyoushaComradeEntity();
        entity.setRiyoushaComradeId(467);
        entity.setIsNotOrg(true);
        entity.setRiyoushaComradeName("test-user");

        GetRiyoushaComradeCapsuleDto capsuleDto = new GetRiyoushaComradeCapsuleDto();
        capsuleDto.setRiyoushaComradeEntity(entity);

        ObjectMapper objectMapper = GetObjectMapperWithTimeModuleUtil.practice();

        String path = "/user-riyousha/get-comrade";
