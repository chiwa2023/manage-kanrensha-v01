...
class CreateUserLeastDtoByBatchParamUtilTest {
    ...
    void test() throws Exception {
        ...
        UserPersonLeastDto userDto = createUserLeastDtoByBatchParamUtil.practice(this.getStepExecution());

        assertEquals(userId, userDto.getUserPersonId());
        assertEquals(userCode, userDto.getUserPersonCode());
        assertEquals(userName, userDto.getUserPersonName());
