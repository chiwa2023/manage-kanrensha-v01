...
/**
 * ForceDumpStdMasterSabunCorpService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpStdMasterSabunCorpServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpStdMasterSabunCorpService.practice(LocalDate.of(2024, 1, 1), LocalDate.of(2025, 1, 1)));
    }
