...
/**
 * ExecuteBatchMasterMinCorpService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ExecuteBatchMasterMinCorpServiceTest {
    ...
    void test() {
        ...
        Path readFilePath = Paths.get("190/test/", "関連者企業団体最小登録.csv");
        assertDoesNotThrow(() -> executeBatchMasterMinCorpService.practice(readFilePath.toString(), userDto));
    }
