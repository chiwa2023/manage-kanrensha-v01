...
/**
 * ExecuteBatchMasterMinPoliOrgService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ExecuteBatchMasterMinPoliOrgServiceTest {
    ...
    void test() {
        ...
        Path readFilePath = Paths.get("190/test/", "関連者政治団体最小登録.csv");
        assertDoesNotThrow(() -> executeBatchMasterMinPoliOrgService.practice(readFilePath.toString(), userDto));
    }
