...
/**
 * DumpMasterPoliticalOrganizationBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class DumpMasterPoliticalOrganizationBatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(DumpMasterPoliticalOrganizationBatchConfiguration.JOB_NAME,
                dumpMasterPoliticalOrganization.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(dumpMasterPoliticalOrganization);
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(storageFolder, "master_poli_org.csv").toString())
                .toJobParameters();
