...
/**
 * DumpSabunPartnerPoliOrgHistory01ItemReader単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class DumpSabunPartnerPoliOrgHistory01ItemReaderTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        dumpSabunPartnerPoliOrgHistory01ItemReader.beforeStep(this.getStepExecution());

        assertEquals(1002, dumpSabunPartnerPoliOrgHistory01ItemReader.read().getPartnerPoliOrgHistoryId());
        assertNull(dumpSabunPartnerPoliOrgHistory01ItemReader.read());
    }
