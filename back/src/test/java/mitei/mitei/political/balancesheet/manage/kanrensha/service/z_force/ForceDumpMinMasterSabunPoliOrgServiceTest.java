...
/**
 * ForceDumpMinMasterSabunPoliOrgService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpMinMasterSabunPoliOrgServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceDumpMinMasterSabunPoliOrgService.practice(LocalDate.of(2024, 1, 1),
