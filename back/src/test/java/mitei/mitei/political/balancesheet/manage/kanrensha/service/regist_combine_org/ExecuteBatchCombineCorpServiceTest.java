...
/**
 * ExecuteBatchCombineCorpService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ExecuteBatchCombineCorpServiceTest {
    ...
    void test() {
        ...
        Path readFilePath = Paths.get("190/test/", "sample_combine_corp.csv");
        assertDoesNotThrow(() -> executeBatchCombineCorpService.practice(readFilePath.toString(), userDto));
    }
}
