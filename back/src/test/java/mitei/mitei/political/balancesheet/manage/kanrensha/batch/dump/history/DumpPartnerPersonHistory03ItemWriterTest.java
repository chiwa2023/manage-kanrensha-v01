...
/**
 * DumpPartnerPersonHistory03ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpPartnerPersonHistory03ItemWriterTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/person_03.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpPartnerPersonHistory03ItemWriter.beforeStep(stepExecution);

        PartnerPersonHistory03Entity entity00 = new PartnerPersonHistory03Entity();
        ...
        List<PartnerPersonHistory03Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends PartnerPersonHistory03Entity> items = new Chunk<>(list);
        dumpPartnerPersonHistory03ItemWriter.open(stepExecution.getExecutionContext());
        dumpPartnerPersonHistory03ItemWriter.write(items);
