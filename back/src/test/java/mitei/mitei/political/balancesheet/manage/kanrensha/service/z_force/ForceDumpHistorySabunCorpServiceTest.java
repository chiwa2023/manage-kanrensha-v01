...
/**
 * ForceDumpHistorySabunCorpService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpHistorySabunCorpServiceTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void test() {
        assertDoesNotThrow(() -> forceDumpHistorySabunCorpService.practice(LocalDate.of(2024, 1, 1),LocalDate.of(2025, 1, 1)));
    }
