...
/**
 * ForceDumpStdMasterCorpService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpStdMasterCorpServiceTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void test() {
        assertDoesNotThrow(() -> forceDumpStdMasterCorpService.practice(LocalDate.of(2024, 1, 1)));
    }
