...
/**
 * ForceDumpStdMasterPoliOrgService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpStdMasterPoliOrgServiceTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void test() {
        assertDoesNotThrow(() -> forceDumpStdMasterPoliOrgService.practice(LocalDate.of(2024, 1, 1)));
    }
