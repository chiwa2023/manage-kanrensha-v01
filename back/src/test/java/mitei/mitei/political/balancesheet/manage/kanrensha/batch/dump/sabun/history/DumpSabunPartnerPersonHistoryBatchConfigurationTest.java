...
/**
 * DumpSabunPartnerPersonHistoryBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class DumpSabunPartnerPersonHistoryBatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(DumpSabunPartnerPersonHistoryBatchConfiguration.JOB_NAME, dumpSabunPartnerPersonHistory.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(dumpSabunPartnerPersonHistory);
