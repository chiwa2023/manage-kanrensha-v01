...
/**
 * SuspendDuplicateWkTblParnerCorpAddMinTasklet単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SuspendDuplicateWkTblParnerCorpAddMinTaskletTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("duplicatee_sample_wk_tbl_partner_corp_add_min.sql")
    void test() throws Exception {

        final String reason = "アップロードファイル内で重複しているデータです";

        suspendDuplicateWkTblParnerCorpAddMinTasklet.beforeStep(this.getStepExecution());
        suspendDuplicateWkTblParnerCorpAddMinTasklet.execute(null, null);

        WkTblPartnerCorpAddMinEntity entity501 = wkTblPartnerCorpAddMinRepository.findById(501).get();
        ...
        WkTblPartnerCorpAddMinEntity entity502 = wkTblPartnerCorpAddMinRepository.findById(502).get();
        ...
        WkTblPartnerCorpAddMinEntity entity601 = wkTblPartnerCorpAddMinRepository.findById(601).get();
