...
/**
 * ReplaceComradeAccessTokenControllert単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.MOCK)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ReplaceComradeRefleshTokenControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        capsuleDto.setUserId("55555@seijishikin.net");
        capsuleDto.setPassword("55555");

        String path = "/replace-token";
