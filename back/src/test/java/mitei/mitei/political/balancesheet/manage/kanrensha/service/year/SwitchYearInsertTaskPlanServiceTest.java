...
class SwitchYearInsertTaskPlanServiceTest {
    ...
    @Test
    @Tag("TableTruncate")
    @Sql({ "../../logic/year/y2025/delete_task_plan_2025.sql", "../../logic/year/y2025/sample_task_info.sql" })
    @Transactional
    void test() {

        UserPersonLeastDto usertDto = CreateLeastUserForTestUtil.practice();
        Integer idSaved = switchYearInsertTaskPlanService.practice(2025, usertDto, TaskInfoConstants.SAVE_POSTAL_REPAIR_CSV);
