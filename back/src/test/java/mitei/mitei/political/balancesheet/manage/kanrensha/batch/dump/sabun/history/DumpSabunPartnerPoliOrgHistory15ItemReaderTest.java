...
/**
 * DumpSabunPartnerPoliOrgHistory15ItemReader単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class DumpSabunPartnerPoliOrgHistory15ItemReaderTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        dumpSabunPartnerPoliOrgHistory15ItemReader.beforeStep(this.getStepExecution());

        assertEquals(1002, dumpSabunPartnerPoliOrgHistory15ItemReader.read().getPartnerPoliOrgHistoryId());
        assertNull(dumpSabunPartnerPoliOrgHistory15ItemReader.read());
    }
