...
/**
 * DumpSabunPartnerPoliOrgHistory02ItemReader単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class DumpSabunPartnerPoliOrgHistory02ItemReaderTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        dumpSabunPartnerPoliOrgHistory02ItemReader.beforeStep(this.getStepExecution());

        assertEquals(1002, dumpSabunPartnerPoliOrgHistory02ItemReader.read().getPartnerPoliOrgHistoryId());
        assertNull(dumpSabunPartnerPoliOrgHistory02ItemReader.read());
    }
