...
class EraseWkTblCombineOrgTaskletTest {
    ...
    void test() throws Exception {
        ...
        assertEquals(7, wkTblPartnerCombineOrgRepository.count());
        assertEquals(5, wkTblPartnerCombineOrgJudgeRepository.count());

        eraseWkTblCombineOrgTasklet.beforeStep(this.getStepExecution());
        eraseWkTblCombineOrgTasklet.execute(null, null);

        assertEquals(1, wkTblPartnerCombineOrgRepository.count());
        assertEquals(1, wkTblPartnerCombineOrgJudgeRepository.count());
    }
