...
class RegistBulkHistoryPoliOrgControllerTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Tag("TableTruncate")
    @Sql("../../service/regist_bulk_history/sample_wk_tbl_partner_poli_org_history.sql")
    @Transactional
    void test() throws Exception {
        ...
        WkTblPartnerPoliOrgHistoryEntity entityInput01 = wkTblPartnerPoliOrgHistoryRepository.findById(313).get();
        ...
        String path = "/regist-bulk-history/update-poli-org";
