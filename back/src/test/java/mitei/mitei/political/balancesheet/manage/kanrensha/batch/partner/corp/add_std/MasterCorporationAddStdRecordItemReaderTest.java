...
/**
 * MasterCorporationAddStdRecordItemReader単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class MasterCorporationAddStdRecordItemReaderTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        masterCorporationAddStdRecordItemReader.beforeStep(this.getStepExecution());

        // 414:対象ユーザでない、413:最新でない、415:編集対象でないため読まれない
        assertEquals(412, masterCorporationAddStdRecordItemReader.read().getWkTblMasterCorpId());
        assertNull(masterCorporationAddStdRecordItemReader.read());
    }
