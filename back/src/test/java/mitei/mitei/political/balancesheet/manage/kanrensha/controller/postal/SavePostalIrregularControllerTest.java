...
/**
 * SavePostalIrregularController単体テスト
 */
@SpringJUnitConfig
...
class SavePostalIrregularControllerTest {
    ...
    @Test
    @Tag("TableTruncate")
    @Sql("../../service/postal/delete_address_postal_irregular.sql")
    @Transactional
    @WithMockUser
    void test() throws Exception {
        ...
        String path = "/postal-irregular/save";
