...
class RetryKanrenshaPersonHistoryBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryKanrenshaPersonHistoryBatchConfiguration.JOB_NAME, retryKanrenshaPersonHistory.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(retryKanrenshaPersonHistory);
