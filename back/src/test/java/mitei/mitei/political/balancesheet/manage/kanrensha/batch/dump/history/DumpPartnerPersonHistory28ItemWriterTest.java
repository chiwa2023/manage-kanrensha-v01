...
/**
 * DumpPartnerPersonHistory28ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpPartnerPersonHistory28ItemWriterTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/person_28.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpPartnerPersonHistory28ItemWriter.beforeStep(stepExecution);

        PartnerPersonHistory28Entity entity00 = new PartnerPersonHistory28Entity();
        ...
        List<PartnerPersonHistory28Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends PartnerPersonHistory28Entity> items = new Chunk<>(list);
        dumpPartnerPersonHistory28ItemWriter.open(stepExecution.getExecutionContext());
        dumpPartnerPersonHistory28ItemWriter.write(items);
