...
class PartnerCorpHistoryItemReaderTest {
    ...
    void test() throws Exception {
        ...
        // "ぼったくり企業","和歌山県架空市実在町","代表者　太郎","12-345-ABCCDEF"
        ...
        // "ふんだくり企業","宮崎県架空市実在町","代表者　次郎","23-45657-QWERTY"
        assertEquals("ふんだくり企業", dto03.getPartnerName());
        ...
        // "職業組合A","山形県架空市実在町","代表者　三郎","12-33-44-55"
        assertEquals("職業組合A", dto04.getPartnerName());
        ...
        // "職業組合B","山梨県架空市実在町","代表者　四郎","99-88-77-66"
        assertEquals("職業組合B", dto05.getPartnerName());
