...
/**
 * ForceDumpHistorySabunPoliOrgService単体テスト
 */
@SpringJUnitConfig
...
class ForceDumpHistorySabunPoliOrgServiceTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void test() {
        assertDoesNotThrow(() -> forceDumpHistorySabunPoliOrgService.practice(LocalDate.of(2024, 1, 1),LocalDate.of(2025, 1, 1)));
    }
