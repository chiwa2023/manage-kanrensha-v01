...
/**
 * RetryStdKanrenshaPoliticalOrganizationMasterBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class RetryStdKanrenshaPoliticalOrganizationMasterBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryStdKanrenshaPoliticalOrganizationMasterBatchConfiguration.JOB_NAME,
                retryStdKanrenshaPoliticalOrganizationMaster.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(retryStdKanrenshaPoliticalOrganizationMaster);
